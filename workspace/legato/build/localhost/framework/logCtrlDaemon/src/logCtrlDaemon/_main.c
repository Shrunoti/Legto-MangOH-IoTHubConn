...
// Startup code for the executable 'logCtrlDaemon'.
...
LE_SHARED const char* _logDaemon_logFd_ServiceInstanceName = "logFd";
LE_SHARED const char* _logDaemon_logDaemonWdog_ServiceInstanceName = "logDaemonWdog";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t logCtrlDaemon_exe_LogSession;
LE_SHARED le_log_Level_t* logCtrlDaemon_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    logCtrlDaemon_exe_LogSession = log_RegComponent("logCtrlDaemon_exe", &logCtrlDaemon_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_logDaemon.so");
