...
// Startup code for the executable 'sdir'.
...
LE_SHARED const char* _sdirTool_le_cfg_ServiceInstanceName = "le_cfg";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t sdir_exe_LogSession;
LE_SHARED le_log_Level_t* sdir_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    sdir_exe_LogSession = log_RegComponent("sdir_exe", &sdir_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_sdirTool.so");
