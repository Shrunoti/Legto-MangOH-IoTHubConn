...
// Startup code for the executable 'log'.
...
LE_SHARED le_log_SessionRef_t log_exe_LogSession;
LE_SHARED le_log_Level_t* log_exe_LogLevelFilterPtr;

// Declare default component's COMPONENT_INIT function.
void _log_exe_COMPONENT_INIT(void);
...
int main(int argc, char* argv[])
{
    ...
    log_exe_LogSession = log_RegComponent("log_exe", &log_exe_LogLevelFilterPtr);
...
// Queue the default component's COMPONENT_INIT to Event Loop.
    event_QueueComponentInit(_log_exe_COMPONENT_INIT);
