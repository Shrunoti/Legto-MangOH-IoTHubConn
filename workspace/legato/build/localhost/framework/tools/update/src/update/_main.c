...
// Startup code for the executable 'update'.
...
LE_SHARED const char* _update_le_update_ServiceInstanceName = "le_update";
LE_SHARED const char* _update_le_updateCtrl_ServiceInstanceName = "le_updateCtrl";
LE_SHARED const char* _update_le_appRemove_ServiceInstanceName = "le_appRemove";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t update_exe_LogSession;
LE_SHARED le_log_Level_t* update_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    update_exe_LogSession = log_RegComponent("update_exe", &update_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_update.so");
