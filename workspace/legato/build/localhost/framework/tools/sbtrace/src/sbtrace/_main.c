...
// Startup code for the executable 'sbtrace'.
...
LE_SHARED const char* _sbtrace_le_appCtrl_ServiceInstanceName = "le_appCtrl";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t sbtrace_exe_LogSession;
LE_SHARED le_log_Level_t* sbtrace_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    sbtrace_exe_LogSession = log_RegComponent("sbtrace_exe", &sbtrace_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_sbtrace.so");
