...
// Startup code for the executable 'config'.
...
LE_SHARED const char* _config_le_cfg_ServiceInstanceName = "le_cfg";
LE_SHARED const char* _config_le_cfgAdmin_ServiceInstanceName = "le_cfgAdmin";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t config_exe_LogSession;
LE_SHARED le_log_Level_t* config_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    config_exe_LogSession = log_RegComponent("config_exe", &config_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_config.so");
