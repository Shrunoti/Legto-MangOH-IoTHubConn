...
// Startup code for the executable 'app'.
...
LE_SHARED const char* _appCtrl_le_appCtrl_ServiceInstanceName = "le_appCtrl";
LE_SHARED const char* _appCtrl_le_framework_ServiceInstanceName = "le_framework";
LE_SHARED const char* _appCtrl_le_appInfo_ServiceInstanceName = "le_appInfo";
LE_SHARED const char* _appCtrl_le_cfg_ServiceInstanceName = "le_cfg";
LE_SHARED const char* _appCtrl_le_appProc_ServiceInstanceName = "le_appProc";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t app_exe_LogSession;
LE_SHARED le_log_Level_t* app_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    app_exe_LogSession = log_RegComponent("app_exe", &app_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_appCtrl.so");
