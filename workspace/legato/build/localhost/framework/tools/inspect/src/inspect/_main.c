...
// Startup code for the executable 'inspect'.
...
LE_SHARED le_log_SessionRef_t inspect_exe_LogSession;
LE_SHARED le_log_Level_t* inspect_exe_LogLevelFilterPtr;

// Declare default component's COMPONENT_INIT function.
void _inspect_exe_COMPONENT_INIT(void);
...
int main(int argc, char* argv[])
{
    ...
    inspect_exe_LogSession = log_RegComponent("inspect_exe", &inspect_exe_LogLevelFilterPtr);
...
// Queue the default component's COMPONENT_INIT to Event Loop.
    event_QueueComponentInit(_inspect_exe_COMPONENT_INIT);
