...
#include "le_update_messages.h"
#include "le_update_server.h"
...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_update_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_update_ServerHandlers", 3);
...
static void AsyncResponse_le_update_AddProgressHandler
(
...
)
{
    ...
    _msgPtr->id = _MSGID_le_update_AddProgressHandler;
...
static void Handle_le_update_AddProgressHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_update_ProgressHandlerRef_t _result;
    _result  = le_update_AddProgressHandler ( AsyncResponse_le_update_AddProgressHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_update_RemoveProgressHandler;
...
static void Handle_le_update_RemoveProgressHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_update_ProgressHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);
...
static void Handle_le_update_Start
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_update_Install
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_update_End
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_update_GetErrorCode
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_update_ErrorCode_t _result;
    _result  = le_update_GetErrorCode (  );
...
static void Handle_le_update_GetCurrentSysIndex
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    int32_t _result;
    _result  = le_update_GetCurrentSysIndex (  );
...
static void Handle_le_update_GetSystemHash
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    if ( (hashStrSize > 32) &&
         (hashStrSize < UINT32_MAX) )
    {
        LE_DEBUG("Adjusting hashStrSize from %zu to 32", hashStrSize);
        hashStrSize = 32;
    }
    if (hashStrSize >= UINT32_MAX)
    {
        hashStrSize = 0;
    }
    else
    ...
    // Define storage for output parameters
    char hashStrBuffer[33];
    char *hashStr = hashStrBuffer;
    hashStr[0] = 0;
    ...
    // Call the function
    le_result_t _result;
    _result  = le_update_GetSystemHash ( 
        systemIndex, 
        hashStr, 
        hashStrSize );
...
static void Handle_le_update_GetPreviousSystemIndex
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    int32_t _result;
    _result  = le_update_GetPreviousSystemIndex ( 
        systemIndex );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_update_AddProgressHandler : Handle_le_update_AddProgressHandler(msgRef); break;
        case _MSGID_le_update_RemoveProgressHandler : Handle_le_update_RemoveProgressHandler(msgRef); break;
        case _MSGID_le_update_Start : Handle_le_update_Start(msgRef); break;
        case _MSGID_le_update_Install : Handle_le_update_Install(msgRef); break;
        case _MSGID_le_update_End : Handle_le_update_End(msgRef); break;
        case _MSGID_le_update_GetErrorCode : Handle_le_update_GetErrorCode(msgRef); break;
        case _MSGID_le_update_GetCurrentSysIndex : Handle_le_update_GetCurrentSysIndex(msgRef); break;
        case _MSGID_le_update_GetSystemHash : Handle_le_update_GetSystemHash(msgRef); break;
        case _MSGID_le_update_GetPreviousSystemIndex : Handle_le_update_GetPreviousSystemIndex(msgRef); break;
