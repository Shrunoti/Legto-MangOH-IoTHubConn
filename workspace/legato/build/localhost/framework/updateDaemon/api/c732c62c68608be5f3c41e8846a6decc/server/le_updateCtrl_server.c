...
#include "le_updateCtrl_messages.h"
#include "le_updateCtrl_server.h"
...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_updateCtrl_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_updateCtrl_ServerHandlers", 3);
...
static void Handle_le_updateCtrl_Defer
(
...
static void Handle_le_updateCtrl_Allow
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_updateCtrl_LockProbation
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    bool _result;
    _result  = le_updateCtrl_LockProbation (  );
...
static void Handle_le_updateCtrl_UnlockProbation
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_updateCtrl_MarkGood
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_updateCtrl_MarkGood ( 
        force );
...
static void Handle_le_updateCtrl_FailProbation
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_updateCtrl_GetSystemState
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_updateCtrl_SystemState_t _result;
    _result  = le_updateCtrl_GetSystemState (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_updateCtrl_Defer : Handle_le_updateCtrl_Defer(msgRef); break;
        case _MSGID_le_updateCtrl_Allow : Handle_le_updateCtrl_Allow(msgRef); break;
        case _MSGID_le_updateCtrl_LockProbation : Handle_le_updateCtrl_LockProbation(msgRef); break;
        case _MSGID_le_updateCtrl_UnlockProbation : Handle_le_updateCtrl_UnlockProbation(msgRef); break;
        case _MSGID_le_updateCtrl_MarkGood : Handle_le_updateCtrl_MarkGood(msgRef); break;
        case _MSGID_le_updateCtrl_FailProbation : Handle_le_updateCtrl_FailProbation(msgRef); break;
        case _MSGID_le_updateCtrl_GetSystemState : Handle_le_updateCtrl_GetSystemState(msgRef); break;
