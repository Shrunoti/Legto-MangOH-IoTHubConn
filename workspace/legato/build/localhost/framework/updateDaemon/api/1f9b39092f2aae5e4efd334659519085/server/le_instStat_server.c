...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_instStat_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_instStat_ServerHandlers", 3);
...
static void AsyncResponse_le_instStat_AddAppInstallEventHandler
(
...
static void Handle_le_instStat_AddAppInstallEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _result  = le_instStat_AddAppInstallEventHandler ( AsyncResponse_le_instStat_AddAppInstallEventHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_instStat_RemoveAppInstallEventHandler;
...
static void Handle_le_instStat_RemoveAppInstallEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_instStat_AppInstallEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);
...
static void AsyncResponse_le_instStat_AddAppUninstallEventHandler
(
    const char* LE_NONNULL appName,
    void* contextPtr
)
...
static void Handle_le_instStat_AddAppUninstallEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _result  = le_instStat_AddAppUninstallEventHandler ( AsyncResponse_le_instStat_AddAppUninstallEventHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->handlerRef = (le_event_HandlerRef_t)_result;
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_instStat_RemoveAppUninstallEventHandler;
...
static void Handle_le_instStat_RemoveAppUninstallEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    le_ref_DeleteRef(_HandlerRefMap, handlerRef);
    _UNLOCK
    handlerRef = (le_instStat_AppUninstallEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_instStat_AddAppInstallEventHandler : Handle_le_instStat_AddAppInstallEventHandler(msgRef); break;
        case _MSGID_le_instStat_RemoveAppInstallEventHandler : Handle_le_instStat_RemoveAppInstallEventHandler(msgRef); break;
        case _MSGID_le_instStat_AddAppUninstallEventHandler : Handle_le_instStat_AddAppUninstallEventHandler(msgRef); break;
        case _MSGID_le_instStat_RemoveAppUninstallEventHandler : Handle_le_instStat_RemoveAppUninstallEventHandler(msgRef); break;
