...
// Startup code for the executable 'configTree'.
...
LE_SHARED const char* _configTree_le_cfg_ServiceInstanceName = "le_cfg";
LE_SHARED const char* _configTree_le_cfgAdmin_ServiceInstanceName = "le_cfgAdmin";
LE_SHARED const char* _configTree_configTreeWdog_ServiceInstanceName = "configTreeWdog";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t configTree_exe_LogSession;
LE_SHARED le_log_Level_t* configTree_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    configTree_exe_LogSession = log_RegComponent("configTree_exe", &configTree_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_configTree.so");
