...
// Startup code for the executable 'serviceDirectory'.
...
LE_SHARED le_log_SessionRef_t serviceDirectory_exe_LogSession;
LE_SHARED le_log_Level_t* serviceDirectory_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    serviceDirectory_exe_LogSession = log_RegComponent("serviceDirectory_exe", &serviceDirectory_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_serviceDirectory.so");
