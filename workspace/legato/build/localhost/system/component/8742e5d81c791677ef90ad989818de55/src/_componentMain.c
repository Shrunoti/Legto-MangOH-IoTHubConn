...
void _le_pa_default_COMPONENT_INIT(void);
...
__attribute__((constructor)) void _le_pa_default_Init(void)
{
    ...
    le_pa_default_LogSession = log_RegComponent("le_pa_default", &le_pa_default_LogLevelFilterPtr);

    //Queue the COMPONENT_INIT function to be called by the event loop
    event_QueueComponentInit(_le_pa_default_COMPONENT_INIT);
}
