...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_lpt_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_lpt_ServerHandlers", 3);
...
static void Handle_le_lpt_SetEDrxState
(
...
static void Handle_le_lpt_SetRequestedEDrxValue
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_lpt_SetRequestedEDrxValue ( 
        rat, 
        eDrxValue );
...
static void Handle_le_lpt_GetRequestedEDrxValue
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    uint8_t eDrxValueBuffer;
    uint8_t *eDrxValuePtr = &eDrxValueBuffer;
    ...
    // Call the function
    le_result_t _result;
    _result  = le_lpt_GetRequestedEDrxValue ( 
        rat, 
        eDrxValuePtr );
...
static void Handle_le_lpt_GetNetworkProvidedEDrxValue
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_lpt_GetNetworkProvidedEDrxValue ( 
        rat, 
        eDrxValuePtr );
...
static void Handle_le_lpt_GetNetworkProvidedPagingTimeWindow
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    uint8_t pagingTimeWindowBuffer;
    uint8_t *pagingTimeWindowPtr = &pagingTimeWindowBuffer;
    if (!(_requiredOutputs & (1u << 0)))
    {
        pagingTimeWindowPtr = NULL;
    }

    // Call the function
    le_result_t _result;
    _result  = le_lpt_GetNetworkProvidedPagingTimeWindow ( 
        rat, 
        pagingTimeWindowPtr );
...
static void AsyncResponse_le_lpt_AddEDrxParamsChangeHandler
(
    le_lpt_EDrxRat_t rat,
    le_onoff_t activation,
    uint8_t eDrxValue,
...
static void Handle_le_lpt_AddEDrxParamsChangeHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _result  = le_lpt_AddEDrxParamsChangeHandler ( AsyncResponse_le_lpt_AddEDrxParamsChangeHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_lpt_RemoveEDrxParamsChangeHandler;
...
static void Handle_le_lpt_RemoveEDrxParamsChangeHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_lpt_EDrxParamsChangeHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_lpt_SetEDrxState : Handle_le_lpt_SetEDrxState(msgRef); break;
        case _MSGID_le_lpt_SetRequestedEDrxValue : Handle_le_lpt_SetRequestedEDrxValue(msgRef); break;
        case _MSGID_le_lpt_GetRequestedEDrxValue : Handle_le_lpt_GetRequestedEDrxValue(msgRef); break;
        case _MSGID_le_lpt_GetNetworkProvidedEDrxValue : Handle_le_lpt_GetNetworkProvidedEDrxValue(msgRef); break;
        case _MSGID_le_lpt_GetNetworkProvidedPagingTimeWindow : Handle_le_lpt_GetNetworkProvidedPagingTimeWindow(msgRef); break;
        case _MSGID_le_lpt_AddEDrxParamsChangeHandler : Handle_le_lpt_AddEDrxParamsChangeHandler(msgRef); break;
        case _MSGID_le_lpt_RemoveEDrxParamsChangeHandler : Handle_le_lpt_RemoveEDrxParamsChangeHandler(msgRef); break;
