...
#include "le_mdmCfg_messages.h"
#include "le_mdmCfg_server.h"
...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_mdmCfg_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_mdmCfg_ServerHandlers", 3);
...
static void Handle_le_mdmCfg_StoreCurrentConfiguration
(
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_mdmCfg_StoreCurrentConfiguration (  );
...
static void Handle_le_mdmCfg_RestoreSavedConfiguration
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_mdmCfg_RestoreSavedConfiguration (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_mdmCfg_StoreCurrentConfiguration : Handle_le_mdmCfg_StoreCurrentConfiguration(msgRef); break;
        case _MSGID_le_mdmCfg_RestoreSavedConfiguration : Handle_le_mdmCfg_RestoreSavedConfiguration(msgRef); break;
