...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_mcc_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_mcc_ServerHandlers", 3);
...
)
{
    ...
    {
        LE_DEBUG("Adjusting telPtrSize from %zu to 17", telPtrSize);
        telPtrSize = 17;
    }
...
)
{
    ...
    // Define storage for output parameters
    le_onoff_t clirStatusPtrBuffer;
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_mcc_Create : Handle_le_mcc_Create(msgRef); break;
        case _MSGID_le_mcc_Delete : Handle_le_mcc_Delete(msgRef); break;
        case _MSGID_le_mcc_Start : Handle_le_mcc_Start(msgRef); break;
        case _MSGID_le_mcc_IsConnected : Handle_le_mcc_IsConnected(msgRef); break;
        case _MSGID_le_mcc_GetRemoteTel : Handle_le_mcc_GetRemoteTel(msgRef); break;
        case _MSGID_le_mcc_GetTerminationReason : Handle_le_mcc_GetTerminationReason(msgRef); break;
        case _MSGID_le_mcc_GetPlatformSpecificTerminationCode : Handle_le_mcc_GetPlatformSpecificTerminationCode(msgRef); break;
        case _MSGID_le_mcc_Answer : Handle_le_mcc_Answer(msgRef); break;
        case _MSGID_le_mcc_HangUp : Handle_le_mcc_HangUp(msgRef); break;
        case _MSGID_le_mcc_HangUpAll : Handle_le_mcc_HangUpAll(msgRef); break;
        case _MSGID_le_mcc_GetCallerIdRestrict : Handle_le_mcc_GetCallerIdRestrict(msgRef); break;
        case _MSGID_le_mcc_SetCallerIdRestrict : Handle_le_mcc_SetCallerIdRestrict(msgRef); break;
        case _MSGID_le_mcc_AddCallEventHandler : Handle_le_mcc_AddCallEventHandler(msgRef); break;
        case _MSGID_le_mcc_RemoveCallEventHandler : Handle_le_mcc_RemoveCallEventHandler(msgRef); break;
        case _MSGID_le_mcc_SetCallWaitingService : Handle_le_mcc_SetCallWaitingService(msgRef); break;
        case _MSGID_le_mcc_GetCallWaitingService : Handle_le_mcc_GetCallWaitingService(msgRef); break;
        case _MSGID_le_mcc_ActivateCall : Handle_le_mcc_ActivateCall(msgRef); break;
        case _MSGID_le_mcc_SetAmrWbCapability : Handle_le_mcc_SetAmrWbCapability(msgRef); break;
        case _MSGID_le_mcc_GetAmrWbCapability : Handle_le_mcc_GetAmrWbCapability(msgRef); break;
