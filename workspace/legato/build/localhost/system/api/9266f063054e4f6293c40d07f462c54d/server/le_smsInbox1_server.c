...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_smsInbox1_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_smsInbox1_ServerHandlers", 3);
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_smsInbox1_Open : Handle_le_smsInbox1_Open(msgRef); break;
        case _MSGID_le_smsInbox1_Close : Handle_le_smsInbox1_Close(msgRef); break;
        case _MSGID_le_smsInbox1_AddRxMessageHandler : Handle_le_smsInbox1_AddRxMessageHandler(msgRef); break;
        case _MSGID_le_smsInbox1_RemoveRxMessageHandler : Handle_le_smsInbox1_RemoveRxMessageHandler(msgRef); break;
        case _MSGID_le_smsInbox1_DeleteMsg : Handle_le_smsInbox1_DeleteMsg(msgRef); break;
        case _MSGID_le_smsInbox1_GetImsi : Handle_le_smsInbox1_GetImsi(msgRef); break;
        case _MSGID_le_smsInbox1_GetFormat : Handle_le_smsInbox1_GetFormat(msgRef); break;
        case _MSGID_le_smsInbox1_GetSenderTel : Handle_le_smsInbox1_GetSenderTel(msgRef); break;
        case _MSGID_le_smsInbox1_GetTimeStamp : Handle_le_smsInbox1_GetTimeStamp(msgRef); break;
        case _MSGID_le_smsInbox1_GetMsgLen : Handle_le_smsInbox1_GetMsgLen(msgRef); break;
        case _MSGID_le_smsInbox1_GetText : Handle_le_smsInbox1_GetText(msgRef); break;
        case _MSGID_le_smsInbox1_GetBinary : Handle_le_smsInbox1_GetBinary(msgRef); break;
        case _MSGID_le_smsInbox1_GetPdu : Handle_le_smsInbox1_GetPdu(msgRef); break;
        case _MSGID_le_smsInbox1_GetFirst : Handle_le_smsInbox1_GetFirst(msgRef); break;
        case _MSGID_le_smsInbox1_GetNext : Handle_le_smsInbox1_GetNext(msgRef); break;
        case _MSGID_le_smsInbox1_IsUnread : Handle_le_smsInbox1_IsUnread(msgRef); break;
        case _MSGID_le_smsInbox1_MarkRead : Handle_le_smsInbox1_MarkRead(msgRef); break;
        case _MSGID_le_smsInbox1_MarkUnread : Handle_le_smsInbox1_MarkUnread(msgRef); break;
        case _MSGID_le_smsInbox1_SetMaxMessages : Handle_le_smsInbox1_SetMaxMessages(msgRef); break;
        case _MSGID_le_smsInbox1_GetMaxMessages : Handle_le_smsInbox1_GetMaxMessages(msgRef); break;
