...
#include "le_smsInbox2_messages.h"
#include "le_smsInbox2_server.h"
...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_smsInbox2_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_smsInbox2_ServerHandlers", 3);
...
static void Handle_le_smsInbox2_Open
(
...
)
{
    ...
    // Call the function
    le_smsInbox2_SessionRef_t _result;
    _result  = le_smsInbox2_Open (  );
...
static void Handle_le_smsInbox2_Close
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_smsInbox2_AddRxMessageHandler
(
    uint32_t msgId,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_smsInbox2_AddRxMessageHandler;
...
static void Handle_le_smsInbox2_AddRxMessageHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_smsInbox2_RxMessageHandlerRef_t _result;
    _result  = le_smsInbox2_AddRxMessageHandler ( AsyncResponse_le_smsInbox2_AddRxMessageHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_smsInbox2_RemoveRxMessageHandler;
...
static void Handle_le_smsInbox2_RemoveRxMessageHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_smsInbox2_RxMessageHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_smsInbox2_RemoveRxMessageHandler ( 
        handlerRef );
...
static void Handle_le_smsInbox2_DeleteMsg
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_smsInbox2_GetImsi
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_smsInbox2_GetFormat
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _result  = le_smsInbox2_GetFormat ( 
        msgId );
...
static void Handle_le_smsInbox2_GetSenderTel
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_smsInbox2_GetSenderTel ( 
        msgId, 
        tel, 
        telSize );
...
static void Handle_le_smsInbox2_GetTimeStamp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_smsInbox2_GetTimeStamp ( 
        msgId, 
        timestamp, 
        timestampSize );
...
static void Handle_le_smsInbox2_GetMsgLen
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    size_t _result;
    _result  = le_smsInbox2_GetMsgLen ( 
        msgId );
...
static void Handle_le_smsInbox2_GetText
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_smsInbox2_GetBinary
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_smsInbox2_GetBinary ( 
        msgId, 
        binPtr, 
        &binSize );
...
static void Handle_le_smsInbox2_GetPdu
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_smsInbox2_GetFirst
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_smsInbox2_GetNext
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_smsInbox2_IsUnread
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_smsInbox2_MarkRead
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_smsInbox2_MarkUnread
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_smsInbox2_SetMaxMessages
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_smsInbox2_SetMaxMessages ( 
        maxMessageCount );
...
static void Handle_le_smsInbox2_GetMaxMessages
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    uint32_t maxMessageCountPtrBuffer;
    ...
    // Call the function
    le_result_t _result;
    _result  = le_smsInbox2_GetMaxMessages ( 
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_smsInbox2_Open : Handle_le_smsInbox2_Open(msgRef); break;
        case _MSGID_le_smsInbox2_Close : Handle_le_smsInbox2_Close(msgRef); break;
        case _MSGID_le_smsInbox2_AddRxMessageHandler : Handle_le_smsInbox2_AddRxMessageHandler(msgRef); break;
        case _MSGID_le_smsInbox2_RemoveRxMessageHandler : Handle_le_smsInbox2_RemoveRxMessageHandler(msgRef); break;
        case _MSGID_le_smsInbox2_DeleteMsg : Handle_le_smsInbox2_DeleteMsg(msgRef); break;
        case _MSGID_le_smsInbox2_GetImsi : Handle_le_smsInbox2_GetImsi(msgRef); break;
        case _MSGID_le_smsInbox2_GetFormat : Handle_le_smsInbox2_GetFormat(msgRef); break;
        case _MSGID_le_smsInbox2_GetSenderTel : Handle_le_smsInbox2_GetSenderTel(msgRef); break;
        case _MSGID_le_smsInbox2_GetTimeStamp : Handle_le_smsInbox2_GetTimeStamp(msgRef); break;
        case _MSGID_le_smsInbox2_GetMsgLen : Handle_le_smsInbox2_GetMsgLen(msgRef); break;
        case _MSGID_le_smsInbox2_GetText : Handle_le_smsInbox2_GetText(msgRef); break;
        case _MSGID_le_smsInbox2_GetBinary : Handle_le_smsInbox2_GetBinary(msgRef); break;
        case _MSGID_le_smsInbox2_GetPdu : Handle_le_smsInbox2_GetPdu(msgRef); break;
        case _MSGID_le_smsInbox2_GetFirst : Handle_le_smsInbox2_GetFirst(msgRef); break;
        case _MSGID_le_smsInbox2_GetNext : Handle_le_smsInbox2_GetNext(msgRef); break;
        case _MSGID_le_smsInbox2_IsUnread : Handle_le_smsInbox2_IsUnread(msgRef); break;
        case _MSGID_le_smsInbox2_MarkRead : Handle_le_smsInbox2_MarkRead(msgRef); break;
        case _MSGID_le_smsInbox2_MarkUnread : Handle_le_smsInbox2_MarkUnread(msgRef); break;
        case _MSGID_le_smsInbox2_SetMaxMessages : Handle_le_smsInbox2_SetMaxMessages(msgRef); break;
        case _MSGID_le_smsInbox2_GetMaxMessages : Handle_le_smsInbox2_GetMaxMessages(msgRef); break;
