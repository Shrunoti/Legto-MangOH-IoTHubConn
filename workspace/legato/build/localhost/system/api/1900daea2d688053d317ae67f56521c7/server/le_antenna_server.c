...
#include "le_antenna_messages.h"
#include "le_antenna_server.h"
...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_antenna_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_antenna_ServerHandlers", 3);
...
static void Handle_le_antenna_Request
(
...
)
{
    ...
    // Call the function
    le_antenna_ObjRef_t _result;
    _result  = le_antenna_Request ( 
        antennaType );
...
static void Handle_le_antenna_GetType
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    le_antenna_Type_t antennaTypeBuffer;
    le_antenna_Type_t *antennaTypePtr = &antennaTypeBuffer;
...
static void Handle_le_antenna_SetShortLimit
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_antenna_SetShortLimit ( 
        antennaRef, 
        shortLimit );
...
static void Handle_le_antenna_GetShortLimit
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    uint32_t shortLimitBuffer;
    uint32_t *shortLimitPtr = &shortLimitBuffer;
    if (!(_requiredOutputs & (1u << 0)))
    {
        shortLimitPtr = NULL;
    }
    ...
    // Call the function
    le_result_t _result;
    _result  = le_antenna_GetShortLimit ( 
        antennaRef, 
        shortLimitPtr );
...
static void Handle_le_antenna_SetOpenLimit
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_antenna_SetOpenLimit ( 
        antennaRef, 
        openLimit );
...
static void Handle_le_antenna_GetOpenLimit
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    uint32_t openLimitBuffer;
    uint32_t *openLimitPtr = &openLimitBuffer;
    if (!(_requiredOutputs & (1u << 0)))
    {
        openLimitPtr = NULL;
    }
    ...
    // Call the function
    le_result_t _result;
    _result  = le_antenna_GetOpenLimit ( 
        antennaRef, 
        openLimitPtr );
...
static void AsyncResponse_le_antenna_AddStatusEventHandler
(
    le_antenna_ObjRef_t antennaRef,
...
)
{
    ...
    _msgPtr->id = _MSGID_le_antenna_AddStatusEventHandler;
...
static void Handle_le_antenna_AddStatusEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_antenna_StatusEventHandlerRef_t _result;
    _result  = le_antenna_AddStatusEventHandler ( 
        antennaRef, AsyncResponse_le_antenna_AddStatusEventHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_antenna_RemoveStatusEventHandler;
...
static void Handle_le_antenna_RemoveStatusEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_antenna_StatusEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);
...
static void Handle_le_antenna_GetStatus
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    le_antenna_Status_t statusBuffer;
    le_antenna_Status_t *statusPtr = &statusBuffer;
    if (!(_requiredOutputs & (1u << 0)))
    {
        statusPtr = NULL;
    }
...
static void Handle_le_antenna_SetExternalAdc
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_antenna_SetExternalAdc ( 
        antennaRef, 
        adcId );
...
static void Handle_le_antenna_GetExternalAdc
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_antenna_GetExternalAdc ( 
        antennaRef, 
        adcIdPtr );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_antenna_Request : Handle_le_antenna_Request(msgRef); break;
        case _MSGID_le_antenna_GetType : Handle_le_antenna_GetType(msgRef); break;
        case _MSGID_le_antenna_SetShortLimit : Handle_le_antenna_SetShortLimit(msgRef); break;
        case _MSGID_le_antenna_GetShortLimit : Handle_le_antenna_GetShortLimit(msgRef); break;
        case _MSGID_le_antenna_SetOpenLimit : Handle_le_antenna_SetOpenLimit(msgRef); break;
        case _MSGID_le_antenna_GetOpenLimit : Handle_le_antenna_GetOpenLimit(msgRef); break;
        case _MSGID_le_antenna_AddStatusEventHandler : Handle_le_antenna_AddStatusEventHandler(msgRef); break;
        case _MSGID_le_antenna_RemoveStatusEventHandler : Handle_le_antenna_RemoveStatusEventHandler(msgRef); break;
        case _MSGID_le_antenna_GetStatus : Handle_le_antenna_GetStatus(msgRef); break;
        case _MSGID_le_antenna_SetExternalAdc : Handle_le_antenna_SetExternalAdc(msgRef); break;
        case _MSGID_le_antenna_GetExternalAdc : Handle_le_antenna_GetExternalAdc(msgRef); break;
