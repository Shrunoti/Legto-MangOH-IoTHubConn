...
#include "le_voicecall_messages.h"
#include "le_voicecall_server.h"
...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_voicecall_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_voicecall_ServerHandlers", 3);
...
static void AsyncResponse_le_voicecall_AddStateHandler
(
...
)
{
    ...
    _msgPtr->id = _MSGID_le_voicecall_AddStateHandler;
...
static void Handle_le_voicecall_AddStateHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_voicecall_StateHandlerRef_t _result;
    _result  = le_voicecall_AddStateHandler ( AsyncResponse_le_voicecall_AddStateHandler, 
        contextPtr );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_voicecall_RemoveStateHandler;
...
static void Handle_le_voicecall_RemoveStateHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_voicecall_StateHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);
...
static void Handle_le_voicecall_Start
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_voicecall_CallRef_t _result;
    _result  = le_voicecall_Start ( 
        DestinationID );
...
static void Handle_le_voicecall_End
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_voicecall_Delete
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_voicecall_Answer
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_voicecall_GetTerminationReason
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Define storage for output parameters
    le_voicecall_TerminationReason_t reasonBuffer;
    le_voicecall_TerminationReason_t *reasonPtr = &reasonBuffer;
    ...
    // Call the function
    le_result_t _result;
    _result  = le_voicecall_GetTerminationReason ( 
        reference, 
        reasonPtr );
...
static void Handle_le_voicecall_GetTxAudioStream
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _result  = le_voicecall_GetTxAudioStream ( 
        reference );
...
static void Handle_le_voicecall_GetRxAudioStream
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_audio_StreamRef_t _result;
    _result  = le_voicecall_GetRxAudioStream ( 
        reference );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_voicecall_AddStateHandler : Handle_le_voicecall_AddStateHandler(msgRef); break;
        case _MSGID_le_voicecall_RemoveStateHandler : Handle_le_voicecall_RemoveStateHandler(msgRef); break;
        case _MSGID_le_voicecall_Start : Handle_le_voicecall_Start(msgRef); break;
        case _MSGID_le_voicecall_End : Handle_le_voicecall_End(msgRef); break;
        case _MSGID_le_voicecall_Delete : Handle_le_voicecall_Delete(msgRef); break;
        case _MSGID_le_voicecall_Answer : Handle_le_voicecall_Answer(msgRef); break;
        case _MSGID_le_voicecall_GetTerminationReason : Handle_le_voicecall_GetTerminationReason(msgRef); break;
        case _MSGID_le_voicecall_GetTxAudioStream : Handle_le_voicecall_GetTxAudioStream(msgRef); break;
        case _MSGID_le_voicecall_GetRxAudioStream : Handle_le_voicecall_GetRxAudioStream(msgRef); break;
