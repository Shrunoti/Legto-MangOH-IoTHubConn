...
typedef enum
{
    LE_GPIOPIN61_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    LE_GPIOPIN61_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
le_gpioPin61_Polarity_t;
...
typedef enum
{
    LE_GPIOPIN61_EDGE_NONE = 0,
        ///< No edge detection
    LE_GPIOPIN61_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    LE_GPIOPIN61_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    LE_GPIOPIN61_EDGE_BOTH = 3
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef struct le_gpioPin61_ChangeEventHandler* le_gpioPin61_ChangeEventHandlerRef_t;
...
typedef enum
{
    LE_GPIOPIN61_PULL_OFF = 0,
        ///< Neither resistor is enabled
    LE_GPIOPIN61_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    LE_GPIOPIN61_PULL_UP = 2
        ///< Pullup resistor is enabled
}
le_gpioPin61_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_gpioPin61_ChangeCallbackFunc_t)
(
    bool state,
