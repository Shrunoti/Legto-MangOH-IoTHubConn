...
#include "le_gpioPin63_messages.h"
#include "le_gpioPin63_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin63_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin63_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin63_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin63_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin63_ServerHandlers", 3);
...
static void Handle_le_gpioPin63_SetInput
(
...
)
{
    ...
    le_gpioPin63_Polarity_t polarity;
...
static void Handle_le_gpioPin63_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin63_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin63_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin63_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin63_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin63_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin63_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin63_EnablePullUp (  );
...
static void Handle_le_gpioPin63_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin63_EnablePullDown (  );
...
static void Handle_le_gpioPin63_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin63_DisableResistors (  );
...
static void Handle_le_gpioPin63_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin63_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin63_Deactivate (  );
...
static void Handle_le_gpioPin63_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin63_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin63_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin63_AddChangeEventHandler;
...
static void Handle_le_gpioPin63_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin63_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin63_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin63_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin63_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin63_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin63_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin63_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin63_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin63_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin63_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin63_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin63_DisableEdgeSense (  );
...
static void Handle_le_gpioPin63_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin63_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin63_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin63_Edge_t _result;
    _result  = le_gpioPin63_GetEdgeSense (  );
...
static void Handle_le_gpioPin63_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin63_Polarity_t _result;
    _result  = le_gpioPin63_GetPolarity (  );
...
static void Handle_le_gpioPin63_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin63_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin63_PullUpDown_t _result;
    _result  = le_gpioPin63_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin63_SetInput : Handle_le_gpioPin63_SetInput(msgRef); break;
        case _MSGID_le_gpioPin63_SetPushPullOutput : Handle_le_gpioPin63_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin63_SetTriStateOutput : Handle_le_gpioPin63_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin63_SetOpenDrainOutput : Handle_le_gpioPin63_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin63_EnablePullUp : Handle_le_gpioPin63_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin63_EnablePullDown : Handle_le_gpioPin63_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin63_DisableResistors : Handle_le_gpioPin63_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin63_Activate : Handle_le_gpioPin63_Activate(msgRef); break;
        case _MSGID_le_gpioPin63_Deactivate : Handle_le_gpioPin63_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin63_SetHighZ : Handle_le_gpioPin63_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin63_Read : Handle_le_gpioPin63_Read(msgRef); break;
        case _MSGID_le_gpioPin63_AddChangeEventHandler : Handle_le_gpioPin63_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin63_RemoveChangeEventHandler : Handle_le_gpioPin63_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin63_SetEdgeSense : Handle_le_gpioPin63_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin63_DisableEdgeSense : Handle_le_gpioPin63_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin63_IsOutput : Handle_le_gpioPin63_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin63_IsInput : Handle_le_gpioPin63_IsInput(msgRef); break;
        case _MSGID_le_gpioPin63_GetEdgeSense : Handle_le_gpioPin63_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin63_GetPolarity : Handle_le_gpioPin63_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin63_IsActive : Handle_le_gpioPin63_IsActive(msgRef); break;
        case _MSGID_le_gpioPin63_GetPullUpDown : Handle_le_gpioPin63_GetPullUpDown(msgRef); break;
