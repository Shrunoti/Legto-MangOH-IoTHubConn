...
#ifndef LE_GPIOPIN52_INTERFACE_H_INCLUDE_GUARD
#define LE_GPIOPIN52_INTERFACE_H_INCLUDE_GUARD
...
typedef enum
{
    LE_GPIOPIN52_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    LE_GPIOPIN52_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
le_gpioPin52_Polarity_t;
...
typedef enum
{
    LE_GPIOPIN52_EDGE_NONE = 0,
        ///< No edge detection
    LE_GPIOPIN52_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    LE_GPIOPIN52_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    LE_GPIOPIN52_EDGE_BOTH = 3
...
//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'le_gpioPin52_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct le_gpioPin52_ChangeEventHandler* le_gpioPin52_ChangeEventHandlerRef_t;
...
typedef enum
{
    LE_GPIOPIN52_PULL_OFF = 0,
        ///< Neither resistor is enabled
    LE_GPIOPIN52_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    LE_GPIOPIN52_PULL_UP = 2
        ///< Pullup resistor is enabled
}
le_gpioPin52_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_gpioPin52_ChangeCallbackFunc_t)
(
    bool state,
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin52_SetInput
(
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin52_SetPushPullOutput
(
    le_gpioPin52_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin52_SetTriStateOutput
(
    le_gpioPin52_Polarity_t polarity
        ///< [IN] Active-high or active-low.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin52_SetOpenDrainOutput
(
    le_gpioPin52_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin52_EnablePullUp
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin52_EnablePullDown
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin52_DisableResistors
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin52_Activate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin52_Deactivate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin52_SetHighZ
(
    void
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'le_gpioPin52_ChangeEvent'
 *
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'le_gpioPin52_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin52_RemoveChangeEventHandler
(
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin52_SetEdgeSense
(
    le_gpioPin52_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin52_DisableEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin52_Edge_t le_gpioPin52_GetEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin52_Polarity_t le_gpioPin52_GetPolarity
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin52_PullUpDown_t le_gpioPin52_GetPullUpDown
(
    void
);


#endif // LE_GPIOPIN52_INTERFACE_H_INCLUDE_GUARD