...
#include "le_gpioPin18_messages.h"
#include "le_gpioPin18_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin18_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin18_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin18_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin18_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin18_ServerHandlers", 3);
...
static void Handle_le_gpioPin18_SetInput
(
...
)
{
    ...
    le_gpioPin18_Polarity_t polarity;
...
static void Handle_le_gpioPin18_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin18_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin18_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin18_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin18_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin18_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin18_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin18_EnablePullUp (  );
...
static void Handle_le_gpioPin18_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin18_EnablePullDown (  );
...
static void Handle_le_gpioPin18_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin18_DisableResistors (  );
...
static void Handle_le_gpioPin18_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin18_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin18_Deactivate (  );
...
static void Handle_le_gpioPin18_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin18_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin18_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin18_AddChangeEventHandler;
...
static void Handle_le_gpioPin18_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin18_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin18_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin18_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin18_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin18_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin18_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin18_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin18_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin18_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin18_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin18_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin18_DisableEdgeSense (  );
...
static void Handle_le_gpioPin18_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin18_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin18_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin18_Edge_t _result;
    _result  = le_gpioPin18_GetEdgeSense (  );
...
static void Handle_le_gpioPin18_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin18_Polarity_t _result;
    _result  = le_gpioPin18_GetPolarity (  );
...
static void Handle_le_gpioPin18_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin18_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin18_PullUpDown_t _result;
    _result  = le_gpioPin18_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin18_SetInput : Handle_le_gpioPin18_SetInput(msgRef); break;
        case _MSGID_le_gpioPin18_SetPushPullOutput : Handle_le_gpioPin18_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin18_SetTriStateOutput : Handle_le_gpioPin18_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin18_SetOpenDrainOutput : Handle_le_gpioPin18_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin18_EnablePullUp : Handle_le_gpioPin18_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin18_EnablePullDown : Handle_le_gpioPin18_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin18_DisableResistors : Handle_le_gpioPin18_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin18_Activate : Handle_le_gpioPin18_Activate(msgRef); break;
        case _MSGID_le_gpioPin18_Deactivate : Handle_le_gpioPin18_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin18_SetHighZ : Handle_le_gpioPin18_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin18_Read : Handle_le_gpioPin18_Read(msgRef); break;
        case _MSGID_le_gpioPin18_AddChangeEventHandler : Handle_le_gpioPin18_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin18_RemoveChangeEventHandler : Handle_le_gpioPin18_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin18_SetEdgeSense : Handle_le_gpioPin18_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin18_DisableEdgeSense : Handle_le_gpioPin18_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin18_IsOutput : Handle_le_gpioPin18_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin18_IsInput : Handle_le_gpioPin18_IsInput(msgRef); break;
        case _MSGID_le_gpioPin18_GetEdgeSense : Handle_le_gpioPin18_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin18_GetPolarity : Handle_le_gpioPin18_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin18_IsActive : Handle_le_gpioPin18_IsActive(msgRef); break;
        case _MSGID_le_gpioPin18_GetPullUpDown : Handle_le_gpioPin18_GetPullUpDown(msgRef); break;
