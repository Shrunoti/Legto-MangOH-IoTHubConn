...
#include "le_gpioPin4_messages.h"
#include "le_gpioPin4_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin4_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin4_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin4_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin4_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin4_ServerHandlers", 3);
...
static void Handle_le_gpioPin4_SetInput
(
...
)
{
    ...
    le_gpioPin4_Polarity_t polarity;
...
static void Handle_le_gpioPin4_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin4_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin4_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin4_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin4_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin4_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin4_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin4_EnablePullUp (  );
...
static void Handle_le_gpioPin4_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin4_EnablePullDown (  );
...
static void Handle_le_gpioPin4_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin4_DisableResistors (  );
...
static void Handle_le_gpioPin4_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin4_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin4_Deactivate (  );
...
static void Handle_le_gpioPin4_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin4_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin4_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin4_AddChangeEventHandler;
...
static void Handle_le_gpioPin4_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin4_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin4_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin4_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin4_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin4_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin4_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin4_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin4_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin4_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin4_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin4_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin4_DisableEdgeSense (  );
...
static void Handle_le_gpioPin4_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin4_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin4_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin4_Edge_t _result;
    _result  = le_gpioPin4_GetEdgeSense (  );
...
static void Handle_le_gpioPin4_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin4_Polarity_t _result;
    _result  = le_gpioPin4_GetPolarity (  );
...
static void Handle_le_gpioPin4_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin4_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin4_PullUpDown_t _result;
    _result  = le_gpioPin4_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin4_SetInput : Handle_le_gpioPin4_SetInput(msgRef); break;
        case _MSGID_le_gpioPin4_SetPushPullOutput : Handle_le_gpioPin4_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin4_SetTriStateOutput : Handle_le_gpioPin4_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin4_SetOpenDrainOutput : Handle_le_gpioPin4_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin4_EnablePullUp : Handle_le_gpioPin4_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin4_EnablePullDown : Handle_le_gpioPin4_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin4_DisableResistors : Handle_le_gpioPin4_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin4_Activate : Handle_le_gpioPin4_Activate(msgRef); break;
        case _MSGID_le_gpioPin4_Deactivate : Handle_le_gpioPin4_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin4_SetHighZ : Handle_le_gpioPin4_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin4_Read : Handle_le_gpioPin4_Read(msgRef); break;
        case _MSGID_le_gpioPin4_AddChangeEventHandler : Handle_le_gpioPin4_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin4_RemoveChangeEventHandler : Handle_le_gpioPin4_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin4_SetEdgeSense : Handle_le_gpioPin4_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin4_DisableEdgeSense : Handle_le_gpioPin4_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin4_IsOutput : Handle_le_gpioPin4_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin4_IsInput : Handle_le_gpioPin4_IsInput(msgRef); break;
        case _MSGID_le_gpioPin4_GetEdgeSense : Handle_le_gpioPin4_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin4_GetPolarity : Handle_le_gpioPin4_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin4_IsActive : Handle_le_gpioPin4_IsActive(msgRef); break;
        case _MSGID_le_gpioPin4_GetPullUpDown : Handle_le_gpioPin4_GetPullUpDown(msgRef); break;
