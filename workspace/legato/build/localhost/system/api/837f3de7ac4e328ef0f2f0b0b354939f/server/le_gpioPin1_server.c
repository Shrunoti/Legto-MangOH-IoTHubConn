...
#include "le_gpioPin1_messages.h"
#include "le_gpioPin1_server.h"
...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin1_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin1_ServerHandlers", 3);
...
static void Handle_le_gpioPin1_SetInput
(
...
static void Handle_le_gpioPin1_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin1_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin1_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin1_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin1_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin1_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin1_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin1_EnablePullUp (  );
...
static void Handle_le_gpioPin1_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin1_EnablePullDown (  );
...
static void Handle_le_gpioPin1_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin1_DisableResistors (  );
...
static void Handle_le_gpioPin1_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin1_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin1_Deactivate (  );
...
static void Handle_le_gpioPin1_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin1_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin1_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin1_AddChangeEventHandler;
...
static void Handle_le_gpioPin1_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin1_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin1_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin1_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin1_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin1_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_gpioPin1_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin1_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin1_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin1_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin1_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin1_DisableEdgeSense (  );
...
static void Handle_le_gpioPin1_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin1_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin1_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin1_Edge_t _result;
    _result  = le_gpioPin1_GetEdgeSense (  );
...
static void Handle_le_gpioPin1_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin1_Polarity_t _result;
    _result  = le_gpioPin1_GetPolarity (  );
...
static void Handle_le_gpioPin1_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin1_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin1_PullUpDown_t _result;
    _result  = le_gpioPin1_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin1_SetInput : Handle_le_gpioPin1_SetInput(msgRef); break;
        case _MSGID_le_gpioPin1_SetPushPullOutput : Handle_le_gpioPin1_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin1_SetTriStateOutput : Handle_le_gpioPin1_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin1_SetOpenDrainOutput : Handle_le_gpioPin1_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin1_EnablePullUp : Handle_le_gpioPin1_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin1_EnablePullDown : Handle_le_gpioPin1_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin1_DisableResistors : Handle_le_gpioPin1_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin1_Activate : Handle_le_gpioPin1_Activate(msgRef); break;
        case _MSGID_le_gpioPin1_Deactivate : Handle_le_gpioPin1_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin1_SetHighZ : Handle_le_gpioPin1_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin1_Read : Handle_le_gpioPin1_Read(msgRef); break;
        case _MSGID_le_gpioPin1_AddChangeEventHandler : Handle_le_gpioPin1_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin1_RemoveChangeEventHandler : Handle_le_gpioPin1_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin1_SetEdgeSense : Handle_le_gpioPin1_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin1_DisableEdgeSense : Handle_le_gpioPin1_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin1_IsOutput : Handle_le_gpioPin1_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin1_IsInput : Handle_le_gpioPin1_IsInput(msgRef); break;
        case _MSGID_le_gpioPin1_GetEdgeSense : Handle_le_gpioPin1_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin1_GetPolarity : Handle_le_gpioPin1_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin1_IsActive : Handle_le_gpioPin1_IsActive(msgRef); break;
        case _MSGID_le_gpioPin1_GetPullUpDown : Handle_le_gpioPin1_GetPullUpDown(msgRef); break;
