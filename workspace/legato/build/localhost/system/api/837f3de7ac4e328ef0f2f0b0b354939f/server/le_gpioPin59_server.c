...
#include "le_gpioPin59_messages.h"
#include "le_gpioPin59_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin59_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin59_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin59_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin59_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin59_ServerHandlers", 3);
...
static void Handle_le_gpioPin59_SetInput
(
...
)
{
    ...
    le_gpioPin59_Polarity_t polarity;
...
static void Handle_le_gpioPin59_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin59_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin59_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin59_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin59_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin59_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin59_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin59_EnablePullUp (  );
...
static void Handle_le_gpioPin59_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin59_EnablePullDown (  );
...
static void Handle_le_gpioPin59_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin59_DisableResistors (  );
...
static void Handle_le_gpioPin59_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin59_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin59_Deactivate (  );
...
static void Handle_le_gpioPin59_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin59_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin59_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin59_AddChangeEventHandler;
...
static void Handle_le_gpioPin59_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin59_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin59_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin59_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin59_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin59_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin59_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin59_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin59_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin59_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin59_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin59_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin59_DisableEdgeSense (  );
...
static void Handle_le_gpioPin59_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin59_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin59_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin59_Edge_t _result;
    _result  = le_gpioPin59_GetEdgeSense (  );
...
static void Handle_le_gpioPin59_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin59_Polarity_t _result;
    _result  = le_gpioPin59_GetPolarity (  );
...
static void Handle_le_gpioPin59_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin59_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin59_PullUpDown_t _result;
    _result  = le_gpioPin59_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin59_SetInput : Handle_le_gpioPin59_SetInput(msgRef); break;
        case _MSGID_le_gpioPin59_SetPushPullOutput : Handle_le_gpioPin59_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin59_SetTriStateOutput : Handle_le_gpioPin59_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin59_SetOpenDrainOutput : Handle_le_gpioPin59_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin59_EnablePullUp : Handle_le_gpioPin59_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin59_EnablePullDown : Handle_le_gpioPin59_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin59_DisableResistors : Handle_le_gpioPin59_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin59_Activate : Handle_le_gpioPin59_Activate(msgRef); break;
        case _MSGID_le_gpioPin59_Deactivate : Handle_le_gpioPin59_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin59_SetHighZ : Handle_le_gpioPin59_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin59_Read : Handle_le_gpioPin59_Read(msgRef); break;
        case _MSGID_le_gpioPin59_AddChangeEventHandler : Handle_le_gpioPin59_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin59_RemoveChangeEventHandler : Handle_le_gpioPin59_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin59_SetEdgeSense : Handle_le_gpioPin59_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin59_DisableEdgeSense : Handle_le_gpioPin59_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin59_IsOutput : Handle_le_gpioPin59_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin59_IsInput : Handle_le_gpioPin59_IsInput(msgRef); break;
        case _MSGID_le_gpioPin59_GetEdgeSense : Handle_le_gpioPin59_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin59_GetPolarity : Handle_le_gpioPin59_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin59_IsActive : Handle_le_gpioPin59_IsActive(msgRef); break;
        case _MSGID_le_gpioPin59_GetPullUpDown : Handle_le_gpioPin59_GetPullUpDown(msgRef); break;
