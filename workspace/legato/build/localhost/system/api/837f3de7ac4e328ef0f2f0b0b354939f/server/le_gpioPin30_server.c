...
#include "le_gpioPin30_messages.h"
#include "le_gpioPin30_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin30_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin30_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin30_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin30_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin30_ServerHandlers", 3);
...
static void Handle_le_gpioPin30_SetInput
(
...
)
{
    ...
    le_gpioPin30_Polarity_t polarity;
...
static void Handle_le_gpioPin30_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin30_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin30_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin30_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin30_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin30_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin30_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin30_EnablePullUp (  );
...
static void Handle_le_gpioPin30_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin30_EnablePullDown (  );
...
static void Handle_le_gpioPin30_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin30_DisableResistors (  );
...
static void Handle_le_gpioPin30_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin30_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin30_Deactivate (  );
...
static void Handle_le_gpioPin30_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin30_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin30_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin30_AddChangeEventHandler;
...
static void Handle_le_gpioPin30_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin30_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin30_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin30_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin30_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin30_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin30_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin30_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin30_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin30_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin30_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin30_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin30_DisableEdgeSense (  );
...
static void Handle_le_gpioPin30_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin30_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin30_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin30_Edge_t _result;
    _result  = le_gpioPin30_GetEdgeSense (  );
...
static void Handle_le_gpioPin30_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin30_Polarity_t _result;
    _result  = le_gpioPin30_GetPolarity (  );
...
static void Handle_le_gpioPin30_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin30_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin30_PullUpDown_t _result;
    _result  = le_gpioPin30_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin30_SetInput : Handle_le_gpioPin30_SetInput(msgRef); break;
        case _MSGID_le_gpioPin30_SetPushPullOutput : Handle_le_gpioPin30_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin30_SetTriStateOutput : Handle_le_gpioPin30_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin30_SetOpenDrainOutput : Handle_le_gpioPin30_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin30_EnablePullUp : Handle_le_gpioPin30_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin30_EnablePullDown : Handle_le_gpioPin30_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin30_DisableResistors : Handle_le_gpioPin30_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin30_Activate : Handle_le_gpioPin30_Activate(msgRef); break;
        case _MSGID_le_gpioPin30_Deactivate : Handle_le_gpioPin30_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin30_SetHighZ : Handle_le_gpioPin30_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin30_Read : Handle_le_gpioPin30_Read(msgRef); break;
        case _MSGID_le_gpioPin30_AddChangeEventHandler : Handle_le_gpioPin30_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin30_RemoveChangeEventHandler : Handle_le_gpioPin30_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin30_SetEdgeSense : Handle_le_gpioPin30_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin30_DisableEdgeSense : Handle_le_gpioPin30_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin30_IsOutput : Handle_le_gpioPin30_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin30_IsInput : Handle_le_gpioPin30_IsInput(msgRef); break;
        case _MSGID_le_gpioPin30_GetEdgeSense : Handle_le_gpioPin30_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin30_GetPolarity : Handle_le_gpioPin30_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin30_IsActive : Handle_le_gpioPin30_IsActive(msgRef); break;
        case _MSGID_le_gpioPin30_GetPullUpDown : Handle_le_gpioPin30_GetPullUpDown(msgRef); break;
