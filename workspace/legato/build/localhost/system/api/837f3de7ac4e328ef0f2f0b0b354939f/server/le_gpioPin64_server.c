...
#include "le_gpioPin64_messages.h"
#include "le_gpioPin64_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin64_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin64_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin64_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin64_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin64_ServerHandlers", 3);
...
static void Handle_le_gpioPin64_SetInput
(
...
)
{
    ...
    le_gpioPin64_Polarity_t polarity;
...
static void Handle_le_gpioPin64_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin64_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin64_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin64_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin64_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin64_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin64_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin64_EnablePullUp (  );
...
static void Handle_le_gpioPin64_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin64_EnablePullDown (  );
...
static void Handle_le_gpioPin64_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin64_DisableResistors (  );
...
static void Handle_le_gpioPin64_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin64_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin64_Deactivate (  );
...
static void Handle_le_gpioPin64_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin64_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin64_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin64_AddChangeEventHandler;
...
static void Handle_le_gpioPin64_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin64_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin64_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin64_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin64_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin64_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin64_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin64_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin64_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin64_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin64_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin64_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin64_DisableEdgeSense (  );
...
static void Handle_le_gpioPin64_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin64_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin64_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin64_Edge_t _result;
    _result  = le_gpioPin64_GetEdgeSense (  );
...
static void Handle_le_gpioPin64_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin64_Polarity_t _result;
    _result  = le_gpioPin64_GetPolarity (  );
...
static void Handle_le_gpioPin64_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin64_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin64_PullUpDown_t _result;
    _result  = le_gpioPin64_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin64_SetInput : Handle_le_gpioPin64_SetInput(msgRef); break;
        case _MSGID_le_gpioPin64_SetPushPullOutput : Handle_le_gpioPin64_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin64_SetTriStateOutput : Handle_le_gpioPin64_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin64_SetOpenDrainOutput : Handle_le_gpioPin64_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin64_EnablePullUp : Handle_le_gpioPin64_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin64_EnablePullDown : Handle_le_gpioPin64_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin64_DisableResistors : Handle_le_gpioPin64_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin64_Activate : Handle_le_gpioPin64_Activate(msgRef); break;
        case _MSGID_le_gpioPin64_Deactivate : Handle_le_gpioPin64_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin64_SetHighZ : Handle_le_gpioPin64_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin64_Read : Handle_le_gpioPin64_Read(msgRef); break;
        case _MSGID_le_gpioPin64_AddChangeEventHandler : Handle_le_gpioPin64_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin64_RemoveChangeEventHandler : Handle_le_gpioPin64_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin64_SetEdgeSense : Handle_le_gpioPin64_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin64_DisableEdgeSense : Handle_le_gpioPin64_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin64_IsOutput : Handle_le_gpioPin64_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin64_IsInput : Handle_le_gpioPin64_IsInput(msgRef); break;
        case _MSGID_le_gpioPin64_GetEdgeSense : Handle_le_gpioPin64_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin64_GetPolarity : Handle_le_gpioPin64_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin64_IsActive : Handle_le_gpioPin64_IsActive(msgRef); break;
        case _MSGID_le_gpioPin64_GetPullUpDown : Handle_le_gpioPin64_GetPullUpDown(msgRef); break;
