...
#include "le_gpioPin52_messages.h"
#include "le_gpioPin52_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin52_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin52_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin52_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin52_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin52_ServerHandlers", 3);
...
static void Handle_le_gpioPin52_SetInput
(
...
)
{
    ...
    le_gpioPin52_Polarity_t polarity;
...
static void Handle_le_gpioPin52_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin52_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin52_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin52_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin52_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin52_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin52_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin52_EnablePullUp (  );
...
static void Handle_le_gpioPin52_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin52_EnablePullDown (  );
...
static void Handle_le_gpioPin52_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin52_DisableResistors (  );
...
static void Handle_le_gpioPin52_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin52_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin52_Deactivate (  );
...
static void Handle_le_gpioPin52_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin52_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin52_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin52_AddChangeEventHandler;
...
static void Handle_le_gpioPin52_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin52_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin52_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin52_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin52_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin52_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin52_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin52_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin52_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin52_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin52_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin52_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin52_DisableEdgeSense (  );
...
static void Handle_le_gpioPin52_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin52_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin52_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin52_Edge_t _result;
    _result  = le_gpioPin52_GetEdgeSense (  );
...
static void Handle_le_gpioPin52_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin52_Polarity_t _result;
    _result  = le_gpioPin52_GetPolarity (  );
...
static void Handle_le_gpioPin52_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin52_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin52_PullUpDown_t _result;
    _result  = le_gpioPin52_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin52_SetInput : Handle_le_gpioPin52_SetInput(msgRef); break;
        case _MSGID_le_gpioPin52_SetPushPullOutput : Handle_le_gpioPin52_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin52_SetTriStateOutput : Handle_le_gpioPin52_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin52_SetOpenDrainOutput : Handle_le_gpioPin52_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin52_EnablePullUp : Handle_le_gpioPin52_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin52_EnablePullDown : Handle_le_gpioPin52_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin52_DisableResistors : Handle_le_gpioPin52_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin52_Activate : Handle_le_gpioPin52_Activate(msgRef); break;
        case _MSGID_le_gpioPin52_Deactivate : Handle_le_gpioPin52_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin52_SetHighZ : Handle_le_gpioPin52_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin52_Read : Handle_le_gpioPin52_Read(msgRef); break;
        case _MSGID_le_gpioPin52_AddChangeEventHandler : Handle_le_gpioPin52_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin52_RemoveChangeEventHandler : Handle_le_gpioPin52_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin52_SetEdgeSense : Handle_le_gpioPin52_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin52_DisableEdgeSense : Handle_le_gpioPin52_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin52_IsOutput : Handle_le_gpioPin52_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin52_IsInput : Handle_le_gpioPin52_IsInput(msgRef); break;
        case _MSGID_le_gpioPin52_GetEdgeSense : Handle_le_gpioPin52_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin52_GetPolarity : Handle_le_gpioPin52_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin52_IsActive : Handle_le_gpioPin52_IsActive(msgRef); break;
        case _MSGID_le_gpioPin52_GetPullUpDown : Handle_le_gpioPin52_GetPullUpDown(msgRef); break;
