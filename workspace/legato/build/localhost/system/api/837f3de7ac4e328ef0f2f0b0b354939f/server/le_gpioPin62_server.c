...
#include "le_gpioPin62_messages.h"
#include "le_gpioPin62_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin62_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin62_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin62_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin62_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin62_ServerHandlers", 3);
...
static void Handle_le_gpioPin62_SetInput
(
...
)
{
    ...
    le_gpioPin62_Polarity_t polarity;
...
static void Handle_le_gpioPin62_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin62_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin62_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin62_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin62_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin62_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin62_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin62_EnablePullUp (  );
...
static void Handle_le_gpioPin62_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin62_EnablePullDown (  );
...
static void Handle_le_gpioPin62_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin62_DisableResistors (  );
...
static void Handle_le_gpioPin62_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin62_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin62_Deactivate (  );
...
static void Handle_le_gpioPin62_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin62_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin62_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin62_AddChangeEventHandler;
...
static void Handle_le_gpioPin62_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin62_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin62_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin62_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin62_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin62_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin62_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin62_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin62_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin62_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin62_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin62_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin62_DisableEdgeSense (  );
...
static void Handle_le_gpioPin62_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin62_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin62_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin62_Edge_t _result;
    _result  = le_gpioPin62_GetEdgeSense (  );
...
static void Handle_le_gpioPin62_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin62_Polarity_t _result;
    _result  = le_gpioPin62_GetPolarity (  );
...
static void Handle_le_gpioPin62_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin62_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin62_PullUpDown_t _result;
    _result  = le_gpioPin62_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin62_SetInput : Handle_le_gpioPin62_SetInput(msgRef); break;
        case _MSGID_le_gpioPin62_SetPushPullOutput : Handle_le_gpioPin62_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin62_SetTriStateOutput : Handle_le_gpioPin62_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin62_SetOpenDrainOutput : Handle_le_gpioPin62_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin62_EnablePullUp : Handle_le_gpioPin62_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin62_EnablePullDown : Handle_le_gpioPin62_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin62_DisableResistors : Handle_le_gpioPin62_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin62_Activate : Handle_le_gpioPin62_Activate(msgRef); break;
        case _MSGID_le_gpioPin62_Deactivate : Handle_le_gpioPin62_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin62_SetHighZ : Handle_le_gpioPin62_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin62_Read : Handle_le_gpioPin62_Read(msgRef); break;
        case _MSGID_le_gpioPin62_AddChangeEventHandler : Handle_le_gpioPin62_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin62_RemoveChangeEventHandler : Handle_le_gpioPin62_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin62_SetEdgeSense : Handle_le_gpioPin62_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin62_DisableEdgeSense : Handle_le_gpioPin62_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin62_IsOutput : Handle_le_gpioPin62_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin62_IsInput : Handle_le_gpioPin62_IsInput(msgRef); break;
        case _MSGID_le_gpioPin62_GetEdgeSense : Handle_le_gpioPin62_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin62_GetPolarity : Handle_le_gpioPin62_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin62_IsActive : Handle_le_gpioPin62_IsActive(msgRef); break;
        case _MSGID_le_gpioPin62_GetPullUpDown : Handle_le_gpioPin62_GetPullUpDown(msgRef); break;
