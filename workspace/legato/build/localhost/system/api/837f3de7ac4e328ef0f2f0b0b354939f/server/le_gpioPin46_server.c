...
#include "le_gpioPin46_messages.h"
#include "le_gpioPin46_server.h"
...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin46_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin46_ServerHandlers", 3);
...
static void Handle_le_gpioPin46_SetInput
(
...
static void Handle_le_gpioPin46_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin46_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin46_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin46_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin46_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin46_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin46_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin46_EnablePullUp (  );
...
static void Handle_le_gpioPin46_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin46_EnablePullDown (  );
...
static void Handle_le_gpioPin46_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin46_DisableResistors (  );
...
static void Handle_le_gpioPin46_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin46_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin46_Deactivate (  );
...
static void Handle_le_gpioPin46_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin46_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin46_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin46_AddChangeEventHandler;
...
static void Handle_le_gpioPin46_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin46_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin46_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin46_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin46_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin46_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_gpioPin46_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin46_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin46_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin46_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin46_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin46_DisableEdgeSense (  );
...
static void Handle_le_gpioPin46_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin46_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin46_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin46_Edge_t _result;
    _result  = le_gpioPin46_GetEdgeSense (  );
...
static void Handle_le_gpioPin46_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin46_Polarity_t _result;
    _result  = le_gpioPin46_GetPolarity (  );
...
static void Handle_le_gpioPin46_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin46_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin46_PullUpDown_t _result;
    _result  = le_gpioPin46_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin46_SetInput : Handle_le_gpioPin46_SetInput(msgRef); break;
        case _MSGID_le_gpioPin46_SetPushPullOutput : Handle_le_gpioPin46_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin46_SetTriStateOutput : Handle_le_gpioPin46_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin46_SetOpenDrainOutput : Handle_le_gpioPin46_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin46_EnablePullUp : Handle_le_gpioPin46_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin46_EnablePullDown : Handle_le_gpioPin46_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin46_DisableResistors : Handle_le_gpioPin46_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin46_Activate : Handle_le_gpioPin46_Activate(msgRef); break;
        case _MSGID_le_gpioPin46_Deactivate : Handle_le_gpioPin46_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin46_SetHighZ : Handle_le_gpioPin46_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin46_Read : Handle_le_gpioPin46_Read(msgRef); break;
        case _MSGID_le_gpioPin46_AddChangeEventHandler : Handle_le_gpioPin46_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin46_RemoveChangeEventHandler : Handle_le_gpioPin46_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin46_SetEdgeSense : Handle_le_gpioPin46_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin46_DisableEdgeSense : Handle_le_gpioPin46_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin46_IsOutput : Handle_le_gpioPin46_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin46_IsInput : Handle_le_gpioPin46_IsInput(msgRef); break;
        case _MSGID_le_gpioPin46_GetEdgeSense : Handle_le_gpioPin46_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin46_GetPolarity : Handle_le_gpioPin46_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin46_IsActive : Handle_le_gpioPin46_IsActive(msgRef); break;
        case _MSGID_le_gpioPin46_GetPullUpDown : Handle_le_gpioPin46_GetPullUpDown(msgRef); break;
