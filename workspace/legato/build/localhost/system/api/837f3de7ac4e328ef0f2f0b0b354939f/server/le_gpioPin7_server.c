...
#include "le_gpioPin7_messages.h"
#include "le_gpioPin7_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin7_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin7_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin7_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin7_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin7_ServerHandlers", 3);
...
static void Handle_le_gpioPin7_SetInput
(
...
static void Handle_le_gpioPin7_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin7_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin7_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin7_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin7_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin7_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin7_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin7_EnablePullUp (  );
...
static void Handle_le_gpioPin7_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin7_EnablePullDown (  );
...
static void Handle_le_gpioPin7_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin7_DisableResistors (  );
...
static void Handle_le_gpioPin7_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin7_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin7_Deactivate (  );
...
static void Handle_le_gpioPin7_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin7_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin7_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin7_AddChangeEventHandler;
...
static void Handle_le_gpioPin7_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin7_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin7_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin7_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin7_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin7_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin7_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin7_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin7_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin7_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin7_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin7_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin7_DisableEdgeSense (  );
...
static void Handle_le_gpioPin7_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin7_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin7_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin7_Edge_t _result;
    _result  = le_gpioPin7_GetEdgeSense (  );
...
static void Handle_le_gpioPin7_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin7_Polarity_t _result;
    _result  = le_gpioPin7_GetPolarity (  );
...
static void Handle_le_gpioPin7_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin7_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin7_PullUpDown_t _result;
    _result  = le_gpioPin7_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin7_SetInput : Handle_le_gpioPin7_SetInput(msgRef); break;
        case _MSGID_le_gpioPin7_SetPushPullOutput : Handle_le_gpioPin7_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin7_SetTriStateOutput : Handle_le_gpioPin7_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin7_SetOpenDrainOutput : Handle_le_gpioPin7_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin7_EnablePullUp : Handle_le_gpioPin7_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin7_EnablePullDown : Handle_le_gpioPin7_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin7_DisableResistors : Handle_le_gpioPin7_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin7_Activate : Handle_le_gpioPin7_Activate(msgRef); break;
        case _MSGID_le_gpioPin7_Deactivate : Handle_le_gpioPin7_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin7_SetHighZ : Handle_le_gpioPin7_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin7_Read : Handle_le_gpioPin7_Read(msgRef); break;
        case _MSGID_le_gpioPin7_AddChangeEventHandler : Handle_le_gpioPin7_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin7_RemoveChangeEventHandler : Handle_le_gpioPin7_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin7_SetEdgeSense : Handle_le_gpioPin7_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin7_DisableEdgeSense : Handle_le_gpioPin7_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin7_IsOutput : Handle_le_gpioPin7_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin7_IsInput : Handle_le_gpioPin7_IsInput(msgRef); break;
        case _MSGID_le_gpioPin7_GetEdgeSense : Handle_le_gpioPin7_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin7_GetPolarity : Handle_le_gpioPin7_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin7_IsActive : Handle_le_gpioPin7_IsActive(msgRef); break;
        case _MSGID_le_gpioPin7_GetPullUpDown : Handle_le_gpioPin7_GetPullUpDown(msgRef); break;
