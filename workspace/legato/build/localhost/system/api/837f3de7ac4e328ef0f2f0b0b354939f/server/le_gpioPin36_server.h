...
#ifndef LE_GPIOPIN36_INTERFACE_H_INCLUDE_GUARD
#define LE_GPIOPIN36_INTERFACE_H_INCLUDE_GUARD
...
typedef enum
{
    LE_GPIOPIN36_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    LE_GPIOPIN36_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
le_gpioPin36_Polarity_t;
...
typedef enum
{
    LE_GPIOPIN36_EDGE_NONE = 0,
        ///< No edge detection
    LE_GPIOPIN36_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    LE_GPIOPIN36_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    LE_GPIOPIN36_EDGE_BOTH = 3
...
//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'le_gpioPin36_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct le_gpioPin36_ChangeEventHandler* le_gpioPin36_ChangeEventHandlerRef_t;
...
typedef enum
{
    LE_GPIOPIN36_PULL_OFF = 0,
        ///< Neither resistor is enabled
    LE_GPIOPIN36_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    LE_GPIOPIN36_PULL_UP = 2
        ///< Pullup resistor is enabled
}
le_gpioPin36_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_gpioPin36_ChangeCallbackFunc_t)
(
    bool state,
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin36_SetInput
(
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin36_SetPushPullOutput
(
    le_gpioPin36_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin36_SetTriStateOutput
(
    le_gpioPin36_Polarity_t polarity
        ///< [IN] Active-high or active-low.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin36_SetOpenDrainOutput
(
    le_gpioPin36_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin36_EnablePullUp
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin36_EnablePullDown
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin36_DisableResistors
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin36_Activate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin36_Deactivate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin36_SetHighZ
(
    void
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'le_gpioPin36_ChangeEvent'
 *
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'le_gpioPin36_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin36_RemoveChangeEventHandler
(
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin36_SetEdgeSense
(
    le_gpioPin36_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin36_DisableEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin36_Edge_t le_gpioPin36_GetEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin36_Polarity_t le_gpioPin36_GetPolarity
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin36_PullUpDown_t le_gpioPin36_GetPullUpDown
(
    void
);


#endif // LE_GPIOPIN36_INTERFACE_H_INCLUDE_GUARD