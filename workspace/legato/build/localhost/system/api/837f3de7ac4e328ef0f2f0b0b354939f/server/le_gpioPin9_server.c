...
#include "le_gpioPin9_messages.h"
#include "le_gpioPin9_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin9_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin9_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin9_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin9_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin9_ServerHandlers", 3);
...
static void Handle_le_gpioPin9_SetInput
(
...
)
{
    ...
    le_gpioPin9_Polarity_t polarity;
...
static void Handle_le_gpioPin9_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin9_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin9_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin9_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin9_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin9_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin9_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin9_EnablePullUp (  );
...
static void Handle_le_gpioPin9_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin9_EnablePullDown (  );
...
static void Handle_le_gpioPin9_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin9_DisableResistors (  );
...
static void Handle_le_gpioPin9_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin9_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin9_Deactivate (  );
...
static void Handle_le_gpioPin9_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin9_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin9_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin9_AddChangeEventHandler;
...
static void Handle_le_gpioPin9_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin9_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin9_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin9_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin9_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin9_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin9_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin9_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin9_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin9_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin9_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin9_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin9_DisableEdgeSense (  );
...
static void Handle_le_gpioPin9_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin9_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin9_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin9_Edge_t _result;
    _result  = le_gpioPin9_GetEdgeSense (  );
...
static void Handle_le_gpioPin9_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin9_Polarity_t _result;
    _result  = le_gpioPin9_GetPolarity (  );
...
static void Handle_le_gpioPin9_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin9_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin9_PullUpDown_t _result;
    _result  = le_gpioPin9_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin9_SetInput : Handle_le_gpioPin9_SetInput(msgRef); break;
        case _MSGID_le_gpioPin9_SetPushPullOutput : Handle_le_gpioPin9_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin9_SetTriStateOutput : Handle_le_gpioPin9_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin9_SetOpenDrainOutput : Handle_le_gpioPin9_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin9_EnablePullUp : Handle_le_gpioPin9_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin9_EnablePullDown : Handle_le_gpioPin9_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin9_DisableResistors : Handle_le_gpioPin9_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin9_Activate : Handle_le_gpioPin9_Activate(msgRef); break;
        case _MSGID_le_gpioPin9_Deactivate : Handle_le_gpioPin9_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin9_SetHighZ : Handle_le_gpioPin9_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin9_Read : Handle_le_gpioPin9_Read(msgRef); break;
        case _MSGID_le_gpioPin9_AddChangeEventHandler : Handle_le_gpioPin9_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin9_RemoveChangeEventHandler : Handle_le_gpioPin9_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin9_SetEdgeSense : Handle_le_gpioPin9_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin9_DisableEdgeSense : Handle_le_gpioPin9_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin9_IsOutput : Handle_le_gpioPin9_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin9_IsInput : Handle_le_gpioPin9_IsInput(msgRef); break;
        case _MSGID_le_gpioPin9_GetEdgeSense : Handle_le_gpioPin9_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin9_GetPolarity : Handle_le_gpioPin9_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin9_IsActive : Handle_le_gpioPin9_IsActive(msgRef); break;
        case _MSGID_le_gpioPin9_GetPullUpDown : Handle_le_gpioPin9_GetPullUpDown(msgRef); break;
