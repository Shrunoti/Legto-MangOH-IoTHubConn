...
#include "le_gpioPin49_messages.h"
#include "le_gpioPin49_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin49_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin49_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin49_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin49_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin49_ServerHandlers", 3);
...
static void Handle_le_gpioPin49_SetInput
(
...
)
{
    ...
    le_gpioPin49_Polarity_t polarity;
...
static void Handle_le_gpioPin49_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin49_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin49_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin49_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin49_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin49_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin49_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin49_EnablePullUp (  );
...
static void Handle_le_gpioPin49_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin49_EnablePullDown (  );
...
static void Handle_le_gpioPin49_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin49_DisableResistors (  );
...
static void Handle_le_gpioPin49_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin49_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin49_Deactivate (  );
...
static void Handle_le_gpioPin49_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin49_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin49_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin49_AddChangeEventHandler;
...
static void Handle_le_gpioPin49_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin49_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin49_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin49_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin49_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin49_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin49_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin49_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin49_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin49_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin49_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin49_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin49_DisableEdgeSense (  );
...
static void Handle_le_gpioPin49_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin49_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin49_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin49_Edge_t _result;
    _result  = le_gpioPin49_GetEdgeSense (  );
...
static void Handle_le_gpioPin49_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin49_Polarity_t _result;
    _result  = le_gpioPin49_GetPolarity (  );
...
static void Handle_le_gpioPin49_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin49_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin49_PullUpDown_t _result;
    _result  = le_gpioPin49_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin49_SetInput : Handle_le_gpioPin49_SetInput(msgRef); break;
        case _MSGID_le_gpioPin49_SetPushPullOutput : Handle_le_gpioPin49_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin49_SetTriStateOutput : Handle_le_gpioPin49_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin49_SetOpenDrainOutput : Handle_le_gpioPin49_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin49_EnablePullUp : Handle_le_gpioPin49_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin49_EnablePullDown : Handle_le_gpioPin49_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin49_DisableResistors : Handle_le_gpioPin49_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin49_Activate : Handle_le_gpioPin49_Activate(msgRef); break;
        case _MSGID_le_gpioPin49_Deactivate : Handle_le_gpioPin49_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin49_SetHighZ : Handle_le_gpioPin49_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin49_Read : Handle_le_gpioPin49_Read(msgRef); break;
        case _MSGID_le_gpioPin49_AddChangeEventHandler : Handle_le_gpioPin49_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin49_RemoveChangeEventHandler : Handle_le_gpioPin49_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin49_SetEdgeSense : Handle_le_gpioPin49_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin49_DisableEdgeSense : Handle_le_gpioPin49_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin49_IsOutput : Handle_le_gpioPin49_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin49_IsInput : Handle_le_gpioPin49_IsInput(msgRef); break;
        case _MSGID_le_gpioPin49_GetEdgeSense : Handle_le_gpioPin49_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin49_GetPolarity : Handle_le_gpioPin49_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin49_IsActive : Handle_le_gpioPin49_IsActive(msgRef); break;
        case _MSGID_le_gpioPin49_GetPullUpDown : Handle_le_gpioPin49_GetPullUpDown(msgRef); break;
