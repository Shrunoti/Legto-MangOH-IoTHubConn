...
#include "le_gpioPin57_messages.h"
#include "le_gpioPin57_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin57_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin57_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin57_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin57_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin57_ServerHandlers", 3);
...
static void Handle_le_gpioPin57_SetInput
(
...
)
{
    ...
    le_gpioPin57_Polarity_t polarity;
...
static void Handle_le_gpioPin57_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin57_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin57_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin57_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin57_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin57_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin57_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin57_EnablePullUp (  );
...
static void Handle_le_gpioPin57_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin57_EnablePullDown (  );
...
static void Handle_le_gpioPin57_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin57_DisableResistors (  );
...
static void Handle_le_gpioPin57_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin57_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin57_Deactivate (  );
...
static void Handle_le_gpioPin57_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin57_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin57_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin57_AddChangeEventHandler;
...
static void Handle_le_gpioPin57_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin57_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin57_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin57_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin57_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin57_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin57_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin57_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin57_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin57_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin57_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin57_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin57_DisableEdgeSense (  );
...
static void Handle_le_gpioPin57_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin57_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin57_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin57_Edge_t _result;
    _result  = le_gpioPin57_GetEdgeSense (  );
...
static void Handle_le_gpioPin57_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin57_Polarity_t _result;
    _result  = le_gpioPin57_GetPolarity (  );
...
static void Handle_le_gpioPin57_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin57_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin57_PullUpDown_t _result;
    _result  = le_gpioPin57_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin57_SetInput : Handle_le_gpioPin57_SetInput(msgRef); break;
        case _MSGID_le_gpioPin57_SetPushPullOutput : Handle_le_gpioPin57_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin57_SetTriStateOutput : Handle_le_gpioPin57_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin57_SetOpenDrainOutput : Handle_le_gpioPin57_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin57_EnablePullUp : Handle_le_gpioPin57_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin57_EnablePullDown : Handle_le_gpioPin57_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin57_DisableResistors : Handle_le_gpioPin57_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin57_Activate : Handle_le_gpioPin57_Activate(msgRef); break;
        case _MSGID_le_gpioPin57_Deactivate : Handle_le_gpioPin57_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin57_SetHighZ : Handle_le_gpioPin57_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin57_Read : Handle_le_gpioPin57_Read(msgRef); break;
        case _MSGID_le_gpioPin57_AddChangeEventHandler : Handle_le_gpioPin57_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin57_RemoveChangeEventHandler : Handle_le_gpioPin57_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin57_SetEdgeSense : Handle_le_gpioPin57_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin57_DisableEdgeSense : Handle_le_gpioPin57_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin57_IsOutput : Handle_le_gpioPin57_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin57_IsInput : Handle_le_gpioPin57_IsInput(msgRef); break;
        case _MSGID_le_gpioPin57_GetEdgeSense : Handle_le_gpioPin57_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin57_GetPolarity : Handle_le_gpioPin57_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin57_IsActive : Handle_le_gpioPin57_IsActive(msgRef); break;
        case _MSGID_le_gpioPin57_GetPullUpDown : Handle_le_gpioPin57_GetPullUpDown(msgRef); break;
