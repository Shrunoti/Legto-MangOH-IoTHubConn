...
#include "le_gpioPin43_messages.h"
#include "le_gpioPin43_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin43_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin43_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin43_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin43_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin43_ServerHandlers", 3);
...
static void Handle_le_gpioPin43_SetInput
(
...
)
{
    ...
    le_gpioPin43_Polarity_t polarity;
...
static void Handle_le_gpioPin43_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin43_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin43_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin43_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin43_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin43_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin43_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin43_EnablePullUp (  );
...
static void Handle_le_gpioPin43_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin43_EnablePullDown (  );
...
static void Handle_le_gpioPin43_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin43_DisableResistors (  );
...
static void Handle_le_gpioPin43_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin43_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin43_Deactivate (  );
...
static void Handle_le_gpioPin43_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin43_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin43_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin43_AddChangeEventHandler;
...
static void Handle_le_gpioPin43_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin43_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin43_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin43_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin43_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin43_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin43_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin43_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin43_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin43_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin43_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin43_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin43_DisableEdgeSense (  );
...
static void Handle_le_gpioPin43_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin43_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin43_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin43_Edge_t _result;
    _result  = le_gpioPin43_GetEdgeSense (  );
...
static void Handle_le_gpioPin43_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin43_Polarity_t _result;
    _result  = le_gpioPin43_GetPolarity (  );
...
static void Handle_le_gpioPin43_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin43_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin43_PullUpDown_t _result;
    _result  = le_gpioPin43_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin43_SetInput : Handle_le_gpioPin43_SetInput(msgRef); break;
        case _MSGID_le_gpioPin43_SetPushPullOutput : Handle_le_gpioPin43_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin43_SetTriStateOutput : Handle_le_gpioPin43_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin43_SetOpenDrainOutput : Handle_le_gpioPin43_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin43_EnablePullUp : Handle_le_gpioPin43_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin43_EnablePullDown : Handle_le_gpioPin43_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin43_DisableResistors : Handle_le_gpioPin43_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin43_Activate : Handle_le_gpioPin43_Activate(msgRef); break;
        case _MSGID_le_gpioPin43_Deactivate : Handle_le_gpioPin43_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin43_SetHighZ : Handle_le_gpioPin43_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin43_Read : Handle_le_gpioPin43_Read(msgRef); break;
        case _MSGID_le_gpioPin43_AddChangeEventHandler : Handle_le_gpioPin43_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin43_RemoveChangeEventHandler : Handle_le_gpioPin43_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin43_SetEdgeSense : Handle_le_gpioPin43_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin43_DisableEdgeSense : Handle_le_gpioPin43_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin43_IsOutput : Handle_le_gpioPin43_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin43_IsInput : Handle_le_gpioPin43_IsInput(msgRef); break;
        case _MSGID_le_gpioPin43_GetEdgeSense : Handle_le_gpioPin43_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin43_GetPolarity : Handle_le_gpioPin43_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin43_IsActive : Handle_le_gpioPin43_IsActive(msgRef); break;
        case _MSGID_le_gpioPin43_GetPullUpDown : Handle_le_gpioPin43_GetPullUpDown(msgRef); break;
