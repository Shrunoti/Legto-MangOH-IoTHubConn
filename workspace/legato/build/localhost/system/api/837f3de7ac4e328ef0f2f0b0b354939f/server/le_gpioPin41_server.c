...
#include "le_gpioPin41_messages.h"
#include "le_gpioPin41_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin41_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin41_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin41_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin41_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin41_ServerHandlers", 3);
...
static void Handle_le_gpioPin41_SetInput
(
...
)
{
    ...
    le_gpioPin41_Polarity_t polarity;
...
static void Handle_le_gpioPin41_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin41_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin41_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin41_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin41_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin41_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin41_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin41_EnablePullUp (  );
...
static void Handle_le_gpioPin41_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin41_EnablePullDown (  );
...
static void Handle_le_gpioPin41_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin41_DisableResistors (  );
...
static void Handle_le_gpioPin41_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin41_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin41_Deactivate (  );
...
static void Handle_le_gpioPin41_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin41_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin41_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin41_AddChangeEventHandler;
...
static void Handle_le_gpioPin41_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin41_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin41_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin41_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin41_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin41_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin41_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin41_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin41_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin41_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin41_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin41_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin41_DisableEdgeSense (  );
...
static void Handle_le_gpioPin41_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin41_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin41_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin41_Edge_t _result;
    _result  = le_gpioPin41_GetEdgeSense (  );
...
static void Handle_le_gpioPin41_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin41_Polarity_t _result;
    _result  = le_gpioPin41_GetPolarity (  );
...
static void Handle_le_gpioPin41_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin41_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin41_PullUpDown_t _result;
    _result  = le_gpioPin41_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin41_SetInput : Handle_le_gpioPin41_SetInput(msgRef); break;
        case _MSGID_le_gpioPin41_SetPushPullOutput : Handle_le_gpioPin41_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin41_SetTriStateOutput : Handle_le_gpioPin41_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin41_SetOpenDrainOutput : Handle_le_gpioPin41_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin41_EnablePullUp : Handle_le_gpioPin41_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin41_EnablePullDown : Handle_le_gpioPin41_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin41_DisableResistors : Handle_le_gpioPin41_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin41_Activate : Handle_le_gpioPin41_Activate(msgRef); break;
        case _MSGID_le_gpioPin41_Deactivate : Handle_le_gpioPin41_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin41_SetHighZ : Handle_le_gpioPin41_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin41_Read : Handle_le_gpioPin41_Read(msgRef); break;
        case _MSGID_le_gpioPin41_AddChangeEventHandler : Handle_le_gpioPin41_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin41_RemoveChangeEventHandler : Handle_le_gpioPin41_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin41_SetEdgeSense : Handle_le_gpioPin41_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin41_DisableEdgeSense : Handle_le_gpioPin41_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin41_IsOutput : Handle_le_gpioPin41_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin41_IsInput : Handle_le_gpioPin41_IsInput(msgRef); break;
        case _MSGID_le_gpioPin41_GetEdgeSense : Handle_le_gpioPin41_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin41_GetPolarity : Handle_le_gpioPin41_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin41_IsActive : Handle_le_gpioPin41_IsActive(msgRef); break;
        case _MSGID_le_gpioPin41_GetPullUpDown : Handle_le_gpioPin41_GetPullUpDown(msgRef); break;
