...
#include "le_gpioPin40_messages.h"
#include "le_gpioPin40_server.h"
...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin40_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin40_ServerHandlers", 3);
...
static void Handle_le_gpioPin40_SetInput
(
...
static void Handle_le_gpioPin40_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin40_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin40_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin40_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin40_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin40_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin40_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin40_EnablePullUp (  );
...
static void Handle_le_gpioPin40_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin40_EnablePullDown (  );
...
static void Handle_le_gpioPin40_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin40_DisableResistors (  );
...
static void Handle_le_gpioPin40_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin40_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin40_Deactivate (  );
...
static void Handle_le_gpioPin40_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin40_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin40_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin40_AddChangeEventHandler;
...
static void Handle_le_gpioPin40_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin40_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin40_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin40_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin40_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin40_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_gpioPin40_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin40_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin40_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin40_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin40_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin40_DisableEdgeSense (  );
...
static void Handle_le_gpioPin40_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin40_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin40_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin40_Edge_t _result;
    _result  = le_gpioPin40_GetEdgeSense (  );
...
static void Handle_le_gpioPin40_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin40_Polarity_t _result;
    _result  = le_gpioPin40_GetPolarity (  );
...
static void Handle_le_gpioPin40_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin40_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin40_PullUpDown_t _result;
    _result  = le_gpioPin40_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin40_SetInput : Handle_le_gpioPin40_SetInput(msgRef); break;
        case _MSGID_le_gpioPin40_SetPushPullOutput : Handle_le_gpioPin40_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin40_SetTriStateOutput : Handle_le_gpioPin40_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin40_SetOpenDrainOutput : Handle_le_gpioPin40_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin40_EnablePullUp : Handle_le_gpioPin40_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin40_EnablePullDown : Handle_le_gpioPin40_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin40_DisableResistors : Handle_le_gpioPin40_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin40_Activate : Handle_le_gpioPin40_Activate(msgRef); break;
        case _MSGID_le_gpioPin40_Deactivate : Handle_le_gpioPin40_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin40_SetHighZ : Handle_le_gpioPin40_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin40_Read : Handle_le_gpioPin40_Read(msgRef); break;
        case _MSGID_le_gpioPin40_AddChangeEventHandler : Handle_le_gpioPin40_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin40_RemoveChangeEventHandler : Handle_le_gpioPin40_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin40_SetEdgeSense : Handle_le_gpioPin40_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin40_DisableEdgeSense : Handle_le_gpioPin40_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin40_IsOutput : Handle_le_gpioPin40_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin40_IsInput : Handle_le_gpioPin40_IsInput(msgRef); break;
        case _MSGID_le_gpioPin40_GetEdgeSense : Handle_le_gpioPin40_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin40_GetPolarity : Handle_le_gpioPin40_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin40_IsActive : Handle_le_gpioPin40_IsActive(msgRef); break;
        case _MSGID_le_gpioPin40_GetPullUpDown : Handle_le_gpioPin40_GetPullUpDown(msgRef); break;
