...
#include "le_gpioPin32_messages.h"
#include "le_gpioPin32_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin32_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin32_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin32_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin32_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin32_ServerHandlers", 3);
...
static void Handle_le_gpioPin32_SetInput
(
...
static void Handle_le_gpioPin32_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin32_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin32_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin32_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin32_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin32_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin32_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin32_EnablePullUp (  );
...
static void Handle_le_gpioPin32_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin32_EnablePullDown (  );
...
static void Handle_le_gpioPin32_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin32_DisableResistors (  );
...
static void Handle_le_gpioPin32_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin32_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin32_Deactivate (  );
...
static void Handle_le_gpioPin32_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin32_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin32_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin32_AddChangeEventHandler;
...
static void Handle_le_gpioPin32_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin32_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin32_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin32_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin32_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin32_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin32_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin32_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin32_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin32_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin32_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin32_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin32_DisableEdgeSense (  );
...
static void Handle_le_gpioPin32_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin32_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin32_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin32_Edge_t _result;
    _result  = le_gpioPin32_GetEdgeSense (  );
...
static void Handle_le_gpioPin32_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin32_Polarity_t _result;
    _result  = le_gpioPin32_GetPolarity (  );
...
static void Handle_le_gpioPin32_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin32_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin32_PullUpDown_t _result;
    _result  = le_gpioPin32_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin32_SetInput : Handle_le_gpioPin32_SetInput(msgRef); break;
        case _MSGID_le_gpioPin32_SetPushPullOutput : Handle_le_gpioPin32_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin32_SetTriStateOutput : Handle_le_gpioPin32_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin32_SetOpenDrainOutput : Handle_le_gpioPin32_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin32_EnablePullUp : Handle_le_gpioPin32_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin32_EnablePullDown : Handle_le_gpioPin32_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin32_DisableResistors : Handle_le_gpioPin32_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin32_Activate : Handle_le_gpioPin32_Activate(msgRef); break;
        case _MSGID_le_gpioPin32_Deactivate : Handle_le_gpioPin32_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin32_SetHighZ : Handle_le_gpioPin32_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin32_Read : Handle_le_gpioPin32_Read(msgRef); break;
        case _MSGID_le_gpioPin32_AddChangeEventHandler : Handle_le_gpioPin32_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin32_RemoveChangeEventHandler : Handle_le_gpioPin32_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin32_SetEdgeSense : Handle_le_gpioPin32_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin32_DisableEdgeSense : Handle_le_gpioPin32_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin32_IsOutput : Handle_le_gpioPin32_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin32_IsInput : Handle_le_gpioPin32_IsInput(msgRef); break;
        case _MSGID_le_gpioPin32_GetEdgeSense : Handle_le_gpioPin32_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin32_GetPolarity : Handle_le_gpioPin32_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin32_IsActive : Handle_le_gpioPin32_IsActive(msgRef); break;
        case _MSGID_le_gpioPin32_GetPullUpDown : Handle_le_gpioPin32_GetPullUpDown(msgRef); break;
