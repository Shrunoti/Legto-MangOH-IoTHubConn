...
#include "le_gpioPin22_messages.h"
#include "le_gpioPin22_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin22_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin22_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin22_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin22_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin22_ServerHandlers", 3);
...
static void Handle_le_gpioPin22_SetInput
(
...
static void Handle_le_gpioPin22_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin22_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin22_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin22_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin22_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin22_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin22_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin22_EnablePullUp (  );
...
static void Handle_le_gpioPin22_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin22_EnablePullDown (  );
...
static void Handle_le_gpioPin22_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin22_DisableResistors (  );
...
static void Handle_le_gpioPin22_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin22_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin22_Deactivate (  );
...
static void Handle_le_gpioPin22_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin22_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin22_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin22_AddChangeEventHandler;
...
static void Handle_le_gpioPin22_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin22_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin22_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin22_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin22_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin22_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin22_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin22_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin22_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin22_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin22_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin22_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin22_DisableEdgeSense (  );
...
static void Handle_le_gpioPin22_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin22_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin22_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin22_Edge_t _result;
    _result  = le_gpioPin22_GetEdgeSense (  );
...
static void Handle_le_gpioPin22_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin22_Polarity_t _result;
    _result  = le_gpioPin22_GetPolarity (  );
...
static void Handle_le_gpioPin22_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin22_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin22_PullUpDown_t _result;
    _result  = le_gpioPin22_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin22_SetInput : Handle_le_gpioPin22_SetInput(msgRef); break;
        case _MSGID_le_gpioPin22_SetPushPullOutput : Handle_le_gpioPin22_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin22_SetTriStateOutput : Handle_le_gpioPin22_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin22_SetOpenDrainOutput : Handle_le_gpioPin22_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin22_EnablePullUp : Handle_le_gpioPin22_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin22_EnablePullDown : Handle_le_gpioPin22_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin22_DisableResistors : Handle_le_gpioPin22_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin22_Activate : Handle_le_gpioPin22_Activate(msgRef); break;
        case _MSGID_le_gpioPin22_Deactivate : Handle_le_gpioPin22_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin22_SetHighZ : Handle_le_gpioPin22_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin22_Read : Handle_le_gpioPin22_Read(msgRef); break;
        case _MSGID_le_gpioPin22_AddChangeEventHandler : Handle_le_gpioPin22_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin22_RemoveChangeEventHandler : Handle_le_gpioPin22_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin22_SetEdgeSense : Handle_le_gpioPin22_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin22_DisableEdgeSense : Handle_le_gpioPin22_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin22_IsOutput : Handle_le_gpioPin22_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin22_IsInput : Handle_le_gpioPin22_IsInput(msgRef); break;
        case _MSGID_le_gpioPin22_GetEdgeSense : Handle_le_gpioPin22_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin22_GetPolarity : Handle_le_gpioPin22_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin22_IsActive : Handle_le_gpioPin22_IsActive(msgRef); break;
        case _MSGID_le_gpioPin22_GetPullUpDown : Handle_le_gpioPin22_GetPullUpDown(msgRef); break;
