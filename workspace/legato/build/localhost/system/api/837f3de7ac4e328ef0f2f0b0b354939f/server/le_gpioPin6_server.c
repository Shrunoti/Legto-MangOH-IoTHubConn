...
#include "le_gpioPin6_messages.h"
...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin6_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin6_ServerHandlers", 3);
...
)
{
    ...
    le_gpioPin6_Polarity_t polarity;
...
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin6_AddChangeEventHandler;
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin6_ChangeEventHandlerRef_t handlerRef;
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin6_SetInput : Handle_le_gpioPin6_SetInput(msgRef); break;
        case _MSGID_le_gpioPin6_SetPushPullOutput : Handle_le_gpioPin6_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin6_SetTriStateOutput : Handle_le_gpioPin6_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin6_SetOpenDrainOutput : Handle_le_gpioPin6_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin6_EnablePullUp : Handle_le_gpioPin6_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin6_EnablePullDown : Handle_le_gpioPin6_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin6_DisableResistors : Handle_le_gpioPin6_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin6_Activate : Handle_le_gpioPin6_Activate(msgRef); break;
        case _MSGID_le_gpioPin6_Deactivate : Handle_le_gpioPin6_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin6_SetHighZ : Handle_le_gpioPin6_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin6_Read : Handle_le_gpioPin6_Read(msgRef); break;
        case _MSGID_le_gpioPin6_AddChangeEventHandler : Handle_le_gpioPin6_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin6_RemoveChangeEventHandler : Handle_le_gpioPin6_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin6_SetEdgeSense : Handle_le_gpioPin6_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin6_DisableEdgeSense : Handle_le_gpioPin6_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin6_IsOutput : Handle_le_gpioPin6_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin6_IsInput : Handle_le_gpioPin6_IsInput(msgRef); break;
        case _MSGID_le_gpioPin6_GetEdgeSense : Handle_le_gpioPin6_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin6_GetPolarity : Handle_le_gpioPin6_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin6_IsActive : Handle_le_gpioPin6_IsActive(msgRef); break;
        case _MSGID_le_gpioPin6_GetPullUpDown : Handle_le_gpioPin6_GetPullUpDown(msgRef); break;
