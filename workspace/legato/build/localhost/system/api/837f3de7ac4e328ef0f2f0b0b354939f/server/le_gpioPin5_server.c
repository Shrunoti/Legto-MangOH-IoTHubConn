...
#include "le_gpioPin5_messages.h"
#include "le_gpioPin5_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin5_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin5_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin5_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin5_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin5_ServerHandlers", 3);
...
static void Handle_le_gpioPin5_SetInput
(
...
)
{
    ...
    le_gpioPin5_Polarity_t polarity;
...
static void Handle_le_gpioPin5_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin5_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin5_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin5_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin5_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin5_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin5_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin5_EnablePullUp (  );
...
static void Handle_le_gpioPin5_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin5_EnablePullDown (  );
...
static void Handle_le_gpioPin5_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin5_DisableResistors (  );
...
static void Handle_le_gpioPin5_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin5_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin5_Deactivate (  );
...
static void Handle_le_gpioPin5_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin5_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin5_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin5_AddChangeEventHandler;
...
static void Handle_le_gpioPin5_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin5_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin5_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin5_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin5_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin5_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin5_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin5_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin5_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin5_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin5_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin5_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin5_DisableEdgeSense (  );
...
static void Handle_le_gpioPin5_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin5_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin5_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin5_Edge_t _result;
    _result  = le_gpioPin5_GetEdgeSense (  );
...
static void Handle_le_gpioPin5_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin5_Polarity_t _result;
    _result  = le_gpioPin5_GetPolarity (  );
...
static void Handle_le_gpioPin5_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin5_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin5_PullUpDown_t _result;
    _result  = le_gpioPin5_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin5_SetInput : Handle_le_gpioPin5_SetInput(msgRef); break;
        case _MSGID_le_gpioPin5_SetPushPullOutput : Handle_le_gpioPin5_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin5_SetTriStateOutput : Handle_le_gpioPin5_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin5_SetOpenDrainOutput : Handle_le_gpioPin5_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin5_EnablePullUp : Handle_le_gpioPin5_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin5_EnablePullDown : Handle_le_gpioPin5_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin5_DisableResistors : Handle_le_gpioPin5_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin5_Activate : Handle_le_gpioPin5_Activate(msgRef); break;
        case _MSGID_le_gpioPin5_Deactivate : Handle_le_gpioPin5_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin5_SetHighZ : Handle_le_gpioPin5_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin5_Read : Handle_le_gpioPin5_Read(msgRef); break;
        case _MSGID_le_gpioPin5_AddChangeEventHandler : Handle_le_gpioPin5_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin5_RemoveChangeEventHandler : Handle_le_gpioPin5_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin5_SetEdgeSense : Handle_le_gpioPin5_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin5_DisableEdgeSense : Handle_le_gpioPin5_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin5_IsOutput : Handle_le_gpioPin5_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin5_IsInput : Handle_le_gpioPin5_IsInput(msgRef); break;
        case _MSGID_le_gpioPin5_GetEdgeSense : Handle_le_gpioPin5_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin5_GetPolarity : Handle_le_gpioPin5_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin5_IsActive : Handle_le_gpioPin5_IsActive(msgRef); break;
        case _MSGID_le_gpioPin5_GetPullUpDown : Handle_le_gpioPin5_GetPullUpDown(msgRef); break;
