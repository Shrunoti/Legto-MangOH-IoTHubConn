...
#include "le_gpioPin44_messages.h"
#include "le_gpioPin44_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin44_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin44_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin44_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin44_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin44_ServerHandlers", 3);
...
static void Handle_le_gpioPin44_SetInput
(
...
)
{
    ...
    le_gpioPin44_Polarity_t polarity;
...
static void Handle_le_gpioPin44_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin44_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin44_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin44_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin44_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin44_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin44_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin44_EnablePullUp (  );
...
static void Handle_le_gpioPin44_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin44_EnablePullDown (  );
...
static void Handle_le_gpioPin44_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin44_DisableResistors (  );
...
static void Handle_le_gpioPin44_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin44_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin44_Deactivate (  );
...
static void Handle_le_gpioPin44_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin44_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin44_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin44_AddChangeEventHandler;
...
static void Handle_le_gpioPin44_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin44_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin44_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin44_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin44_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin44_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin44_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin44_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin44_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin44_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin44_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin44_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin44_DisableEdgeSense (  );
...
static void Handle_le_gpioPin44_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin44_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin44_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin44_Edge_t _result;
    _result  = le_gpioPin44_GetEdgeSense (  );
...
static void Handle_le_gpioPin44_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin44_Polarity_t _result;
    _result  = le_gpioPin44_GetPolarity (  );
...
static void Handle_le_gpioPin44_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin44_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin44_PullUpDown_t _result;
    _result  = le_gpioPin44_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin44_SetInput : Handle_le_gpioPin44_SetInput(msgRef); break;
        case _MSGID_le_gpioPin44_SetPushPullOutput : Handle_le_gpioPin44_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin44_SetTriStateOutput : Handle_le_gpioPin44_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin44_SetOpenDrainOutput : Handle_le_gpioPin44_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin44_EnablePullUp : Handle_le_gpioPin44_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin44_EnablePullDown : Handle_le_gpioPin44_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin44_DisableResistors : Handle_le_gpioPin44_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin44_Activate : Handle_le_gpioPin44_Activate(msgRef); break;
        case _MSGID_le_gpioPin44_Deactivate : Handle_le_gpioPin44_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin44_SetHighZ : Handle_le_gpioPin44_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin44_Read : Handle_le_gpioPin44_Read(msgRef); break;
        case _MSGID_le_gpioPin44_AddChangeEventHandler : Handle_le_gpioPin44_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin44_RemoveChangeEventHandler : Handle_le_gpioPin44_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin44_SetEdgeSense : Handle_le_gpioPin44_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin44_DisableEdgeSense : Handle_le_gpioPin44_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin44_IsOutput : Handle_le_gpioPin44_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin44_IsInput : Handle_le_gpioPin44_IsInput(msgRef); break;
        case _MSGID_le_gpioPin44_GetEdgeSense : Handle_le_gpioPin44_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin44_GetPolarity : Handle_le_gpioPin44_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin44_IsActive : Handle_le_gpioPin44_IsActive(msgRef); break;
        case _MSGID_le_gpioPin44_GetPullUpDown : Handle_le_gpioPin44_GetPullUpDown(msgRef); break;
