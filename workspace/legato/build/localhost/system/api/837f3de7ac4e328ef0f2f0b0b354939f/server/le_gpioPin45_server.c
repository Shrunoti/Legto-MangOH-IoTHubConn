...
#include "le_gpioPin45_messages.h"
#include "le_gpioPin45_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin45_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin45_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin45_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin45_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin45_ServerHandlers", 3);
...
static void Handle_le_gpioPin45_SetInput
(
...
)
{
    ...
    le_gpioPin45_Polarity_t polarity;
...
static void Handle_le_gpioPin45_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin45_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin45_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin45_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin45_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin45_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin45_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin45_EnablePullUp (  );
...
static void Handle_le_gpioPin45_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin45_EnablePullDown (  );
...
static void Handle_le_gpioPin45_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin45_DisableResistors (  );
...
static void Handle_le_gpioPin45_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin45_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin45_Deactivate (  );
...
static void Handle_le_gpioPin45_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin45_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin45_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin45_AddChangeEventHandler;
...
static void Handle_le_gpioPin45_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin45_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin45_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin45_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin45_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin45_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin45_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin45_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin45_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin45_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin45_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin45_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin45_DisableEdgeSense (  );
...
static void Handle_le_gpioPin45_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin45_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin45_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin45_Edge_t _result;
    _result  = le_gpioPin45_GetEdgeSense (  );
...
static void Handle_le_gpioPin45_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin45_Polarity_t _result;
    _result  = le_gpioPin45_GetPolarity (  );
...
static void Handle_le_gpioPin45_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin45_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin45_PullUpDown_t _result;
    _result  = le_gpioPin45_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin45_SetInput : Handle_le_gpioPin45_SetInput(msgRef); break;
        case _MSGID_le_gpioPin45_SetPushPullOutput : Handle_le_gpioPin45_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin45_SetTriStateOutput : Handle_le_gpioPin45_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin45_SetOpenDrainOutput : Handle_le_gpioPin45_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin45_EnablePullUp : Handle_le_gpioPin45_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin45_EnablePullDown : Handle_le_gpioPin45_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin45_DisableResistors : Handle_le_gpioPin45_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin45_Activate : Handle_le_gpioPin45_Activate(msgRef); break;
        case _MSGID_le_gpioPin45_Deactivate : Handle_le_gpioPin45_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin45_SetHighZ : Handle_le_gpioPin45_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin45_Read : Handle_le_gpioPin45_Read(msgRef); break;
        case _MSGID_le_gpioPin45_AddChangeEventHandler : Handle_le_gpioPin45_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin45_RemoveChangeEventHandler : Handle_le_gpioPin45_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin45_SetEdgeSense : Handle_le_gpioPin45_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin45_DisableEdgeSense : Handle_le_gpioPin45_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin45_IsOutput : Handle_le_gpioPin45_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin45_IsInput : Handle_le_gpioPin45_IsInput(msgRef); break;
        case _MSGID_le_gpioPin45_GetEdgeSense : Handle_le_gpioPin45_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin45_GetPolarity : Handle_le_gpioPin45_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin45_IsActive : Handle_le_gpioPin45_IsActive(msgRef); break;
        case _MSGID_le_gpioPin45_GetPullUpDown : Handle_le_gpioPin45_GetPullUpDown(msgRef); break;
