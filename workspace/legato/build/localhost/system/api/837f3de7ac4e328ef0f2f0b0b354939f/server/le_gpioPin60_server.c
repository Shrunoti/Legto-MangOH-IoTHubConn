...
#include "le_gpioPin60_messages.h"
#include "le_gpioPin60_server.h"
...
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin60_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin60_ServerHandlers", 3);
...
static void Handle_le_gpioPin60_SetInput
(
...
static void Handle_le_gpioPin60_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin60_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin60_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin60_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin60_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin60_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin60_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin60_EnablePullUp (  );
...
static void Handle_le_gpioPin60_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin60_EnablePullDown (  );
...
static void Handle_le_gpioPin60_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin60_DisableResistors (  );
...
static void Handle_le_gpioPin60_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin60_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin60_Deactivate (  );
...
static void Handle_le_gpioPin60_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin60_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin60_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin60_AddChangeEventHandler;
...
static void Handle_le_gpioPin60_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin60_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin60_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin60_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin60_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin60_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_gpioPin60_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin60_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin60_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin60_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin60_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin60_DisableEdgeSense (  );
...
static void Handle_le_gpioPin60_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin60_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin60_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin60_Edge_t _result;
    _result  = le_gpioPin60_GetEdgeSense (  );
...
static void Handle_le_gpioPin60_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin60_Polarity_t _result;
    _result  = le_gpioPin60_GetPolarity (  );
...
static void Handle_le_gpioPin60_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin60_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin60_PullUpDown_t _result;
    _result  = le_gpioPin60_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin60_SetInput : Handle_le_gpioPin60_SetInput(msgRef); break;
        case _MSGID_le_gpioPin60_SetPushPullOutput : Handle_le_gpioPin60_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin60_SetTriStateOutput : Handle_le_gpioPin60_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin60_SetOpenDrainOutput : Handle_le_gpioPin60_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin60_EnablePullUp : Handle_le_gpioPin60_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin60_EnablePullDown : Handle_le_gpioPin60_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin60_DisableResistors : Handle_le_gpioPin60_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin60_Activate : Handle_le_gpioPin60_Activate(msgRef); break;
        case _MSGID_le_gpioPin60_Deactivate : Handle_le_gpioPin60_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin60_SetHighZ : Handle_le_gpioPin60_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin60_Read : Handle_le_gpioPin60_Read(msgRef); break;
        case _MSGID_le_gpioPin60_AddChangeEventHandler : Handle_le_gpioPin60_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin60_RemoveChangeEventHandler : Handle_le_gpioPin60_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin60_SetEdgeSense : Handle_le_gpioPin60_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin60_DisableEdgeSense : Handle_le_gpioPin60_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin60_IsOutput : Handle_le_gpioPin60_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin60_IsInput : Handle_le_gpioPin60_IsInput(msgRef); break;
        case _MSGID_le_gpioPin60_GetEdgeSense : Handle_le_gpioPin60_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin60_GetPolarity : Handle_le_gpioPin60_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin60_IsActive : Handle_le_gpioPin60_IsActive(msgRef); break;
        case _MSGID_le_gpioPin60_GetPullUpDown : Handle_le_gpioPin60_GetPullUpDown(msgRef); break;
