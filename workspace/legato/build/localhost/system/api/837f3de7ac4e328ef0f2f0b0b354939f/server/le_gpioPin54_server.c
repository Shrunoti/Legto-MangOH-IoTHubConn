...
#include "le_gpioPin54_messages.h"
#include "le_gpioPin54_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin54_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin54_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin54_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin54_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin54_ServerHandlers", 3);
...
static void Handle_le_gpioPin54_SetInput
(
...
)
{
    ...
    le_gpioPin54_Polarity_t polarity;
...
static void Handle_le_gpioPin54_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin54_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin54_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin54_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin54_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin54_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin54_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin54_EnablePullUp (  );
...
static void Handle_le_gpioPin54_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin54_EnablePullDown (  );
...
static void Handle_le_gpioPin54_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin54_DisableResistors (  );
...
static void Handle_le_gpioPin54_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin54_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin54_Deactivate (  );
...
static void Handle_le_gpioPin54_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin54_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin54_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin54_AddChangeEventHandler;
...
static void Handle_le_gpioPin54_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin54_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin54_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin54_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin54_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin54_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin54_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin54_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin54_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin54_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin54_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin54_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin54_DisableEdgeSense (  );
...
static void Handle_le_gpioPin54_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin54_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin54_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin54_Edge_t _result;
    _result  = le_gpioPin54_GetEdgeSense (  );
...
static void Handle_le_gpioPin54_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin54_Polarity_t _result;
    _result  = le_gpioPin54_GetPolarity (  );
...
static void Handle_le_gpioPin54_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin54_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin54_PullUpDown_t _result;
    _result  = le_gpioPin54_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin54_SetInput : Handle_le_gpioPin54_SetInput(msgRef); break;
        case _MSGID_le_gpioPin54_SetPushPullOutput : Handle_le_gpioPin54_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin54_SetTriStateOutput : Handle_le_gpioPin54_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin54_SetOpenDrainOutput : Handle_le_gpioPin54_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin54_EnablePullUp : Handle_le_gpioPin54_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin54_EnablePullDown : Handle_le_gpioPin54_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin54_DisableResistors : Handle_le_gpioPin54_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin54_Activate : Handle_le_gpioPin54_Activate(msgRef); break;
        case _MSGID_le_gpioPin54_Deactivate : Handle_le_gpioPin54_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin54_SetHighZ : Handle_le_gpioPin54_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin54_Read : Handle_le_gpioPin54_Read(msgRef); break;
        case _MSGID_le_gpioPin54_AddChangeEventHandler : Handle_le_gpioPin54_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin54_RemoveChangeEventHandler : Handle_le_gpioPin54_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin54_SetEdgeSense : Handle_le_gpioPin54_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin54_DisableEdgeSense : Handle_le_gpioPin54_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin54_IsOutput : Handle_le_gpioPin54_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin54_IsInput : Handle_le_gpioPin54_IsInput(msgRef); break;
        case _MSGID_le_gpioPin54_GetEdgeSense : Handle_le_gpioPin54_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin54_GetPolarity : Handle_le_gpioPin54_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin54_IsActive : Handle_le_gpioPin54_IsActive(msgRef); break;
        case _MSGID_le_gpioPin54_GetPullUpDown : Handle_le_gpioPin54_GetPullUpDown(msgRef); break;
