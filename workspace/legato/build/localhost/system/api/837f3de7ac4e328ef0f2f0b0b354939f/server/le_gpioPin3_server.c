...
#include "le_gpioPin3_messages.h"
#include "le_gpioPin3_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin3_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin3_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin3_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin3_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin3_ServerHandlers", 3);
...
static void Handle_le_gpioPin3_SetInput
(
...
)
{
    ...
    le_gpioPin3_Polarity_t polarity;
...
static void Handle_le_gpioPin3_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin3_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin3_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin3_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin3_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin3_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin3_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin3_EnablePullUp (  );
...
static void Handle_le_gpioPin3_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin3_EnablePullDown (  );
...
static void Handle_le_gpioPin3_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin3_DisableResistors (  );
...
static void Handle_le_gpioPin3_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin3_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin3_Deactivate (  );
...
static void Handle_le_gpioPin3_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin3_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin3_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin3_AddChangeEventHandler;
...
static void Handle_le_gpioPin3_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin3_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin3_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin3_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin3_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin3_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin3_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin3_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin3_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin3_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin3_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin3_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin3_DisableEdgeSense (  );
...
static void Handle_le_gpioPin3_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin3_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin3_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin3_Edge_t _result;
    _result  = le_gpioPin3_GetEdgeSense (  );
...
static void Handle_le_gpioPin3_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin3_Polarity_t _result;
    _result  = le_gpioPin3_GetPolarity (  );
...
static void Handle_le_gpioPin3_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin3_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin3_PullUpDown_t _result;
    _result  = le_gpioPin3_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin3_SetInput : Handle_le_gpioPin3_SetInput(msgRef); break;
        case _MSGID_le_gpioPin3_SetPushPullOutput : Handle_le_gpioPin3_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin3_SetTriStateOutput : Handle_le_gpioPin3_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin3_SetOpenDrainOutput : Handle_le_gpioPin3_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin3_EnablePullUp : Handle_le_gpioPin3_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin3_EnablePullDown : Handle_le_gpioPin3_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin3_DisableResistors : Handle_le_gpioPin3_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin3_Activate : Handle_le_gpioPin3_Activate(msgRef); break;
        case _MSGID_le_gpioPin3_Deactivate : Handle_le_gpioPin3_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin3_SetHighZ : Handle_le_gpioPin3_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin3_Read : Handle_le_gpioPin3_Read(msgRef); break;
        case _MSGID_le_gpioPin3_AddChangeEventHandler : Handle_le_gpioPin3_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin3_RemoveChangeEventHandler : Handle_le_gpioPin3_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin3_SetEdgeSense : Handle_le_gpioPin3_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin3_DisableEdgeSense : Handle_le_gpioPin3_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin3_IsOutput : Handle_le_gpioPin3_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin3_IsInput : Handle_le_gpioPin3_IsInput(msgRef); break;
        case _MSGID_le_gpioPin3_GetEdgeSense : Handle_le_gpioPin3_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin3_GetPolarity : Handle_le_gpioPin3_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin3_IsActive : Handle_le_gpioPin3_IsActive(msgRef); break;
        case _MSGID_le_gpioPin3_GetPullUpDown : Handle_le_gpioPin3_GetPullUpDown(msgRef); break;
