...
#include "le_gpioPin53_messages.h"
#include "le_gpioPin53_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin53_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin53_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin53_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin53_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin53_ServerHandlers", 3);
...
static void Handle_le_gpioPin53_SetInput
(
...
)
{
    ...
    le_gpioPin53_Polarity_t polarity;
...
static void Handle_le_gpioPin53_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin53_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin53_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin53_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin53_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin53_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin53_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin53_EnablePullUp (  );
...
static void Handle_le_gpioPin53_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin53_EnablePullDown (  );
...
static void Handle_le_gpioPin53_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin53_DisableResistors (  );
...
static void Handle_le_gpioPin53_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin53_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin53_Deactivate (  );
...
static void Handle_le_gpioPin53_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin53_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin53_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin53_AddChangeEventHandler;
...
static void Handle_le_gpioPin53_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin53_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin53_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin53_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin53_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin53_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin53_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin53_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin53_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin53_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin53_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin53_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin53_DisableEdgeSense (  );
...
static void Handle_le_gpioPin53_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin53_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin53_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin53_Edge_t _result;
    _result  = le_gpioPin53_GetEdgeSense (  );
...
static void Handle_le_gpioPin53_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin53_Polarity_t _result;
    _result  = le_gpioPin53_GetPolarity (  );
...
static void Handle_le_gpioPin53_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin53_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin53_PullUpDown_t _result;
    _result  = le_gpioPin53_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin53_SetInput : Handle_le_gpioPin53_SetInput(msgRef); break;
        case _MSGID_le_gpioPin53_SetPushPullOutput : Handle_le_gpioPin53_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin53_SetTriStateOutput : Handle_le_gpioPin53_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin53_SetOpenDrainOutput : Handle_le_gpioPin53_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin53_EnablePullUp : Handle_le_gpioPin53_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin53_EnablePullDown : Handle_le_gpioPin53_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin53_DisableResistors : Handle_le_gpioPin53_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin53_Activate : Handle_le_gpioPin53_Activate(msgRef); break;
        case _MSGID_le_gpioPin53_Deactivate : Handle_le_gpioPin53_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin53_SetHighZ : Handle_le_gpioPin53_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin53_Read : Handle_le_gpioPin53_Read(msgRef); break;
        case _MSGID_le_gpioPin53_AddChangeEventHandler : Handle_le_gpioPin53_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin53_RemoveChangeEventHandler : Handle_le_gpioPin53_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin53_SetEdgeSense : Handle_le_gpioPin53_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin53_DisableEdgeSense : Handle_le_gpioPin53_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin53_IsOutput : Handle_le_gpioPin53_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin53_IsInput : Handle_le_gpioPin53_IsInput(msgRef); break;
        case _MSGID_le_gpioPin53_GetEdgeSense : Handle_le_gpioPin53_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin53_GetPolarity : Handle_le_gpioPin53_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin53_IsActive : Handle_le_gpioPin53_IsActive(msgRef); break;
        case _MSGID_le_gpioPin53_GetPullUpDown : Handle_le_gpioPin53_GetPullUpDown(msgRef); break;
