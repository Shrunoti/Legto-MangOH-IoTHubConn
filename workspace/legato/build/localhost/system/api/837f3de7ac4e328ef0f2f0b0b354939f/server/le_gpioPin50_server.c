...
#include "le_gpioPin50_messages.h"
#include "le_gpioPin50_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin50_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin50_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin50_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin50_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin50_ServerHandlers", 3);
...
static void Handle_le_gpioPin50_SetInput
(
...
)
{
    ...
    le_gpioPin50_Polarity_t polarity;
...
static void Handle_le_gpioPin50_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin50_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin50_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin50_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin50_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin50_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin50_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin50_EnablePullUp (  );
...
static void Handle_le_gpioPin50_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin50_EnablePullDown (  );
...
static void Handle_le_gpioPin50_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin50_DisableResistors (  );
...
static void Handle_le_gpioPin50_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin50_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin50_Deactivate (  );
...
static void Handle_le_gpioPin50_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin50_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin50_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin50_AddChangeEventHandler;
...
static void Handle_le_gpioPin50_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin50_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin50_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin50_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin50_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin50_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin50_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin50_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin50_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin50_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin50_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin50_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin50_DisableEdgeSense (  );
...
static void Handle_le_gpioPin50_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin50_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin50_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin50_Edge_t _result;
    _result  = le_gpioPin50_GetEdgeSense (  );
...
static void Handle_le_gpioPin50_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin50_Polarity_t _result;
    _result  = le_gpioPin50_GetPolarity (  );
...
static void Handle_le_gpioPin50_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin50_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin50_PullUpDown_t _result;
    _result  = le_gpioPin50_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin50_SetInput : Handle_le_gpioPin50_SetInput(msgRef); break;
        case _MSGID_le_gpioPin50_SetPushPullOutput : Handle_le_gpioPin50_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin50_SetTriStateOutput : Handle_le_gpioPin50_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin50_SetOpenDrainOutput : Handle_le_gpioPin50_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin50_EnablePullUp : Handle_le_gpioPin50_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin50_EnablePullDown : Handle_le_gpioPin50_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin50_DisableResistors : Handle_le_gpioPin50_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin50_Activate : Handle_le_gpioPin50_Activate(msgRef); break;
        case _MSGID_le_gpioPin50_Deactivate : Handle_le_gpioPin50_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin50_SetHighZ : Handle_le_gpioPin50_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin50_Read : Handle_le_gpioPin50_Read(msgRef); break;
        case _MSGID_le_gpioPin50_AddChangeEventHandler : Handle_le_gpioPin50_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin50_RemoveChangeEventHandler : Handle_le_gpioPin50_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin50_SetEdgeSense : Handle_le_gpioPin50_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin50_DisableEdgeSense : Handle_le_gpioPin50_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin50_IsOutput : Handle_le_gpioPin50_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin50_IsInput : Handle_le_gpioPin50_IsInput(msgRef); break;
        case _MSGID_le_gpioPin50_GetEdgeSense : Handle_le_gpioPin50_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin50_GetPolarity : Handle_le_gpioPin50_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin50_IsActive : Handle_le_gpioPin50_IsActive(msgRef); break;
        case _MSGID_le_gpioPin50_GetPullUpDown : Handle_le_gpioPin50_GetPullUpDown(msgRef); break;
