...
#ifndef LE_GPIOPIN16_INTERFACE_H_INCLUDE_GUARD
#define LE_GPIOPIN16_INTERFACE_H_INCLUDE_GUARD
...
typedef enum
{
    LE_GPIOPIN16_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    LE_GPIOPIN16_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
le_gpioPin16_Polarity_t;
...
typedef enum
{
    LE_GPIOPIN16_EDGE_NONE = 0,
        ///< No edge detection
    LE_GPIOPIN16_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    LE_GPIOPIN16_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    LE_GPIOPIN16_EDGE_BOTH = 3
...
//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'le_gpioPin16_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct le_gpioPin16_ChangeEventHandler* le_gpioPin16_ChangeEventHandlerRef_t;
...
typedef enum
{
    LE_GPIOPIN16_PULL_OFF = 0,
        ///< Neither resistor is enabled
    LE_GPIOPIN16_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    LE_GPIOPIN16_PULL_UP = 2
        ///< Pullup resistor is enabled
}
le_gpioPin16_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_gpioPin16_ChangeCallbackFunc_t)
(
    bool state,
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin16_SetInput
(
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin16_SetPushPullOutput
(
    le_gpioPin16_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin16_SetTriStateOutput
(
    le_gpioPin16_Polarity_t polarity
        ///< [IN] Active-high or active-low.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin16_SetOpenDrainOutput
(
    le_gpioPin16_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin16_EnablePullUp
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin16_EnablePullDown
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin16_DisableResistors
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin16_Activate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin16_Deactivate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin16_SetHighZ
(
    void
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'le_gpioPin16_ChangeEvent'
 *
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'le_gpioPin16_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin16_RemoveChangeEventHandler
(
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin16_SetEdgeSense
(
    le_gpioPin16_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin16_DisableEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin16_Edge_t le_gpioPin16_GetEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin16_Polarity_t le_gpioPin16_GetPolarity
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin16_PullUpDown_t le_gpioPin16_GetPullUpDown
(
    void
);


#endif // LE_GPIOPIN16_INTERFACE_H_INCLUDE_GUARD