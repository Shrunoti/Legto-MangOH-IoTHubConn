...
#include "le_gpioPin24_messages.h"
#include "le_gpioPin24_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin24_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin24_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin24_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin24_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin24_ServerHandlers", 3);
...
static void Handle_le_gpioPin24_SetInput
(
...
static void Handle_le_gpioPin24_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin24_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin24_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin24_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin24_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin24_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin24_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin24_EnablePullUp (  );
...
static void Handle_le_gpioPin24_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin24_EnablePullDown (  );
...
static void Handle_le_gpioPin24_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin24_DisableResistors (  );
...
static void Handle_le_gpioPin24_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin24_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin24_Deactivate (  );
...
static void Handle_le_gpioPin24_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin24_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin24_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin24_AddChangeEventHandler;
...
static void Handle_le_gpioPin24_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin24_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin24_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin24_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin24_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin24_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin24_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin24_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin24_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin24_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin24_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin24_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin24_DisableEdgeSense (  );
...
static void Handle_le_gpioPin24_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin24_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin24_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin24_Edge_t _result;
    _result  = le_gpioPin24_GetEdgeSense (  );
...
static void Handle_le_gpioPin24_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin24_Polarity_t _result;
    _result  = le_gpioPin24_GetPolarity (  );
...
static void Handle_le_gpioPin24_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin24_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin24_PullUpDown_t _result;
    _result  = le_gpioPin24_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin24_SetInput : Handle_le_gpioPin24_SetInput(msgRef); break;
        case _MSGID_le_gpioPin24_SetPushPullOutput : Handle_le_gpioPin24_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin24_SetTriStateOutput : Handle_le_gpioPin24_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin24_SetOpenDrainOutput : Handle_le_gpioPin24_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin24_EnablePullUp : Handle_le_gpioPin24_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin24_EnablePullDown : Handle_le_gpioPin24_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin24_DisableResistors : Handle_le_gpioPin24_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin24_Activate : Handle_le_gpioPin24_Activate(msgRef); break;
        case _MSGID_le_gpioPin24_Deactivate : Handle_le_gpioPin24_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin24_SetHighZ : Handle_le_gpioPin24_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin24_Read : Handle_le_gpioPin24_Read(msgRef); break;
        case _MSGID_le_gpioPin24_AddChangeEventHandler : Handle_le_gpioPin24_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin24_RemoveChangeEventHandler : Handle_le_gpioPin24_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin24_SetEdgeSense : Handle_le_gpioPin24_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin24_DisableEdgeSense : Handle_le_gpioPin24_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin24_IsOutput : Handle_le_gpioPin24_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin24_IsInput : Handle_le_gpioPin24_IsInput(msgRef); break;
        case _MSGID_le_gpioPin24_GetEdgeSense : Handle_le_gpioPin24_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin24_GetPolarity : Handle_le_gpioPin24_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin24_IsActive : Handle_le_gpioPin24_IsActive(msgRef); break;
        case _MSGID_le_gpioPin24_GetPullUpDown : Handle_le_gpioPin24_GetPullUpDown(msgRef); break;
