...
#include "le_gpioPin10_messages.h"
#include "le_gpioPin10_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin10_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin10_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin10_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin10_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin10_ServerHandlers", 3);
...
static void Handle_le_gpioPin10_SetInput
(
...
)
{
    ...
    le_gpioPin10_Polarity_t polarity;
...
static void Handle_le_gpioPin10_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin10_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin10_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin10_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin10_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin10_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin10_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin10_EnablePullUp (  );
...
static void Handle_le_gpioPin10_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin10_EnablePullDown (  );
...
static void Handle_le_gpioPin10_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin10_DisableResistors (  );
...
static void Handle_le_gpioPin10_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin10_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin10_Deactivate (  );
...
static void Handle_le_gpioPin10_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin10_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin10_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin10_AddChangeEventHandler;
...
static void Handle_le_gpioPin10_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin10_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin10_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin10_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin10_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin10_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin10_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin10_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin10_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin10_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin10_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin10_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin10_DisableEdgeSense (  );
...
static void Handle_le_gpioPin10_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin10_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin10_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin10_Edge_t _result;
    _result  = le_gpioPin10_GetEdgeSense (  );
...
static void Handle_le_gpioPin10_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin10_Polarity_t _result;
    _result  = le_gpioPin10_GetPolarity (  );
...
static void Handle_le_gpioPin10_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin10_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin10_PullUpDown_t _result;
    _result  = le_gpioPin10_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin10_SetInput : Handle_le_gpioPin10_SetInput(msgRef); break;
        case _MSGID_le_gpioPin10_SetPushPullOutput : Handle_le_gpioPin10_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin10_SetTriStateOutput : Handle_le_gpioPin10_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin10_SetOpenDrainOutput : Handle_le_gpioPin10_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin10_EnablePullUp : Handle_le_gpioPin10_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin10_EnablePullDown : Handle_le_gpioPin10_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin10_DisableResistors : Handle_le_gpioPin10_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin10_Activate : Handle_le_gpioPin10_Activate(msgRef); break;
        case _MSGID_le_gpioPin10_Deactivate : Handle_le_gpioPin10_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin10_SetHighZ : Handle_le_gpioPin10_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin10_Read : Handle_le_gpioPin10_Read(msgRef); break;
        case _MSGID_le_gpioPin10_AddChangeEventHandler : Handle_le_gpioPin10_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin10_RemoveChangeEventHandler : Handle_le_gpioPin10_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin10_SetEdgeSense : Handle_le_gpioPin10_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin10_DisableEdgeSense : Handle_le_gpioPin10_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin10_IsOutput : Handle_le_gpioPin10_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin10_IsInput : Handle_le_gpioPin10_IsInput(msgRef); break;
        case _MSGID_le_gpioPin10_GetEdgeSense : Handle_le_gpioPin10_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin10_GetPolarity : Handle_le_gpioPin10_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin10_IsActive : Handle_le_gpioPin10_IsActive(msgRef); break;
        case _MSGID_le_gpioPin10_GetPullUpDown : Handle_le_gpioPin10_GetPullUpDown(msgRef); break;
