...
#include "le_gpioPin38_messages.h"
#include "le_gpioPin38_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin38_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin38_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin38_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin38_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin38_ServerHandlers", 3);
...
static void Handle_le_gpioPin38_SetInput
(
...
)
{
    ...
    le_gpioPin38_Polarity_t polarity;
...
static void Handle_le_gpioPin38_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin38_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin38_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin38_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin38_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin38_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin38_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin38_EnablePullUp (  );
...
static void Handle_le_gpioPin38_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin38_EnablePullDown (  );
...
static void Handle_le_gpioPin38_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin38_DisableResistors (  );
...
static void Handle_le_gpioPin38_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin38_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin38_Deactivate (  );
...
static void Handle_le_gpioPin38_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin38_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin38_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin38_AddChangeEventHandler;
...
static void Handle_le_gpioPin38_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin38_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin38_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin38_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin38_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin38_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin38_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin38_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin38_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin38_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin38_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin38_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin38_DisableEdgeSense (  );
...
static void Handle_le_gpioPin38_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin38_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin38_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin38_Edge_t _result;
    _result  = le_gpioPin38_GetEdgeSense (  );
...
static void Handle_le_gpioPin38_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin38_Polarity_t _result;
    _result  = le_gpioPin38_GetPolarity (  );
...
static void Handle_le_gpioPin38_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin38_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin38_PullUpDown_t _result;
    _result  = le_gpioPin38_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin38_SetInput : Handle_le_gpioPin38_SetInput(msgRef); break;
        case _MSGID_le_gpioPin38_SetPushPullOutput : Handle_le_gpioPin38_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin38_SetTriStateOutput : Handle_le_gpioPin38_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin38_SetOpenDrainOutput : Handle_le_gpioPin38_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin38_EnablePullUp : Handle_le_gpioPin38_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin38_EnablePullDown : Handle_le_gpioPin38_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin38_DisableResistors : Handle_le_gpioPin38_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin38_Activate : Handle_le_gpioPin38_Activate(msgRef); break;
        case _MSGID_le_gpioPin38_Deactivate : Handle_le_gpioPin38_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin38_SetHighZ : Handle_le_gpioPin38_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin38_Read : Handle_le_gpioPin38_Read(msgRef); break;
        case _MSGID_le_gpioPin38_AddChangeEventHandler : Handle_le_gpioPin38_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin38_RemoveChangeEventHandler : Handle_le_gpioPin38_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin38_SetEdgeSense : Handle_le_gpioPin38_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin38_DisableEdgeSense : Handle_le_gpioPin38_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin38_IsOutput : Handle_le_gpioPin38_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin38_IsInput : Handle_le_gpioPin38_IsInput(msgRef); break;
        case _MSGID_le_gpioPin38_GetEdgeSense : Handle_le_gpioPin38_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin38_GetPolarity : Handle_le_gpioPin38_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin38_IsActive : Handle_le_gpioPin38_IsActive(msgRef); break;
        case _MSGID_le_gpioPin38_GetPullUpDown : Handle_le_gpioPin38_GetPullUpDown(msgRef); break;
