...
#include "le_gpioPin17_messages.h"
#include "le_gpioPin17_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin17_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin17_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin17_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin17_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin17_ServerHandlers", 3);
...
static void Handle_le_gpioPin17_SetInput
(
...
)
{
    ...
    le_gpioPin17_Polarity_t polarity;
...
static void Handle_le_gpioPin17_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin17_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin17_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin17_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin17_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin17_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin17_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin17_EnablePullUp (  );
...
static void Handle_le_gpioPin17_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin17_EnablePullDown (  );
...
static void Handle_le_gpioPin17_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin17_DisableResistors (  );
...
static void Handle_le_gpioPin17_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin17_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin17_Deactivate (  );
...
static void Handle_le_gpioPin17_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin17_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin17_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin17_AddChangeEventHandler;
...
static void Handle_le_gpioPin17_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin17_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin17_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin17_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin17_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin17_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin17_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin17_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin17_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin17_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin17_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin17_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin17_DisableEdgeSense (  );
...
static void Handle_le_gpioPin17_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin17_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin17_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin17_Edge_t _result;
    _result  = le_gpioPin17_GetEdgeSense (  );
...
static void Handle_le_gpioPin17_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin17_Polarity_t _result;
    _result  = le_gpioPin17_GetPolarity (  );
...
static void Handle_le_gpioPin17_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin17_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin17_PullUpDown_t _result;
    _result  = le_gpioPin17_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin17_SetInput : Handle_le_gpioPin17_SetInput(msgRef); break;
        case _MSGID_le_gpioPin17_SetPushPullOutput : Handle_le_gpioPin17_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin17_SetTriStateOutput : Handle_le_gpioPin17_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin17_SetOpenDrainOutput : Handle_le_gpioPin17_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin17_EnablePullUp : Handle_le_gpioPin17_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin17_EnablePullDown : Handle_le_gpioPin17_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin17_DisableResistors : Handle_le_gpioPin17_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin17_Activate : Handle_le_gpioPin17_Activate(msgRef); break;
        case _MSGID_le_gpioPin17_Deactivate : Handle_le_gpioPin17_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin17_SetHighZ : Handle_le_gpioPin17_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin17_Read : Handle_le_gpioPin17_Read(msgRef); break;
        case _MSGID_le_gpioPin17_AddChangeEventHandler : Handle_le_gpioPin17_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin17_RemoveChangeEventHandler : Handle_le_gpioPin17_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin17_SetEdgeSense : Handle_le_gpioPin17_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin17_DisableEdgeSense : Handle_le_gpioPin17_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin17_IsOutput : Handle_le_gpioPin17_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin17_IsInput : Handle_le_gpioPin17_IsInput(msgRef); break;
        case _MSGID_le_gpioPin17_GetEdgeSense : Handle_le_gpioPin17_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin17_GetPolarity : Handle_le_gpioPin17_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin17_IsActive : Handle_le_gpioPin17_IsActive(msgRef); break;
        case _MSGID_le_gpioPin17_GetPullUpDown : Handle_le_gpioPin17_GetPullUpDown(msgRef); break;
