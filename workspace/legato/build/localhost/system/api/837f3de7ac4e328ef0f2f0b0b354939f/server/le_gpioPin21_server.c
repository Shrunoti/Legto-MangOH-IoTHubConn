...
#include "le_gpioPin21_messages.h"
#include "le_gpioPin21_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin21_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin21_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin21_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin21_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin21_ServerHandlers", 3);
...
static void Handle_le_gpioPin21_SetInput
(
...
static void Handle_le_gpioPin21_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin21_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin21_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin21_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin21_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin21_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin21_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin21_EnablePullUp (  );
...
static void Handle_le_gpioPin21_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin21_EnablePullDown (  );
...
static void Handle_le_gpioPin21_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin21_DisableResistors (  );
...
static void Handle_le_gpioPin21_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin21_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin21_Deactivate (  );
...
static void Handle_le_gpioPin21_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin21_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin21_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin21_AddChangeEventHandler;
...
static void Handle_le_gpioPin21_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin21_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin21_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin21_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin21_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin21_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin21_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin21_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin21_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin21_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin21_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin21_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin21_DisableEdgeSense (  );
...
static void Handle_le_gpioPin21_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin21_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin21_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin21_Edge_t _result;
    _result  = le_gpioPin21_GetEdgeSense (  );
...
static void Handle_le_gpioPin21_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin21_Polarity_t _result;
    _result  = le_gpioPin21_GetPolarity (  );
...
static void Handle_le_gpioPin21_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin21_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin21_PullUpDown_t _result;
    _result  = le_gpioPin21_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin21_SetInput : Handle_le_gpioPin21_SetInput(msgRef); break;
        case _MSGID_le_gpioPin21_SetPushPullOutput : Handle_le_gpioPin21_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin21_SetTriStateOutput : Handle_le_gpioPin21_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin21_SetOpenDrainOutput : Handle_le_gpioPin21_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin21_EnablePullUp : Handle_le_gpioPin21_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin21_EnablePullDown : Handle_le_gpioPin21_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin21_DisableResistors : Handle_le_gpioPin21_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin21_Activate : Handle_le_gpioPin21_Activate(msgRef); break;
        case _MSGID_le_gpioPin21_Deactivate : Handle_le_gpioPin21_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin21_SetHighZ : Handle_le_gpioPin21_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin21_Read : Handle_le_gpioPin21_Read(msgRef); break;
        case _MSGID_le_gpioPin21_AddChangeEventHandler : Handle_le_gpioPin21_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin21_RemoveChangeEventHandler : Handle_le_gpioPin21_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin21_SetEdgeSense : Handle_le_gpioPin21_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin21_DisableEdgeSense : Handle_le_gpioPin21_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin21_IsOutput : Handle_le_gpioPin21_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin21_IsInput : Handle_le_gpioPin21_IsInput(msgRef); break;
        case _MSGID_le_gpioPin21_GetEdgeSense : Handle_le_gpioPin21_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin21_GetPolarity : Handle_le_gpioPin21_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin21_IsActive : Handle_le_gpioPin21_IsActive(msgRef); break;
        case _MSGID_le_gpioPin21_GetPullUpDown : Handle_le_gpioPin21_GetPullUpDown(msgRef); break;
