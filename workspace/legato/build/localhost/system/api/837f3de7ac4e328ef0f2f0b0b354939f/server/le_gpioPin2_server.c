...
#include "le_gpioPin2_messages.h"
#include "le_gpioPin2_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin2_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin2_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin2_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin2_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin2_ServerHandlers", 3);
...
static void Handle_le_gpioPin2_SetInput
(
...
static void Handle_le_gpioPin2_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin2_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin2_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin2_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin2_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin2_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin2_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin2_EnablePullUp (  );
...
static void Handle_le_gpioPin2_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin2_EnablePullDown (  );
...
static void Handle_le_gpioPin2_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin2_DisableResistors (  );
...
static void Handle_le_gpioPin2_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin2_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin2_Deactivate (  );
...
static void Handle_le_gpioPin2_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin2_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin2_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin2_AddChangeEventHandler;
...
static void Handle_le_gpioPin2_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin2_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin2_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin2_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin2_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin2_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin2_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin2_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin2_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin2_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin2_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin2_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin2_DisableEdgeSense (  );
...
static void Handle_le_gpioPin2_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin2_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin2_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin2_Edge_t _result;
    _result  = le_gpioPin2_GetEdgeSense (  );
...
static void Handle_le_gpioPin2_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin2_Polarity_t _result;
    _result  = le_gpioPin2_GetPolarity (  );
...
static void Handle_le_gpioPin2_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin2_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin2_PullUpDown_t _result;
    _result  = le_gpioPin2_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin2_SetInput : Handle_le_gpioPin2_SetInput(msgRef); break;
        case _MSGID_le_gpioPin2_SetPushPullOutput : Handle_le_gpioPin2_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin2_SetTriStateOutput : Handle_le_gpioPin2_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin2_SetOpenDrainOutput : Handle_le_gpioPin2_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin2_EnablePullUp : Handle_le_gpioPin2_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin2_EnablePullDown : Handle_le_gpioPin2_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin2_DisableResistors : Handle_le_gpioPin2_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin2_Activate : Handle_le_gpioPin2_Activate(msgRef); break;
        case _MSGID_le_gpioPin2_Deactivate : Handle_le_gpioPin2_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin2_SetHighZ : Handle_le_gpioPin2_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin2_Read : Handle_le_gpioPin2_Read(msgRef); break;
        case _MSGID_le_gpioPin2_AddChangeEventHandler : Handle_le_gpioPin2_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin2_RemoveChangeEventHandler : Handle_le_gpioPin2_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin2_SetEdgeSense : Handle_le_gpioPin2_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin2_DisableEdgeSense : Handle_le_gpioPin2_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin2_IsOutput : Handle_le_gpioPin2_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin2_IsInput : Handle_le_gpioPin2_IsInput(msgRef); break;
        case _MSGID_le_gpioPin2_GetEdgeSense : Handle_le_gpioPin2_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin2_GetPolarity : Handle_le_gpioPin2_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin2_IsActive : Handle_le_gpioPin2_IsActive(msgRef); break;
        case _MSGID_le_gpioPin2_GetPullUpDown : Handle_le_gpioPin2_GetPullUpDown(msgRef); break;
