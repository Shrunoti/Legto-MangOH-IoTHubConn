...
#include "le_gpioPin19_messages.h"
#include "le_gpioPin19_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin19_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin19_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin19_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin19_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin19_ServerHandlers", 3);
...
static void Handle_le_gpioPin19_SetInput
(
...
)
{
    ...
    le_gpioPin19_Polarity_t polarity;
...
static void Handle_le_gpioPin19_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin19_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin19_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin19_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin19_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin19_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin19_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin19_EnablePullUp (  );
...
static void Handle_le_gpioPin19_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin19_EnablePullDown (  );
...
static void Handle_le_gpioPin19_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin19_DisableResistors (  );
...
static void Handle_le_gpioPin19_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin19_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin19_Deactivate (  );
...
static void Handle_le_gpioPin19_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin19_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin19_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin19_AddChangeEventHandler;
...
static void Handle_le_gpioPin19_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin19_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin19_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin19_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin19_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin19_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin19_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin19_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin19_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin19_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin19_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin19_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin19_DisableEdgeSense (  );
...
static void Handle_le_gpioPin19_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin19_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin19_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin19_Edge_t _result;
    _result  = le_gpioPin19_GetEdgeSense (  );
...
static void Handle_le_gpioPin19_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin19_Polarity_t _result;
    _result  = le_gpioPin19_GetPolarity (  );
...
static void Handle_le_gpioPin19_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin19_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin19_PullUpDown_t _result;
    _result  = le_gpioPin19_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin19_SetInput : Handle_le_gpioPin19_SetInput(msgRef); break;
        case _MSGID_le_gpioPin19_SetPushPullOutput : Handle_le_gpioPin19_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin19_SetTriStateOutput : Handle_le_gpioPin19_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin19_SetOpenDrainOutput : Handle_le_gpioPin19_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin19_EnablePullUp : Handle_le_gpioPin19_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin19_EnablePullDown : Handle_le_gpioPin19_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin19_DisableResistors : Handle_le_gpioPin19_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin19_Activate : Handle_le_gpioPin19_Activate(msgRef); break;
        case _MSGID_le_gpioPin19_Deactivate : Handle_le_gpioPin19_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin19_SetHighZ : Handle_le_gpioPin19_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin19_Read : Handle_le_gpioPin19_Read(msgRef); break;
        case _MSGID_le_gpioPin19_AddChangeEventHandler : Handle_le_gpioPin19_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin19_RemoveChangeEventHandler : Handle_le_gpioPin19_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin19_SetEdgeSense : Handle_le_gpioPin19_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin19_DisableEdgeSense : Handle_le_gpioPin19_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin19_IsOutput : Handle_le_gpioPin19_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin19_IsInput : Handle_le_gpioPin19_IsInput(msgRef); break;
        case _MSGID_le_gpioPin19_GetEdgeSense : Handle_le_gpioPin19_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin19_GetPolarity : Handle_le_gpioPin19_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin19_IsActive : Handle_le_gpioPin19_IsActive(msgRef); break;
        case _MSGID_le_gpioPin19_GetPullUpDown : Handle_le_gpioPin19_GetPullUpDown(msgRef); break;
