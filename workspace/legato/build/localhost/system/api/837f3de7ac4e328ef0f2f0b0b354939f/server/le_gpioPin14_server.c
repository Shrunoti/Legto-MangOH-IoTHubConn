...
#include "le_gpioPin14_messages.h"
#include "le_gpioPin14_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin14_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin14_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin14_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin14_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin14_ServerHandlers", 3);
...
static void Handle_le_gpioPin14_SetInput
(
...
)
{
    ...
    le_gpioPin14_Polarity_t polarity;
...
static void Handle_le_gpioPin14_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin14_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin14_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin14_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin14_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin14_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin14_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin14_EnablePullUp (  );
...
static void Handle_le_gpioPin14_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin14_EnablePullDown (  );
...
static void Handle_le_gpioPin14_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin14_DisableResistors (  );
...
static void Handle_le_gpioPin14_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin14_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin14_Deactivate (  );
...
static void Handle_le_gpioPin14_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin14_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin14_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin14_AddChangeEventHandler;
...
static void Handle_le_gpioPin14_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin14_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin14_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin14_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin14_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin14_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin14_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin14_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin14_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin14_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin14_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin14_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin14_DisableEdgeSense (  );
...
static void Handle_le_gpioPin14_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin14_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin14_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin14_Edge_t _result;
    _result  = le_gpioPin14_GetEdgeSense (  );
...
static void Handle_le_gpioPin14_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin14_Polarity_t _result;
    _result  = le_gpioPin14_GetPolarity (  );
...
static void Handle_le_gpioPin14_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin14_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin14_PullUpDown_t _result;
    _result  = le_gpioPin14_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin14_SetInput : Handle_le_gpioPin14_SetInput(msgRef); break;
        case _MSGID_le_gpioPin14_SetPushPullOutput : Handle_le_gpioPin14_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin14_SetTriStateOutput : Handle_le_gpioPin14_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin14_SetOpenDrainOutput : Handle_le_gpioPin14_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin14_EnablePullUp : Handle_le_gpioPin14_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin14_EnablePullDown : Handle_le_gpioPin14_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin14_DisableResistors : Handle_le_gpioPin14_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin14_Activate : Handle_le_gpioPin14_Activate(msgRef); break;
        case _MSGID_le_gpioPin14_Deactivate : Handle_le_gpioPin14_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin14_SetHighZ : Handle_le_gpioPin14_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin14_Read : Handle_le_gpioPin14_Read(msgRef); break;
        case _MSGID_le_gpioPin14_AddChangeEventHandler : Handle_le_gpioPin14_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin14_RemoveChangeEventHandler : Handle_le_gpioPin14_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin14_SetEdgeSense : Handle_le_gpioPin14_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin14_DisableEdgeSense : Handle_le_gpioPin14_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin14_IsOutput : Handle_le_gpioPin14_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin14_IsInput : Handle_le_gpioPin14_IsInput(msgRef); break;
        case _MSGID_le_gpioPin14_GetEdgeSense : Handle_le_gpioPin14_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin14_GetPolarity : Handle_le_gpioPin14_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin14_IsActive : Handle_le_gpioPin14_IsActive(msgRef); break;
        case _MSGID_le_gpioPin14_GetPullUpDown : Handle_le_gpioPin14_GetPullUpDown(msgRef); break;
