...
#include "le_gpioPin51_messages.h"
#include "le_gpioPin51_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin51_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin51_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin51_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin51_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin51_ServerHandlers", 3);
...
static void Handle_le_gpioPin51_SetInput
(
...
)
{
    ...
    le_gpioPin51_Polarity_t polarity;
...
static void Handle_le_gpioPin51_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin51_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin51_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin51_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin51_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin51_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin51_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin51_EnablePullUp (  );
...
static void Handle_le_gpioPin51_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin51_EnablePullDown (  );
...
static void Handle_le_gpioPin51_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin51_DisableResistors (  );
...
static void Handle_le_gpioPin51_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin51_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin51_Deactivate (  );
...
static void Handle_le_gpioPin51_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin51_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin51_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin51_AddChangeEventHandler;
...
static void Handle_le_gpioPin51_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin51_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin51_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin51_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin51_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin51_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin51_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin51_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin51_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin51_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin51_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin51_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin51_DisableEdgeSense (  );
...
static void Handle_le_gpioPin51_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin51_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin51_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin51_Edge_t _result;
    _result  = le_gpioPin51_GetEdgeSense (  );
...
static void Handle_le_gpioPin51_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin51_Polarity_t _result;
    _result  = le_gpioPin51_GetPolarity (  );
...
static void Handle_le_gpioPin51_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin51_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin51_PullUpDown_t _result;
    _result  = le_gpioPin51_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin51_SetInput : Handle_le_gpioPin51_SetInput(msgRef); break;
        case _MSGID_le_gpioPin51_SetPushPullOutput : Handle_le_gpioPin51_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin51_SetTriStateOutput : Handle_le_gpioPin51_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin51_SetOpenDrainOutput : Handle_le_gpioPin51_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin51_EnablePullUp : Handle_le_gpioPin51_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin51_EnablePullDown : Handle_le_gpioPin51_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin51_DisableResistors : Handle_le_gpioPin51_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin51_Activate : Handle_le_gpioPin51_Activate(msgRef); break;
        case _MSGID_le_gpioPin51_Deactivate : Handle_le_gpioPin51_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin51_SetHighZ : Handle_le_gpioPin51_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin51_Read : Handle_le_gpioPin51_Read(msgRef); break;
        case _MSGID_le_gpioPin51_AddChangeEventHandler : Handle_le_gpioPin51_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin51_RemoveChangeEventHandler : Handle_le_gpioPin51_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin51_SetEdgeSense : Handle_le_gpioPin51_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin51_DisableEdgeSense : Handle_le_gpioPin51_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin51_IsOutput : Handle_le_gpioPin51_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin51_IsInput : Handle_le_gpioPin51_IsInput(msgRef); break;
        case _MSGID_le_gpioPin51_GetEdgeSense : Handle_le_gpioPin51_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin51_GetPolarity : Handle_le_gpioPin51_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin51_IsActive : Handle_le_gpioPin51_IsActive(msgRef); break;
        case _MSGID_le_gpioPin51_GetPullUpDown : Handle_le_gpioPin51_GetPullUpDown(msgRef); break;
