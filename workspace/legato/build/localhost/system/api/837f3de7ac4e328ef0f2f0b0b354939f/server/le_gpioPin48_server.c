...
#include "le_gpioPin48_messages.h"
#include "le_gpioPin48_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin48_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin48_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin48_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin48_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin48_ServerHandlers", 3);
...
static void Handle_le_gpioPin48_SetInput
(
...
)
{
    ...
    le_gpioPin48_Polarity_t polarity;
...
static void Handle_le_gpioPin48_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin48_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin48_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin48_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin48_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin48_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin48_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin48_EnablePullUp (  );
...
static void Handle_le_gpioPin48_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin48_EnablePullDown (  );
...
static void Handle_le_gpioPin48_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin48_DisableResistors (  );
...
static void Handle_le_gpioPin48_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin48_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin48_Deactivate (  );
...
static void Handle_le_gpioPin48_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin48_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin48_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin48_AddChangeEventHandler;
...
static void Handle_le_gpioPin48_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin48_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin48_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin48_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin48_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin48_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin48_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin48_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin48_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin48_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin48_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin48_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin48_DisableEdgeSense (  );
...
static void Handle_le_gpioPin48_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin48_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin48_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin48_Edge_t _result;
    _result  = le_gpioPin48_GetEdgeSense (  );
...
static void Handle_le_gpioPin48_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin48_Polarity_t _result;
    _result  = le_gpioPin48_GetPolarity (  );
...
static void Handle_le_gpioPin48_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin48_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin48_PullUpDown_t _result;
    _result  = le_gpioPin48_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin48_SetInput : Handle_le_gpioPin48_SetInput(msgRef); break;
        case _MSGID_le_gpioPin48_SetPushPullOutput : Handle_le_gpioPin48_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin48_SetTriStateOutput : Handle_le_gpioPin48_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin48_SetOpenDrainOutput : Handle_le_gpioPin48_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin48_EnablePullUp : Handle_le_gpioPin48_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin48_EnablePullDown : Handle_le_gpioPin48_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin48_DisableResistors : Handle_le_gpioPin48_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin48_Activate : Handle_le_gpioPin48_Activate(msgRef); break;
        case _MSGID_le_gpioPin48_Deactivate : Handle_le_gpioPin48_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin48_SetHighZ : Handle_le_gpioPin48_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin48_Read : Handle_le_gpioPin48_Read(msgRef); break;
        case _MSGID_le_gpioPin48_AddChangeEventHandler : Handle_le_gpioPin48_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin48_RemoveChangeEventHandler : Handle_le_gpioPin48_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin48_SetEdgeSense : Handle_le_gpioPin48_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin48_DisableEdgeSense : Handle_le_gpioPin48_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin48_IsOutput : Handle_le_gpioPin48_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin48_IsInput : Handle_le_gpioPin48_IsInput(msgRef); break;
        case _MSGID_le_gpioPin48_GetEdgeSense : Handle_le_gpioPin48_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin48_GetPolarity : Handle_le_gpioPin48_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin48_IsActive : Handle_le_gpioPin48_IsActive(msgRef); break;
        case _MSGID_le_gpioPin48_GetPullUpDown : Handle_le_gpioPin48_GetPullUpDown(msgRef); break;
