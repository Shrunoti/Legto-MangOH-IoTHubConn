...
#include "le_gpioPin37_messages.h"
#include "le_gpioPin37_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin37_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin37_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin37_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin37_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin37_ServerHandlers", 3);
...
static void Handle_le_gpioPin37_SetInput
(
...
)
{
    ...
    le_gpioPin37_Polarity_t polarity;
...
static void Handle_le_gpioPin37_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin37_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin37_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin37_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin37_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin37_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin37_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin37_EnablePullUp (  );
...
static void Handle_le_gpioPin37_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin37_EnablePullDown (  );
...
static void Handle_le_gpioPin37_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin37_DisableResistors (  );
...
static void Handle_le_gpioPin37_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin37_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin37_Deactivate (  );
...
static void Handle_le_gpioPin37_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin37_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin37_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin37_AddChangeEventHandler;
...
static void Handle_le_gpioPin37_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin37_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin37_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin37_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin37_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin37_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin37_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin37_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin37_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin37_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin37_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin37_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin37_DisableEdgeSense (  );
...
static void Handle_le_gpioPin37_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin37_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin37_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin37_Edge_t _result;
    _result  = le_gpioPin37_GetEdgeSense (  );
...
static void Handle_le_gpioPin37_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin37_Polarity_t _result;
    _result  = le_gpioPin37_GetPolarity (  );
...
static void Handle_le_gpioPin37_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin37_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin37_PullUpDown_t _result;
    _result  = le_gpioPin37_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin37_SetInput : Handle_le_gpioPin37_SetInput(msgRef); break;
        case _MSGID_le_gpioPin37_SetPushPullOutput : Handle_le_gpioPin37_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin37_SetTriStateOutput : Handle_le_gpioPin37_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin37_SetOpenDrainOutput : Handle_le_gpioPin37_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin37_EnablePullUp : Handle_le_gpioPin37_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin37_EnablePullDown : Handle_le_gpioPin37_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin37_DisableResistors : Handle_le_gpioPin37_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin37_Activate : Handle_le_gpioPin37_Activate(msgRef); break;
        case _MSGID_le_gpioPin37_Deactivate : Handle_le_gpioPin37_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin37_SetHighZ : Handle_le_gpioPin37_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin37_Read : Handle_le_gpioPin37_Read(msgRef); break;
        case _MSGID_le_gpioPin37_AddChangeEventHandler : Handle_le_gpioPin37_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin37_RemoveChangeEventHandler : Handle_le_gpioPin37_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin37_SetEdgeSense : Handle_le_gpioPin37_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin37_DisableEdgeSense : Handle_le_gpioPin37_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin37_IsOutput : Handle_le_gpioPin37_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin37_IsInput : Handle_le_gpioPin37_IsInput(msgRef); break;
        case _MSGID_le_gpioPin37_GetEdgeSense : Handle_le_gpioPin37_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin37_GetPolarity : Handle_le_gpioPin37_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin37_IsActive : Handle_le_gpioPin37_IsActive(msgRef); break;
        case _MSGID_le_gpioPin37_GetPullUpDown : Handle_le_gpioPin37_GetPullUpDown(msgRef); break;
