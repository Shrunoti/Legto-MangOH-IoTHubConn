...
#include "le_gpioPin23_messages.h"
#include "le_gpioPin23_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin23_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin23_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin23_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin23_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin23_ServerHandlers", 3);
...
static void Handle_le_gpioPin23_SetInput
(
...
static void Handle_le_gpioPin23_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin23_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin23_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin23_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin23_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin23_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin23_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin23_EnablePullUp (  );
...
static void Handle_le_gpioPin23_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin23_EnablePullDown (  );
...
static void Handle_le_gpioPin23_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin23_DisableResistors (  );
...
static void Handle_le_gpioPin23_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin23_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin23_Deactivate (  );
...
static void Handle_le_gpioPin23_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin23_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin23_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin23_AddChangeEventHandler;
...
static void Handle_le_gpioPin23_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin23_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin23_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin23_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin23_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin23_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_gpioPin23_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin23_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin23_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin23_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin23_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin23_DisableEdgeSense (  );
...
static void Handle_le_gpioPin23_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin23_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin23_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin23_Edge_t _result;
    _result  = le_gpioPin23_GetEdgeSense (  );
...
static void Handle_le_gpioPin23_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin23_Polarity_t _result;
    _result  = le_gpioPin23_GetPolarity (  );
...
static void Handle_le_gpioPin23_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin23_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin23_PullUpDown_t _result;
    _result  = le_gpioPin23_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin23_SetInput : Handle_le_gpioPin23_SetInput(msgRef); break;
        case _MSGID_le_gpioPin23_SetPushPullOutput : Handle_le_gpioPin23_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin23_SetTriStateOutput : Handle_le_gpioPin23_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin23_SetOpenDrainOutput : Handle_le_gpioPin23_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin23_EnablePullUp : Handle_le_gpioPin23_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin23_EnablePullDown : Handle_le_gpioPin23_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin23_DisableResistors : Handle_le_gpioPin23_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin23_Activate : Handle_le_gpioPin23_Activate(msgRef); break;
        case _MSGID_le_gpioPin23_Deactivate : Handle_le_gpioPin23_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin23_SetHighZ : Handle_le_gpioPin23_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin23_Read : Handle_le_gpioPin23_Read(msgRef); break;
        case _MSGID_le_gpioPin23_AddChangeEventHandler : Handle_le_gpioPin23_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin23_RemoveChangeEventHandler : Handle_le_gpioPin23_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin23_SetEdgeSense : Handle_le_gpioPin23_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin23_DisableEdgeSense : Handle_le_gpioPin23_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin23_IsOutput : Handle_le_gpioPin23_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin23_IsInput : Handle_le_gpioPin23_IsInput(msgRef); break;
        case _MSGID_le_gpioPin23_GetEdgeSense : Handle_le_gpioPin23_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin23_GetPolarity : Handle_le_gpioPin23_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin23_IsActive : Handle_le_gpioPin23_IsActive(msgRef); break;
        case _MSGID_le_gpioPin23_GetPullUpDown : Handle_le_gpioPin23_GetPullUpDown(msgRef); break;
