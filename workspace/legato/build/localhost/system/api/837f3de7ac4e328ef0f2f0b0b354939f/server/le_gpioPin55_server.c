...
#include "le_gpioPin55_messages.h"
#include "le_gpioPin55_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin55_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin55_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin55_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin55_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin55_ServerHandlers", 3);
...
static void Handle_le_gpioPin55_SetInput
(
...
)
{
    ...
    le_gpioPin55_Polarity_t polarity;
...
static void Handle_le_gpioPin55_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin55_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin55_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin55_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin55_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin55_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin55_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin55_EnablePullUp (  );
...
static void Handle_le_gpioPin55_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin55_EnablePullDown (  );
...
static void Handle_le_gpioPin55_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin55_DisableResistors (  );
...
static void Handle_le_gpioPin55_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin55_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin55_Deactivate (  );
...
static void Handle_le_gpioPin55_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin55_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin55_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin55_AddChangeEventHandler;
...
static void Handle_le_gpioPin55_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin55_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin55_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin55_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin55_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin55_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin55_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin55_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin55_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin55_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin55_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin55_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin55_DisableEdgeSense (  );
...
static void Handle_le_gpioPin55_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin55_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin55_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin55_Edge_t _result;
    _result  = le_gpioPin55_GetEdgeSense (  );
...
static void Handle_le_gpioPin55_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin55_Polarity_t _result;
    _result  = le_gpioPin55_GetPolarity (  );
...
static void Handle_le_gpioPin55_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin55_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin55_PullUpDown_t _result;
    _result  = le_gpioPin55_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin55_SetInput : Handle_le_gpioPin55_SetInput(msgRef); break;
        case _MSGID_le_gpioPin55_SetPushPullOutput : Handle_le_gpioPin55_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin55_SetTriStateOutput : Handle_le_gpioPin55_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin55_SetOpenDrainOutput : Handle_le_gpioPin55_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin55_EnablePullUp : Handle_le_gpioPin55_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin55_EnablePullDown : Handle_le_gpioPin55_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin55_DisableResistors : Handle_le_gpioPin55_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin55_Activate : Handle_le_gpioPin55_Activate(msgRef); break;
        case _MSGID_le_gpioPin55_Deactivate : Handle_le_gpioPin55_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin55_SetHighZ : Handle_le_gpioPin55_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin55_Read : Handle_le_gpioPin55_Read(msgRef); break;
        case _MSGID_le_gpioPin55_AddChangeEventHandler : Handle_le_gpioPin55_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin55_RemoveChangeEventHandler : Handle_le_gpioPin55_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin55_SetEdgeSense : Handle_le_gpioPin55_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin55_DisableEdgeSense : Handle_le_gpioPin55_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin55_IsOutput : Handle_le_gpioPin55_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin55_IsInput : Handle_le_gpioPin55_IsInput(msgRef); break;
        case _MSGID_le_gpioPin55_GetEdgeSense : Handle_le_gpioPin55_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin55_GetPolarity : Handle_le_gpioPin55_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin55_IsActive : Handle_le_gpioPin55_IsActive(msgRef); break;
        case _MSGID_le_gpioPin55_GetPullUpDown : Handle_le_gpioPin55_GetPullUpDown(msgRef); break;
