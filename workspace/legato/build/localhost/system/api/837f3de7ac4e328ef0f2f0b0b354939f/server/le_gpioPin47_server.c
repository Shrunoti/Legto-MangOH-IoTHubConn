...
#include "le_gpioPin47_messages.h"
#include "le_gpioPin47_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin47_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin47_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin47_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin47_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin47_ServerHandlers", 3);
...
static void Handle_le_gpioPin47_SetInput
(
...
)
{
    ...
    le_gpioPin47_Polarity_t polarity;
...
static void Handle_le_gpioPin47_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin47_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin47_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin47_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin47_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin47_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin47_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin47_EnablePullUp (  );
...
static void Handle_le_gpioPin47_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin47_EnablePullDown (  );
...
static void Handle_le_gpioPin47_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin47_DisableResistors (  );
...
static void Handle_le_gpioPin47_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin47_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin47_Deactivate (  );
...
static void Handle_le_gpioPin47_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin47_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin47_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin47_AddChangeEventHandler;
...
static void Handle_le_gpioPin47_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin47_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin47_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin47_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin47_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin47_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin47_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin47_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin47_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin47_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin47_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin47_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin47_DisableEdgeSense (  );
...
static void Handle_le_gpioPin47_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin47_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin47_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin47_Edge_t _result;
    _result  = le_gpioPin47_GetEdgeSense (  );
...
static void Handle_le_gpioPin47_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin47_Polarity_t _result;
    _result  = le_gpioPin47_GetPolarity (  );
...
static void Handle_le_gpioPin47_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin47_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin47_PullUpDown_t _result;
    _result  = le_gpioPin47_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin47_SetInput : Handle_le_gpioPin47_SetInput(msgRef); break;
        case _MSGID_le_gpioPin47_SetPushPullOutput : Handle_le_gpioPin47_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin47_SetTriStateOutput : Handle_le_gpioPin47_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin47_SetOpenDrainOutput : Handle_le_gpioPin47_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin47_EnablePullUp : Handle_le_gpioPin47_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin47_EnablePullDown : Handle_le_gpioPin47_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin47_DisableResistors : Handle_le_gpioPin47_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin47_Activate : Handle_le_gpioPin47_Activate(msgRef); break;
        case _MSGID_le_gpioPin47_Deactivate : Handle_le_gpioPin47_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin47_SetHighZ : Handle_le_gpioPin47_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin47_Read : Handle_le_gpioPin47_Read(msgRef); break;
        case _MSGID_le_gpioPin47_AddChangeEventHandler : Handle_le_gpioPin47_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin47_RemoveChangeEventHandler : Handle_le_gpioPin47_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin47_SetEdgeSense : Handle_le_gpioPin47_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin47_DisableEdgeSense : Handle_le_gpioPin47_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin47_IsOutput : Handle_le_gpioPin47_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin47_IsInput : Handle_le_gpioPin47_IsInput(msgRef); break;
        case _MSGID_le_gpioPin47_GetEdgeSense : Handle_le_gpioPin47_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin47_GetPolarity : Handle_le_gpioPin47_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin47_IsActive : Handle_le_gpioPin47_IsActive(msgRef); break;
        case _MSGID_le_gpioPin47_GetPullUpDown : Handle_le_gpioPin47_GetPullUpDown(msgRef); break;
