...
#include "le_gpioPin56_messages.h"
#include "le_gpioPin56_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin56_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin56_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin56_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin56_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin56_ServerHandlers", 3);
...
static void Handle_le_gpioPin56_SetInput
(
...
)
{
    ...
    le_gpioPin56_Polarity_t polarity;
...
static void Handle_le_gpioPin56_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin56_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin56_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin56_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin56_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin56_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin56_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin56_EnablePullUp (  );
...
static void Handle_le_gpioPin56_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin56_EnablePullDown (  );
...
static void Handle_le_gpioPin56_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin56_DisableResistors (  );
...
static void Handle_le_gpioPin56_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin56_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin56_Deactivate (  );
...
static void Handle_le_gpioPin56_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin56_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin56_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin56_AddChangeEventHandler;
...
static void Handle_le_gpioPin56_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin56_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin56_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin56_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin56_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin56_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin56_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin56_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin56_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin56_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin56_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin56_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin56_DisableEdgeSense (  );
...
static void Handle_le_gpioPin56_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin56_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin56_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin56_Edge_t _result;
    _result  = le_gpioPin56_GetEdgeSense (  );
...
static void Handle_le_gpioPin56_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin56_Polarity_t _result;
    _result  = le_gpioPin56_GetPolarity (  );
...
static void Handle_le_gpioPin56_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin56_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin56_PullUpDown_t _result;
    _result  = le_gpioPin56_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin56_SetInput : Handle_le_gpioPin56_SetInput(msgRef); break;
        case _MSGID_le_gpioPin56_SetPushPullOutput : Handle_le_gpioPin56_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin56_SetTriStateOutput : Handle_le_gpioPin56_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin56_SetOpenDrainOutput : Handle_le_gpioPin56_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin56_EnablePullUp : Handle_le_gpioPin56_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin56_EnablePullDown : Handle_le_gpioPin56_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin56_DisableResistors : Handle_le_gpioPin56_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin56_Activate : Handle_le_gpioPin56_Activate(msgRef); break;
        case _MSGID_le_gpioPin56_Deactivate : Handle_le_gpioPin56_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin56_SetHighZ : Handle_le_gpioPin56_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin56_Read : Handle_le_gpioPin56_Read(msgRef); break;
        case _MSGID_le_gpioPin56_AddChangeEventHandler : Handle_le_gpioPin56_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin56_RemoveChangeEventHandler : Handle_le_gpioPin56_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin56_SetEdgeSense : Handle_le_gpioPin56_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin56_DisableEdgeSense : Handle_le_gpioPin56_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin56_IsOutput : Handle_le_gpioPin56_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin56_IsInput : Handle_le_gpioPin56_IsInput(msgRef); break;
        case _MSGID_le_gpioPin56_GetEdgeSense : Handle_le_gpioPin56_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin56_GetPolarity : Handle_le_gpioPin56_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin56_IsActive : Handle_le_gpioPin56_IsActive(msgRef); break;
        case _MSGID_le_gpioPin56_GetPullUpDown : Handle_le_gpioPin56_GetPullUpDown(msgRef); break;
