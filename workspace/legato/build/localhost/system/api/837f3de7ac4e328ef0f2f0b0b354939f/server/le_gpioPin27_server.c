...
#include "le_gpioPin27_messages.h"
#include "le_gpioPin27_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin27_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin27_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin27_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin27_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin27_ServerHandlers", 3);
...
static void Handle_le_gpioPin27_SetInput
(
...
)
{
    ...
    le_gpioPin27_Polarity_t polarity;
...
static void Handle_le_gpioPin27_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin27_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin27_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin27_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin27_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin27_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin27_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin27_EnablePullUp (  );
...
static void Handle_le_gpioPin27_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin27_EnablePullDown (  );
...
static void Handle_le_gpioPin27_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin27_DisableResistors (  );
...
static void Handle_le_gpioPin27_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin27_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin27_Deactivate (  );
...
static void Handle_le_gpioPin27_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin27_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin27_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin27_AddChangeEventHandler;
...
static void Handle_le_gpioPin27_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin27_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin27_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin27_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin27_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin27_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin27_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin27_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin27_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin27_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin27_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin27_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin27_DisableEdgeSense (  );
...
static void Handle_le_gpioPin27_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin27_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin27_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin27_Edge_t _result;
    _result  = le_gpioPin27_GetEdgeSense (  );
...
static void Handle_le_gpioPin27_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin27_Polarity_t _result;
    _result  = le_gpioPin27_GetPolarity (  );
...
static void Handle_le_gpioPin27_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin27_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin27_PullUpDown_t _result;
    _result  = le_gpioPin27_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin27_SetInput : Handle_le_gpioPin27_SetInput(msgRef); break;
        case _MSGID_le_gpioPin27_SetPushPullOutput : Handle_le_gpioPin27_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin27_SetTriStateOutput : Handle_le_gpioPin27_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin27_SetOpenDrainOutput : Handle_le_gpioPin27_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin27_EnablePullUp : Handle_le_gpioPin27_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin27_EnablePullDown : Handle_le_gpioPin27_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin27_DisableResistors : Handle_le_gpioPin27_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin27_Activate : Handle_le_gpioPin27_Activate(msgRef); break;
        case _MSGID_le_gpioPin27_Deactivate : Handle_le_gpioPin27_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin27_SetHighZ : Handle_le_gpioPin27_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin27_Read : Handle_le_gpioPin27_Read(msgRef); break;
        case _MSGID_le_gpioPin27_AddChangeEventHandler : Handle_le_gpioPin27_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin27_RemoveChangeEventHandler : Handle_le_gpioPin27_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin27_SetEdgeSense : Handle_le_gpioPin27_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin27_DisableEdgeSense : Handle_le_gpioPin27_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin27_IsOutput : Handle_le_gpioPin27_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin27_IsInput : Handle_le_gpioPin27_IsInput(msgRef); break;
        case _MSGID_le_gpioPin27_GetEdgeSense : Handle_le_gpioPin27_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin27_GetPolarity : Handle_le_gpioPin27_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin27_IsActive : Handle_le_gpioPin27_IsActive(msgRef); break;
        case _MSGID_le_gpioPin27_GetPullUpDown : Handle_le_gpioPin27_GetPullUpDown(msgRef); break;
