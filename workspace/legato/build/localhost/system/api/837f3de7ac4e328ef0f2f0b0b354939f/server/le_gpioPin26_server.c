...
#include "le_gpioPin26_messages.h"
#include "le_gpioPin26_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin26_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin26_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin26_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin26_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin26_ServerHandlers", 3);
...
static void Handle_le_gpioPin26_SetInput
(
...
)
{
    ...
    le_gpioPin26_Polarity_t polarity;
...
static void Handle_le_gpioPin26_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin26_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin26_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin26_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin26_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin26_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin26_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin26_EnablePullUp (  );
...
static void Handle_le_gpioPin26_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin26_EnablePullDown (  );
...
static void Handle_le_gpioPin26_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin26_DisableResistors (  );
...
static void Handle_le_gpioPin26_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin26_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin26_Deactivate (  );
...
static void Handle_le_gpioPin26_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin26_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin26_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin26_AddChangeEventHandler;
...
static void Handle_le_gpioPin26_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin26_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin26_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin26_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin26_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin26_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin26_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin26_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin26_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin26_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin26_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin26_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin26_DisableEdgeSense (  );
...
static void Handle_le_gpioPin26_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin26_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin26_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin26_Edge_t _result;
    _result  = le_gpioPin26_GetEdgeSense (  );
...
static void Handle_le_gpioPin26_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin26_Polarity_t _result;
    _result  = le_gpioPin26_GetPolarity (  );
...
static void Handle_le_gpioPin26_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin26_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin26_PullUpDown_t _result;
    _result  = le_gpioPin26_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin26_SetInput : Handle_le_gpioPin26_SetInput(msgRef); break;
        case _MSGID_le_gpioPin26_SetPushPullOutput : Handle_le_gpioPin26_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin26_SetTriStateOutput : Handle_le_gpioPin26_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin26_SetOpenDrainOutput : Handle_le_gpioPin26_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin26_EnablePullUp : Handle_le_gpioPin26_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin26_EnablePullDown : Handle_le_gpioPin26_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin26_DisableResistors : Handle_le_gpioPin26_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin26_Activate : Handle_le_gpioPin26_Activate(msgRef); break;
        case _MSGID_le_gpioPin26_Deactivate : Handle_le_gpioPin26_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin26_SetHighZ : Handle_le_gpioPin26_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin26_Read : Handle_le_gpioPin26_Read(msgRef); break;
        case _MSGID_le_gpioPin26_AddChangeEventHandler : Handle_le_gpioPin26_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin26_RemoveChangeEventHandler : Handle_le_gpioPin26_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin26_SetEdgeSense : Handle_le_gpioPin26_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin26_DisableEdgeSense : Handle_le_gpioPin26_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin26_IsOutput : Handle_le_gpioPin26_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin26_IsInput : Handle_le_gpioPin26_IsInput(msgRef); break;
        case _MSGID_le_gpioPin26_GetEdgeSense : Handle_le_gpioPin26_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin26_GetPolarity : Handle_le_gpioPin26_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin26_IsActive : Handle_le_gpioPin26_IsActive(msgRef); break;
        case _MSGID_le_gpioPin26_GetPullUpDown : Handle_le_gpioPin26_GetPullUpDown(msgRef); break;
