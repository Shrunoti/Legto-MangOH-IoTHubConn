...
#ifndef LE_GPIOPIN10_INTERFACE_H_INCLUDE_GUARD
#define LE_GPIOPIN10_INTERFACE_H_INCLUDE_GUARD
...
typedef enum
{
    LE_GPIOPIN10_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    LE_GPIOPIN10_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
le_gpioPin10_Polarity_t;
...
typedef enum
{
    LE_GPIOPIN10_EDGE_NONE = 0,
        ///< No edge detection
    LE_GPIOPIN10_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    LE_GPIOPIN10_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    LE_GPIOPIN10_EDGE_BOTH = 3
...
//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'le_gpioPin10_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct le_gpioPin10_ChangeEventHandler* le_gpioPin10_ChangeEventHandlerRef_t;
...
typedef enum
{
    LE_GPIOPIN10_PULL_OFF = 0,
        ///< Neither resistor is enabled
    LE_GPIOPIN10_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    LE_GPIOPIN10_PULL_UP = 2
        ///< Pullup resistor is enabled
}
le_gpioPin10_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_gpioPin10_ChangeCallbackFunc_t)
(
    bool state,
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin10_SetInput
(
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin10_SetPushPullOutput
(
    le_gpioPin10_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin10_SetTriStateOutput
(
    le_gpioPin10_Polarity_t polarity
        ///< [IN] Active-high or active-low.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin10_SetOpenDrainOutput
(
    le_gpioPin10_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin10_EnablePullUp
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin10_EnablePullDown
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin10_DisableResistors
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin10_Activate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin10_Deactivate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin10_SetHighZ
(
    void
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'le_gpioPin10_ChangeEvent'
 *
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'le_gpioPin10_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin10_RemoveChangeEventHandler
(
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin10_SetEdgeSense
(
    le_gpioPin10_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin10_DisableEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin10_Edge_t le_gpioPin10_GetEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin10_Polarity_t le_gpioPin10_GetPolarity
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin10_PullUpDown_t le_gpioPin10_GetPullUpDown
(
    void
);


#endif // LE_GPIOPIN10_INTERFACE_H_INCLUDE_GUARD