...
#ifndef LE_GPIOPIN59_INTERFACE_H_INCLUDE_GUARD
#define LE_GPIOPIN59_INTERFACE_H_INCLUDE_GUARD
...
typedef enum
{
    LE_GPIOPIN59_ACTIVE_HIGH = 0,
        ///< GPIO active-high, output is 1
    LE_GPIOPIN59_ACTIVE_LOW = 1
        ///< GPIO active-low, output is 0
}
le_gpioPin59_Polarity_t;
...
typedef enum
{
    LE_GPIOPIN59_EDGE_NONE = 0,
        ///< No edge detection
    LE_GPIOPIN59_EDGE_RISING = 1,
        ///< Notify when voltage goes from low to high.
    LE_GPIOPIN59_EDGE_FALLING = 2,
        ///< Notify when voltage goes from high to low.
    LE_GPIOPIN59_EDGE_BOTH = 3
...
//--------------------------------------------------------------------------------------------------
/**
 * Reference type used by Add/Remove functions for EVENT 'le_gpioPin59_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
typedef struct le_gpioPin59_ChangeEventHandler* le_gpioPin59_ChangeEventHandlerRef_t;
...
typedef enum
{
    LE_GPIOPIN59_PULL_OFF = 0,
        ///< Neither resistor is enabled
    LE_GPIOPIN59_PULL_DOWN = 1,
        ///< Pulldown resistor is enabled
    LE_GPIOPIN59_PULL_UP = 2
        ///< Pullup resistor is enabled
}
le_gpioPin59_PullUpDown_t;
 ...
 */
//--------------------------------------------------------------------------------------------------
typedef void (*le_gpioPin59_ChangeCallbackFunc_t)
(
    bool state,
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin59_SetInput
(
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin59_SetPushPullOutput
(
    le_gpioPin59_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin59_SetTriStateOutput
(
    le_gpioPin59_Polarity_t polarity
        ///< [IN] Active-high or active-low.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin59_SetOpenDrainOutput
(
    le_gpioPin59_Polarity_t polarity,
        ///< [IN] Active-high or active-low.
    bool value
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin59_EnablePullUp
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin59_EnablePullDown
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin59_DisableResistors
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin59_Activate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin59_Deactivate
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin59_SetHighZ
(
    void
);
...
//--------------------------------------------------------------------------------------------------
/**
 * Add handler function for EVENT 'le_gpioPin59_ChangeEvent'
 *
...
//--------------------------------------------------------------------------------------------------
/**
 * Remove handler function for EVENT 'le_gpioPin59_ChangeEvent'
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin59_RemoveChangeEventHandler
(
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin59_SetEdgeSense
(
    le_gpioPin59_Edge_t trigger
        ///< [IN] Change(s) that should trigger the callback to be called.
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t le_gpioPin59_DisableEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin59_Edge_t le_gpioPin59_GetEdgeSense
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin59_Polarity_t le_gpioPin59_GetPolarity
(
    void
);
 ...
 */
//--------------------------------------------------------------------------------------------------
le_gpioPin59_PullUpDown_t le_gpioPin59_GetPullUpDown
(
    void
);


#endif // LE_GPIOPIN59_INTERFACE_H_INCLUDE_GUARD