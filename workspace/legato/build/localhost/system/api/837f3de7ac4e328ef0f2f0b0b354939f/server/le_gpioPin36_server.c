...
#include "le_gpioPin36_messages.h"
#include "le_gpioPin36_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin36_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin36_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin36_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin36_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin36_ServerHandlers", 3);
...
static void Handle_le_gpioPin36_SetInput
(
...
)
{
    ...
    le_gpioPin36_Polarity_t polarity;
...
static void Handle_le_gpioPin36_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin36_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin36_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin36_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin36_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin36_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin36_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin36_EnablePullUp (  );
...
static void Handle_le_gpioPin36_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin36_EnablePullDown (  );
...
static void Handle_le_gpioPin36_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin36_DisableResistors (  );
...
static void Handle_le_gpioPin36_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin36_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin36_Deactivate (  );
...
static void Handle_le_gpioPin36_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin36_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin36_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin36_AddChangeEventHandler;
...
static void Handle_le_gpioPin36_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin36_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin36_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin36_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin36_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin36_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin36_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin36_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin36_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin36_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin36_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin36_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin36_DisableEdgeSense (  );
...
static void Handle_le_gpioPin36_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin36_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin36_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin36_Edge_t _result;
    _result  = le_gpioPin36_GetEdgeSense (  );
...
static void Handle_le_gpioPin36_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin36_Polarity_t _result;
    _result  = le_gpioPin36_GetPolarity (  );
...
static void Handle_le_gpioPin36_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin36_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin36_PullUpDown_t _result;
    _result  = le_gpioPin36_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin36_SetInput : Handle_le_gpioPin36_SetInput(msgRef); break;
        case _MSGID_le_gpioPin36_SetPushPullOutput : Handle_le_gpioPin36_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin36_SetTriStateOutput : Handle_le_gpioPin36_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin36_SetOpenDrainOutput : Handle_le_gpioPin36_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin36_EnablePullUp : Handle_le_gpioPin36_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin36_EnablePullDown : Handle_le_gpioPin36_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin36_DisableResistors : Handle_le_gpioPin36_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin36_Activate : Handle_le_gpioPin36_Activate(msgRef); break;
        case _MSGID_le_gpioPin36_Deactivate : Handle_le_gpioPin36_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin36_SetHighZ : Handle_le_gpioPin36_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin36_Read : Handle_le_gpioPin36_Read(msgRef); break;
        case _MSGID_le_gpioPin36_AddChangeEventHandler : Handle_le_gpioPin36_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin36_RemoveChangeEventHandler : Handle_le_gpioPin36_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin36_SetEdgeSense : Handle_le_gpioPin36_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin36_DisableEdgeSense : Handle_le_gpioPin36_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin36_IsOutput : Handle_le_gpioPin36_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin36_IsInput : Handle_le_gpioPin36_IsInput(msgRef); break;
        case _MSGID_le_gpioPin36_GetEdgeSense : Handle_le_gpioPin36_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin36_GetPolarity : Handle_le_gpioPin36_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin36_IsActive : Handle_le_gpioPin36_IsActive(msgRef); break;
        case _MSGID_le_gpioPin36_GetPullUpDown : Handle_le_gpioPin36_GetPullUpDown(msgRef); break;
