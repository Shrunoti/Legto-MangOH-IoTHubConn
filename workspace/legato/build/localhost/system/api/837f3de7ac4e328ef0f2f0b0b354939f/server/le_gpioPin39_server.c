...
#include "le_gpioPin39_messages.h"
#include "le_gpioPin39_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin39_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin39_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin39_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin39_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin39_ServerHandlers", 3);
...
static void Handle_le_gpioPin39_SetInput
(
...
)
{
    ...
    le_gpioPin39_Polarity_t polarity;
...
static void Handle_le_gpioPin39_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin39_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin39_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin39_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin39_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin39_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin39_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin39_EnablePullUp (  );
...
static void Handle_le_gpioPin39_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin39_EnablePullDown (  );
...
static void Handle_le_gpioPin39_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin39_DisableResistors (  );
...
static void Handle_le_gpioPin39_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin39_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin39_Deactivate (  );
...
static void Handle_le_gpioPin39_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin39_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin39_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin39_AddChangeEventHandler;
...
static void Handle_le_gpioPin39_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin39_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin39_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin39_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin39_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin39_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin39_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin39_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin39_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin39_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin39_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin39_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin39_DisableEdgeSense (  );
...
static void Handle_le_gpioPin39_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin39_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin39_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin39_Edge_t _result;
    _result  = le_gpioPin39_GetEdgeSense (  );
...
static void Handle_le_gpioPin39_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin39_Polarity_t _result;
    _result  = le_gpioPin39_GetPolarity (  );
...
static void Handle_le_gpioPin39_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin39_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin39_PullUpDown_t _result;
    _result  = le_gpioPin39_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin39_SetInput : Handle_le_gpioPin39_SetInput(msgRef); break;
        case _MSGID_le_gpioPin39_SetPushPullOutput : Handle_le_gpioPin39_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin39_SetTriStateOutput : Handle_le_gpioPin39_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin39_SetOpenDrainOutput : Handle_le_gpioPin39_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin39_EnablePullUp : Handle_le_gpioPin39_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin39_EnablePullDown : Handle_le_gpioPin39_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin39_DisableResistors : Handle_le_gpioPin39_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin39_Activate : Handle_le_gpioPin39_Activate(msgRef); break;
        case _MSGID_le_gpioPin39_Deactivate : Handle_le_gpioPin39_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin39_SetHighZ : Handle_le_gpioPin39_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin39_Read : Handle_le_gpioPin39_Read(msgRef); break;
        case _MSGID_le_gpioPin39_AddChangeEventHandler : Handle_le_gpioPin39_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin39_RemoveChangeEventHandler : Handle_le_gpioPin39_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin39_SetEdgeSense : Handle_le_gpioPin39_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin39_DisableEdgeSense : Handle_le_gpioPin39_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin39_IsOutput : Handle_le_gpioPin39_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin39_IsInput : Handle_le_gpioPin39_IsInput(msgRef); break;
        case _MSGID_le_gpioPin39_GetEdgeSense : Handle_le_gpioPin39_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin39_GetPolarity : Handle_le_gpioPin39_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin39_IsActive : Handle_le_gpioPin39_IsActive(msgRef); break;
        case _MSGID_le_gpioPin39_GetPullUpDown : Handle_le_gpioPin39_GetPullUpDown(msgRef); break;
