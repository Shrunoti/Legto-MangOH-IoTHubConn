...
#include "le_gpioPin11_messages.h"
#include "le_gpioPin11_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin11_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin11_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin11_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin11_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin11_ServerHandlers", 3);
...
static void Handle_le_gpioPin11_SetInput
(
...
)
{
    ...
    le_gpioPin11_Polarity_t polarity;
...
static void Handle_le_gpioPin11_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin11_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin11_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin11_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin11_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin11_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin11_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin11_EnablePullUp (  );
...
static void Handle_le_gpioPin11_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin11_EnablePullDown (  );
...
static void Handle_le_gpioPin11_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin11_DisableResistors (  );
...
static void Handle_le_gpioPin11_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin11_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin11_Deactivate (  );
...
static void Handle_le_gpioPin11_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin11_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin11_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin11_AddChangeEventHandler;
...
static void Handle_le_gpioPin11_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin11_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin11_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin11_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin11_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin11_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin11_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin11_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin11_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin11_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin11_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin11_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin11_DisableEdgeSense (  );
...
static void Handle_le_gpioPin11_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin11_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin11_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin11_Edge_t _result;
    _result  = le_gpioPin11_GetEdgeSense (  );
...
static void Handle_le_gpioPin11_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin11_Polarity_t _result;
    _result  = le_gpioPin11_GetPolarity (  );
...
static void Handle_le_gpioPin11_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin11_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin11_PullUpDown_t _result;
    _result  = le_gpioPin11_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin11_SetInput : Handle_le_gpioPin11_SetInput(msgRef); break;
        case _MSGID_le_gpioPin11_SetPushPullOutput : Handle_le_gpioPin11_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin11_SetTriStateOutput : Handle_le_gpioPin11_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin11_SetOpenDrainOutput : Handle_le_gpioPin11_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin11_EnablePullUp : Handle_le_gpioPin11_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin11_EnablePullDown : Handle_le_gpioPin11_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin11_DisableResistors : Handle_le_gpioPin11_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin11_Activate : Handle_le_gpioPin11_Activate(msgRef); break;
        case _MSGID_le_gpioPin11_Deactivate : Handle_le_gpioPin11_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin11_SetHighZ : Handle_le_gpioPin11_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin11_Read : Handle_le_gpioPin11_Read(msgRef); break;
        case _MSGID_le_gpioPin11_AddChangeEventHandler : Handle_le_gpioPin11_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin11_RemoveChangeEventHandler : Handle_le_gpioPin11_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin11_SetEdgeSense : Handle_le_gpioPin11_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin11_DisableEdgeSense : Handle_le_gpioPin11_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin11_IsOutput : Handle_le_gpioPin11_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin11_IsInput : Handle_le_gpioPin11_IsInput(msgRef); break;
        case _MSGID_le_gpioPin11_GetEdgeSense : Handle_le_gpioPin11_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin11_GetPolarity : Handle_le_gpioPin11_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin11_IsActive : Handle_le_gpioPin11_IsActive(msgRef); break;
        case _MSGID_le_gpioPin11_GetPullUpDown : Handle_le_gpioPin11_GetPullUpDown(msgRef); break;
