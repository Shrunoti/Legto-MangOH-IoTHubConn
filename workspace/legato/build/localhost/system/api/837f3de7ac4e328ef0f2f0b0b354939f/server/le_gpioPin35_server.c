...
#include "le_gpioPin35_messages.h"
#include "le_gpioPin35_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin35_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin35_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin35_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin35_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin35_ServerHandlers", 3);
...
static void Handle_le_gpioPin35_SetInput
(
...
)
{
    ...
    le_gpioPin35_Polarity_t polarity;
...
static void Handle_le_gpioPin35_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin35_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin35_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin35_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin35_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin35_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin35_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin35_EnablePullUp (  );
...
static void Handle_le_gpioPin35_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin35_EnablePullDown (  );
...
static void Handle_le_gpioPin35_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin35_DisableResistors (  );
...
static void Handle_le_gpioPin35_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin35_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin35_Deactivate (  );
...
static void Handle_le_gpioPin35_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin35_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin35_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin35_AddChangeEventHandler;
...
static void Handle_le_gpioPin35_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin35_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin35_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin35_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin35_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin35_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin35_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin35_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin35_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin35_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin35_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin35_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin35_DisableEdgeSense (  );
...
static void Handle_le_gpioPin35_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin35_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin35_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin35_Edge_t _result;
    _result  = le_gpioPin35_GetEdgeSense (  );
...
static void Handle_le_gpioPin35_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin35_Polarity_t _result;
    _result  = le_gpioPin35_GetPolarity (  );
...
static void Handle_le_gpioPin35_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin35_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin35_PullUpDown_t _result;
    _result  = le_gpioPin35_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin35_SetInput : Handle_le_gpioPin35_SetInput(msgRef); break;
        case _MSGID_le_gpioPin35_SetPushPullOutput : Handle_le_gpioPin35_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin35_SetTriStateOutput : Handle_le_gpioPin35_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin35_SetOpenDrainOutput : Handle_le_gpioPin35_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin35_EnablePullUp : Handle_le_gpioPin35_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin35_EnablePullDown : Handle_le_gpioPin35_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin35_DisableResistors : Handle_le_gpioPin35_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin35_Activate : Handle_le_gpioPin35_Activate(msgRef); break;
        case _MSGID_le_gpioPin35_Deactivate : Handle_le_gpioPin35_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin35_SetHighZ : Handle_le_gpioPin35_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin35_Read : Handle_le_gpioPin35_Read(msgRef); break;
        case _MSGID_le_gpioPin35_AddChangeEventHandler : Handle_le_gpioPin35_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin35_RemoveChangeEventHandler : Handle_le_gpioPin35_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin35_SetEdgeSense : Handle_le_gpioPin35_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin35_DisableEdgeSense : Handle_le_gpioPin35_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin35_IsOutput : Handle_le_gpioPin35_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin35_IsInput : Handle_le_gpioPin35_IsInput(msgRef); break;
        case _MSGID_le_gpioPin35_GetEdgeSense : Handle_le_gpioPin35_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin35_GetPolarity : Handle_le_gpioPin35_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin35_IsActive : Handle_le_gpioPin35_IsActive(msgRef); break;
        case _MSGID_le_gpioPin35_GetPullUpDown : Handle_le_gpioPin35_GetPullUpDown(msgRef); break;
