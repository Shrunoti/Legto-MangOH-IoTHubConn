...
#include "le_gpioPin20_messages.h"
#include "le_gpioPin20_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin20_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin20_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin20_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin20_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin20_ServerHandlers", 3);
...
static void Handle_le_gpioPin20_SetInput
(
...
)
{
    ...
    le_gpioPin20_Polarity_t polarity;
...
static void Handle_le_gpioPin20_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin20_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin20_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin20_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin20_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin20_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin20_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin20_EnablePullUp (  );
...
static void Handle_le_gpioPin20_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin20_EnablePullDown (  );
...
static void Handle_le_gpioPin20_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin20_DisableResistors (  );
...
static void Handle_le_gpioPin20_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin20_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin20_Deactivate (  );
...
static void Handle_le_gpioPin20_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin20_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin20_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin20_AddChangeEventHandler;
...
static void Handle_le_gpioPin20_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin20_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin20_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin20_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin20_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin20_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin20_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin20_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin20_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin20_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin20_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin20_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin20_DisableEdgeSense (  );
...
static void Handle_le_gpioPin20_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin20_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin20_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin20_Edge_t _result;
    _result  = le_gpioPin20_GetEdgeSense (  );
...
static void Handle_le_gpioPin20_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin20_Polarity_t _result;
    _result  = le_gpioPin20_GetPolarity (  );
...
static void Handle_le_gpioPin20_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin20_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin20_PullUpDown_t _result;
    _result  = le_gpioPin20_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin20_SetInput : Handle_le_gpioPin20_SetInput(msgRef); break;
        case _MSGID_le_gpioPin20_SetPushPullOutput : Handle_le_gpioPin20_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin20_SetTriStateOutput : Handle_le_gpioPin20_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin20_SetOpenDrainOutput : Handle_le_gpioPin20_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin20_EnablePullUp : Handle_le_gpioPin20_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin20_EnablePullDown : Handle_le_gpioPin20_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin20_DisableResistors : Handle_le_gpioPin20_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin20_Activate : Handle_le_gpioPin20_Activate(msgRef); break;
        case _MSGID_le_gpioPin20_Deactivate : Handle_le_gpioPin20_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin20_SetHighZ : Handle_le_gpioPin20_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin20_Read : Handle_le_gpioPin20_Read(msgRef); break;
        case _MSGID_le_gpioPin20_AddChangeEventHandler : Handle_le_gpioPin20_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin20_RemoveChangeEventHandler : Handle_le_gpioPin20_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin20_SetEdgeSense : Handle_le_gpioPin20_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin20_DisableEdgeSense : Handle_le_gpioPin20_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin20_IsOutput : Handle_le_gpioPin20_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin20_IsInput : Handle_le_gpioPin20_IsInput(msgRef); break;
        case _MSGID_le_gpioPin20_GetEdgeSense : Handle_le_gpioPin20_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin20_GetPolarity : Handle_le_gpioPin20_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin20_IsActive : Handle_le_gpioPin20_IsActive(msgRef); break;
        case _MSGID_le_gpioPin20_GetPullUpDown : Handle_le_gpioPin20_GetPullUpDown(msgRef); break;
