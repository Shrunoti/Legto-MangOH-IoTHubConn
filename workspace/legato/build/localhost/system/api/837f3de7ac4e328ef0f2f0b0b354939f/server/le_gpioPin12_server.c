...
#include "le_gpioPin12_messages.h"
#include "le_gpioPin12_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin12_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin12_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin12_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin12_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin12_ServerHandlers", 3);
...
static void Handle_le_gpioPin12_SetInput
(
...
)
{
    ...
    le_gpioPin12_Polarity_t polarity;
...
static void Handle_le_gpioPin12_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin12_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin12_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin12_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin12_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin12_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin12_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin12_EnablePullUp (  );
...
static void Handle_le_gpioPin12_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin12_EnablePullDown (  );
...
static void Handle_le_gpioPin12_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin12_DisableResistors (  );
...
static void Handle_le_gpioPin12_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin12_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin12_Deactivate (  );
...
static void Handle_le_gpioPin12_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin12_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin12_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin12_AddChangeEventHandler;
...
static void Handle_le_gpioPin12_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin12_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin12_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin12_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin12_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin12_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin12_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin12_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin12_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin12_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin12_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin12_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin12_DisableEdgeSense (  );
...
static void Handle_le_gpioPin12_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin12_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin12_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin12_Edge_t _result;
    _result  = le_gpioPin12_GetEdgeSense (  );
...
static void Handle_le_gpioPin12_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin12_Polarity_t _result;
    _result  = le_gpioPin12_GetPolarity (  );
...
static void Handle_le_gpioPin12_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin12_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin12_PullUpDown_t _result;
    _result  = le_gpioPin12_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin12_SetInput : Handle_le_gpioPin12_SetInput(msgRef); break;
        case _MSGID_le_gpioPin12_SetPushPullOutput : Handle_le_gpioPin12_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin12_SetTriStateOutput : Handle_le_gpioPin12_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin12_SetOpenDrainOutput : Handle_le_gpioPin12_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin12_EnablePullUp : Handle_le_gpioPin12_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin12_EnablePullDown : Handle_le_gpioPin12_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin12_DisableResistors : Handle_le_gpioPin12_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin12_Activate : Handle_le_gpioPin12_Activate(msgRef); break;
        case _MSGID_le_gpioPin12_Deactivate : Handle_le_gpioPin12_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin12_SetHighZ : Handle_le_gpioPin12_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin12_Read : Handle_le_gpioPin12_Read(msgRef); break;
        case _MSGID_le_gpioPin12_AddChangeEventHandler : Handle_le_gpioPin12_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin12_RemoveChangeEventHandler : Handle_le_gpioPin12_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin12_SetEdgeSense : Handle_le_gpioPin12_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin12_DisableEdgeSense : Handle_le_gpioPin12_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin12_IsOutput : Handle_le_gpioPin12_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin12_IsInput : Handle_le_gpioPin12_IsInput(msgRef); break;
        case _MSGID_le_gpioPin12_GetEdgeSense : Handle_le_gpioPin12_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin12_GetPolarity : Handle_le_gpioPin12_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin12_IsActive : Handle_le_gpioPin12_IsActive(msgRef); break;
        case _MSGID_le_gpioPin12_GetPullUpDown : Handle_le_gpioPin12_GetPullUpDown(msgRef); break;
