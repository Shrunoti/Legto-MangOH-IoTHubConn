...
#include "le_gpioPin58_messages.h"
#include "le_gpioPin58_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin58_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin58_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin58_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin58_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin58_ServerHandlers", 3);
...
static void Handle_le_gpioPin58_SetInput
(
...
)
{
    ...
    le_gpioPin58_Polarity_t polarity;
...
static void Handle_le_gpioPin58_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin58_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin58_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin58_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin58_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin58_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin58_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin58_EnablePullUp (  );
...
static void Handle_le_gpioPin58_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin58_EnablePullDown (  );
...
static void Handle_le_gpioPin58_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin58_DisableResistors (  );
...
static void Handle_le_gpioPin58_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin58_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin58_Deactivate (  );
...
static void Handle_le_gpioPin58_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin58_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin58_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin58_AddChangeEventHandler;
...
static void Handle_le_gpioPin58_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin58_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin58_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin58_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin58_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin58_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin58_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin58_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin58_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin58_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin58_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin58_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin58_DisableEdgeSense (  );
...
static void Handle_le_gpioPin58_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin58_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin58_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin58_Edge_t _result;
    _result  = le_gpioPin58_GetEdgeSense (  );
...
static void Handle_le_gpioPin58_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin58_Polarity_t _result;
    _result  = le_gpioPin58_GetPolarity (  );
...
static void Handle_le_gpioPin58_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin58_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin58_PullUpDown_t _result;
    _result  = le_gpioPin58_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin58_SetInput : Handle_le_gpioPin58_SetInput(msgRef); break;
        case _MSGID_le_gpioPin58_SetPushPullOutput : Handle_le_gpioPin58_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin58_SetTriStateOutput : Handle_le_gpioPin58_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin58_SetOpenDrainOutput : Handle_le_gpioPin58_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin58_EnablePullUp : Handle_le_gpioPin58_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin58_EnablePullDown : Handle_le_gpioPin58_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin58_DisableResistors : Handle_le_gpioPin58_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin58_Activate : Handle_le_gpioPin58_Activate(msgRef); break;
        case _MSGID_le_gpioPin58_Deactivate : Handle_le_gpioPin58_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin58_SetHighZ : Handle_le_gpioPin58_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin58_Read : Handle_le_gpioPin58_Read(msgRef); break;
        case _MSGID_le_gpioPin58_AddChangeEventHandler : Handle_le_gpioPin58_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin58_RemoveChangeEventHandler : Handle_le_gpioPin58_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin58_SetEdgeSense : Handle_le_gpioPin58_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin58_DisableEdgeSense : Handle_le_gpioPin58_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin58_IsOutput : Handle_le_gpioPin58_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin58_IsInput : Handle_le_gpioPin58_IsInput(msgRef); break;
        case _MSGID_le_gpioPin58_GetEdgeSense : Handle_le_gpioPin58_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin58_GetPolarity : Handle_le_gpioPin58_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin58_IsActive : Handle_le_gpioPin58_IsActive(msgRef); break;
        case _MSGID_le_gpioPin58_GetPullUpDown : Handle_le_gpioPin58_GetPullUpDown(msgRef); break;
