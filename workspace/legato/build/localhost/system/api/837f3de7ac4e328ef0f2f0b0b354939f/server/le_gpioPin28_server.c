...
#include "le_gpioPin28_messages.h"
#include "le_gpioPin28_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin28_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin28_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin28_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin28_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin28_ServerHandlers", 3);
...
static void Handle_le_gpioPin28_SetInput
(
...
)
{
    ...
    le_gpioPin28_Polarity_t polarity;
...
static void Handle_le_gpioPin28_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin28_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin28_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin28_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin28_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin28_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin28_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin28_EnablePullUp (  );
...
static void Handle_le_gpioPin28_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin28_EnablePullDown (  );
...
static void Handle_le_gpioPin28_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin28_DisableResistors (  );
...
static void Handle_le_gpioPin28_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin28_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin28_Deactivate (  );
...
static void Handle_le_gpioPin28_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin28_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin28_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin28_AddChangeEventHandler;
...
static void Handle_le_gpioPin28_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin28_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin28_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin28_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin28_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin28_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin28_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin28_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin28_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin28_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin28_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin28_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin28_DisableEdgeSense (  );
...
static void Handle_le_gpioPin28_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin28_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin28_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin28_Edge_t _result;
    _result  = le_gpioPin28_GetEdgeSense (  );
...
static void Handle_le_gpioPin28_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin28_Polarity_t _result;
    _result  = le_gpioPin28_GetPolarity (  );
...
static void Handle_le_gpioPin28_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin28_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin28_PullUpDown_t _result;
    _result  = le_gpioPin28_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin28_SetInput : Handle_le_gpioPin28_SetInput(msgRef); break;
        case _MSGID_le_gpioPin28_SetPushPullOutput : Handle_le_gpioPin28_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin28_SetTriStateOutput : Handle_le_gpioPin28_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin28_SetOpenDrainOutput : Handle_le_gpioPin28_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin28_EnablePullUp : Handle_le_gpioPin28_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin28_EnablePullDown : Handle_le_gpioPin28_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin28_DisableResistors : Handle_le_gpioPin28_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin28_Activate : Handle_le_gpioPin28_Activate(msgRef); break;
        case _MSGID_le_gpioPin28_Deactivate : Handle_le_gpioPin28_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin28_SetHighZ : Handle_le_gpioPin28_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin28_Read : Handle_le_gpioPin28_Read(msgRef); break;
        case _MSGID_le_gpioPin28_AddChangeEventHandler : Handle_le_gpioPin28_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin28_RemoveChangeEventHandler : Handle_le_gpioPin28_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin28_SetEdgeSense : Handle_le_gpioPin28_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin28_DisableEdgeSense : Handle_le_gpioPin28_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin28_IsOutput : Handle_le_gpioPin28_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin28_IsInput : Handle_le_gpioPin28_IsInput(msgRef); break;
        case _MSGID_le_gpioPin28_GetEdgeSense : Handle_le_gpioPin28_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin28_GetPolarity : Handle_le_gpioPin28_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin28_IsActive : Handle_le_gpioPin28_IsActive(msgRef); break;
        case _MSGID_le_gpioPin28_GetPullUpDown : Handle_le_gpioPin28_GetPullUpDown(msgRef); break;
