...
#include "le_gpioPin16_messages.h"
#include "le_gpioPin16_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin16_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin16_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin16_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin16_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin16_ServerHandlers", 3);
...
static void Handle_le_gpioPin16_SetInput
(
...
)
{
    ...
    le_gpioPin16_Polarity_t polarity;
...
static void Handle_le_gpioPin16_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin16_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin16_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin16_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin16_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin16_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin16_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin16_EnablePullUp (  );
...
static void Handle_le_gpioPin16_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin16_EnablePullDown (  );
...
static void Handle_le_gpioPin16_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin16_DisableResistors (  );
...
static void Handle_le_gpioPin16_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin16_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin16_Deactivate (  );
...
static void Handle_le_gpioPin16_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin16_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin16_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin16_AddChangeEventHandler;
...
static void Handle_le_gpioPin16_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin16_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin16_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin16_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin16_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin16_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin16_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin16_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin16_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin16_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin16_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin16_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin16_DisableEdgeSense (  );
...
static void Handle_le_gpioPin16_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin16_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin16_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin16_Edge_t _result;
    _result  = le_gpioPin16_GetEdgeSense (  );
...
static void Handle_le_gpioPin16_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin16_Polarity_t _result;
    _result  = le_gpioPin16_GetPolarity (  );
...
static void Handle_le_gpioPin16_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin16_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin16_PullUpDown_t _result;
    _result  = le_gpioPin16_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin16_SetInput : Handle_le_gpioPin16_SetInput(msgRef); break;
        case _MSGID_le_gpioPin16_SetPushPullOutput : Handle_le_gpioPin16_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin16_SetTriStateOutput : Handle_le_gpioPin16_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin16_SetOpenDrainOutput : Handle_le_gpioPin16_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin16_EnablePullUp : Handle_le_gpioPin16_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin16_EnablePullDown : Handle_le_gpioPin16_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin16_DisableResistors : Handle_le_gpioPin16_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin16_Activate : Handle_le_gpioPin16_Activate(msgRef); break;
        case _MSGID_le_gpioPin16_Deactivate : Handle_le_gpioPin16_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin16_SetHighZ : Handle_le_gpioPin16_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin16_Read : Handle_le_gpioPin16_Read(msgRef); break;
        case _MSGID_le_gpioPin16_AddChangeEventHandler : Handle_le_gpioPin16_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin16_RemoveChangeEventHandler : Handle_le_gpioPin16_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin16_SetEdgeSense : Handle_le_gpioPin16_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin16_DisableEdgeSense : Handle_le_gpioPin16_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin16_IsOutput : Handle_le_gpioPin16_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin16_IsInput : Handle_le_gpioPin16_IsInput(msgRef); break;
        case _MSGID_le_gpioPin16_GetEdgeSense : Handle_le_gpioPin16_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin16_GetPolarity : Handle_le_gpioPin16_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin16_IsActive : Handle_le_gpioPin16_IsActive(msgRef); break;
        case _MSGID_le_gpioPin16_GetPullUpDown : Handle_le_gpioPin16_GetPullUpDown(msgRef); break;
