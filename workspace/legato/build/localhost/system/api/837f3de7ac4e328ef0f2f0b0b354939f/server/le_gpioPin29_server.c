...
#include "le_gpioPin29_messages.h"
#include "le_gpioPin29_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin29_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin29_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin29_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin29_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin29_ServerHandlers", 3);
...
static void Handle_le_gpioPin29_SetInput
(
...
)
{
    ...
    le_gpioPin29_Polarity_t polarity;
...
static void Handle_le_gpioPin29_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin29_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin29_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin29_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin29_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin29_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin29_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin29_EnablePullUp (  );
...
static void Handle_le_gpioPin29_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin29_EnablePullDown (  );
...
static void Handle_le_gpioPin29_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin29_DisableResistors (  );
...
static void Handle_le_gpioPin29_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin29_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin29_Deactivate (  );
...
static void Handle_le_gpioPin29_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin29_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin29_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin29_AddChangeEventHandler;
...
static void Handle_le_gpioPin29_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin29_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin29_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin29_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin29_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin29_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin29_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin29_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin29_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin29_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin29_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin29_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin29_DisableEdgeSense (  );
...
static void Handle_le_gpioPin29_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin29_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin29_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin29_Edge_t _result;
    _result  = le_gpioPin29_GetEdgeSense (  );
...
static void Handle_le_gpioPin29_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin29_Polarity_t _result;
    _result  = le_gpioPin29_GetPolarity (  );
...
static void Handle_le_gpioPin29_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin29_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin29_PullUpDown_t _result;
    _result  = le_gpioPin29_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin29_SetInput : Handle_le_gpioPin29_SetInput(msgRef); break;
        case _MSGID_le_gpioPin29_SetPushPullOutput : Handle_le_gpioPin29_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin29_SetTriStateOutput : Handle_le_gpioPin29_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin29_SetOpenDrainOutput : Handle_le_gpioPin29_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin29_EnablePullUp : Handle_le_gpioPin29_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin29_EnablePullDown : Handle_le_gpioPin29_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin29_DisableResistors : Handle_le_gpioPin29_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin29_Activate : Handle_le_gpioPin29_Activate(msgRef); break;
        case _MSGID_le_gpioPin29_Deactivate : Handle_le_gpioPin29_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin29_SetHighZ : Handle_le_gpioPin29_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin29_Read : Handle_le_gpioPin29_Read(msgRef); break;
        case _MSGID_le_gpioPin29_AddChangeEventHandler : Handle_le_gpioPin29_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin29_RemoveChangeEventHandler : Handle_le_gpioPin29_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin29_SetEdgeSense : Handle_le_gpioPin29_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin29_DisableEdgeSense : Handle_le_gpioPin29_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin29_IsOutput : Handle_le_gpioPin29_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin29_IsInput : Handle_le_gpioPin29_IsInput(msgRef); break;
        case _MSGID_le_gpioPin29_GetEdgeSense : Handle_le_gpioPin29_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin29_GetPolarity : Handle_le_gpioPin29_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin29_IsActive : Handle_le_gpioPin29_IsActive(msgRef); break;
        case _MSGID_le_gpioPin29_GetPullUpDown : Handle_le_gpioPin29_GetPullUpDown(msgRef); break;
