...
#include "le_gpioPin15_messages.h"
#include "le_gpioPin15_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin15_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin15_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin15_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin15_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin15_ServerHandlers", 3);
...
static void Handle_le_gpioPin15_SetInput
(
...
)
{
    ...
    le_gpioPin15_Polarity_t polarity;
...
static void Handle_le_gpioPin15_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin15_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin15_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin15_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin15_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin15_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin15_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin15_EnablePullUp (  );
...
static void Handle_le_gpioPin15_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin15_EnablePullDown (  );
...
static void Handle_le_gpioPin15_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin15_DisableResistors (  );
...
static void Handle_le_gpioPin15_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin15_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin15_Deactivate (  );
...
static void Handle_le_gpioPin15_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin15_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin15_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin15_AddChangeEventHandler;
...
static void Handle_le_gpioPin15_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin15_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin15_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin15_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin15_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin15_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin15_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin15_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin15_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin15_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin15_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin15_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin15_DisableEdgeSense (  );
...
static void Handle_le_gpioPin15_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin15_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin15_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin15_Edge_t _result;
    _result  = le_gpioPin15_GetEdgeSense (  );
...
static void Handle_le_gpioPin15_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin15_Polarity_t _result;
    _result  = le_gpioPin15_GetPolarity (  );
...
static void Handle_le_gpioPin15_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin15_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin15_PullUpDown_t _result;
    _result  = le_gpioPin15_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin15_SetInput : Handle_le_gpioPin15_SetInput(msgRef); break;
        case _MSGID_le_gpioPin15_SetPushPullOutput : Handle_le_gpioPin15_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin15_SetTriStateOutput : Handle_le_gpioPin15_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin15_SetOpenDrainOutput : Handle_le_gpioPin15_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin15_EnablePullUp : Handle_le_gpioPin15_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin15_EnablePullDown : Handle_le_gpioPin15_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin15_DisableResistors : Handle_le_gpioPin15_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin15_Activate : Handle_le_gpioPin15_Activate(msgRef); break;
        case _MSGID_le_gpioPin15_Deactivate : Handle_le_gpioPin15_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin15_SetHighZ : Handle_le_gpioPin15_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin15_Read : Handle_le_gpioPin15_Read(msgRef); break;
        case _MSGID_le_gpioPin15_AddChangeEventHandler : Handle_le_gpioPin15_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin15_RemoveChangeEventHandler : Handle_le_gpioPin15_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin15_SetEdgeSense : Handle_le_gpioPin15_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin15_DisableEdgeSense : Handle_le_gpioPin15_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin15_IsOutput : Handle_le_gpioPin15_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin15_IsInput : Handle_le_gpioPin15_IsInput(msgRef); break;
        case _MSGID_le_gpioPin15_GetEdgeSense : Handle_le_gpioPin15_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin15_GetPolarity : Handle_le_gpioPin15_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin15_IsActive : Handle_le_gpioPin15_IsActive(msgRef); break;
        case _MSGID_le_gpioPin15_GetPullUpDown : Handle_le_gpioPin15_GetPullUpDown(msgRef); break;
