...
#include "le_gpioPin34_messages.h"
#include "le_gpioPin34_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin34_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin34_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin34_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin34_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin34_ServerHandlers", 3);
...
static void Handle_le_gpioPin34_SetInput
(
...
)
{
    ...
    le_gpioPin34_Polarity_t polarity;
...
static void Handle_le_gpioPin34_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin34_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin34_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin34_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin34_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin34_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin34_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin34_EnablePullUp (  );
...
static void Handle_le_gpioPin34_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin34_EnablePullDown (  );
...
static void Handle_le_gpioPin34_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin34_DisableResistors (  );
...
static void Handle_le_gpioPin34_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin34_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin34_Deactivate (  );
...
static void Handle_le_gpioPin34_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin34_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin34_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin34_AddChangeEventHandler;
...
static void Handle_le_gpioPin34_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin34_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin34_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin34_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin34_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin34_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin34_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin34_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin34_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin34_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin34_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin34_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin34_DisableEdgeSense (  );
...
static void Handle_le_gpioPin34_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin34_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin34_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin34_Edge_t _result;
    _result  = le_gpioPin34_GetEdgeSense (  );
...
static void Handle_le_gpioPin34_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin34_Polarity_t _result;
    _result  = le_gpioPin34_GetPolarity (  );
...
static void Handle_le_gpioPin34_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin34_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin34_PullUpDown_t _result;
    _result  = le_gpioPin34_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin34_SetInput : Handle_le_gpioPin34_SetInput(msgRef); break;
        case _MSGID_le_gpioPin34_SetPushPullOutput : Handle_le_gpioPin34_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin34_SetTriStateOutput : Handle_le_gpioPin34_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin34_SetOpenDrainOutput : Handle_le_gpioPin34_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin34_EnablePullUp : Handle_le_gpioPin34_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin34_EnablePullDown : Handle_le_gpioPin34_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin34_DisableResistors : Handle_le_gpioPin34_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin34_Activate : Handle_le_gpioPin34_Activate(msgRef); break;
        case _MSGID_le_gpioPin34_Deactivate : Handle_le_gpioPin34_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin34_SetHighZ : Handle_le_gpioPin34_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin34_Read : Handle_le_gpioPin34_Read(msgRef); break;
        case _MSGID_le_gpioPin34_AddChangeEventHandler : Handle_le_gpioPin34_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin34_RemoveChangeEventHandler : Handle_le_gpioPin34_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin34_SetEdgeSense : Handle_le_gpioPin34_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin34_DisableEdgeSense : Handle_le_gpioPin34_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin34_IsOutput : Handle_le_gpioPin34_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin34_IsInput : Handle_le_gpioPin34_IsInput(msgRef); break;
        case _MSGID_le_gpioPin34_GetEdgeSense : Handle_le_gpioPin34_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin34_GetPolarity : Handle_le_gpioPin34_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin34_IsActive : Handle_le_gpioPin34_IsActive(msgRef); break;
        case _MSGID_le_gpioPin34_GetPullUpDown : Handle_le_gpioPin34_GetPullUpDown(msgRef); break;
