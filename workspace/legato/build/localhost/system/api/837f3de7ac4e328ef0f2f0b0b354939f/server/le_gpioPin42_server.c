...
#include "le_gpioPin42_messages.h"
#include "le_gpioPin42_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin42_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin42_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin42_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin42_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin42_ServerHandlers", 3);
...
static void Handle_le_gpioPin42_SetInput
(
...
static void Handle_le_gpioPin42_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin42_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin42_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin42_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin42_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin42_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin42_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin42_EnablePullUp (  );
...
static void Handle_le_gpioPin42_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin42_EnablePullDown (  );
...
static void Handle_le_gpioPin42_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin42_DisableResistors (  );
...
static void Handle_le_gpioPin42_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin42_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin42_Deactivate (  );
...
static void Handle_le_gpioPin42_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin42_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin42_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin42_AddChangeEventHandler;
...
static void Handle_le_gpioPin42_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin42_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin42_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin42_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin42_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin42_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_gpioPin42_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin42_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin42_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin42_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin42_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin42_DisableEdgeSense (  );
...
static void Handle_le_gpioPin42_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin42_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin42_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin42_Edge_t _result;
    _result  = le_gpioPin42_GetEdgeSense (  );
...
static void Handle_le_gpioPin42_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin42_Polarity_t _result;
    _result  = le_gpioPin42_GetPolarity (  );
...
static void Handle_le_gpioPin42_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin42_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin42_PullUpDown_t _result;
    _result  = le_gpioPin42_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin42_SetInput : Handle_le_gpioPin42_SetInput(msgRef); break;
        case _MSGID_le_gpioPin42_SetPushPullOutput : Handle_le_gpioPin42_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin42_SetTriStateOutput : Handle_le_gpioPin42_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin42_SetOpenDrainOutput : Handle_le_gpioPin42_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin42_EnablePullUp : Handle_le_gpioPin42_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin42_EnablePullDown : Handle_le_gpioPin42_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin42_DisableResistors : Handle_le_gpioPin42_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin42_Activate : Handle_le_gpioPin42_Activate(msgRef); break;
        case _MSGID_le_gpioPin42_Deactivate : Handle_le_gpioPin42_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin42_SetHighZ : Handle_le_gpioPin42_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin42_Read : Handle_le_gpioPin42_Read(msgRef); break;
        case _MSGID_le_gpioPin42_AddChangeEventHandler : Handle_le_gpioPin42_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin42_RemoveChangeEventHandler : Handle_le_gpioPin42_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin42_SetEdgeSense : Handle_le_gpioPin42_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin42_DisableEdgeSense : Handle_le_gpioPin42_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin42_IsOutput : Handle_le_gpioPin42_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin42_IsInput : Handle_le_gpioPin42_IsInput(msgRef); break;
        case _MSGID_le_gpioPin42_GetEdgeSense : Handle_le_gpioPin42_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin42_GetPolarity : Handle_le_gpioPin42_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin42_IsActive : Handle_le_gpioPin42_IsActive(msgRef); break;
        case _MSGID_le_gpioPin42_GetPullUpDown : Handle_le_gpioPin42_GetPullUpDown(msgRef); break;
