...
#include "le_gpioPin31_messages.h"
#include "le_gpioPin31_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin31_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin31_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin31_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin31_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin31_ServerHandlers", 3);
...
static void Handle_le_gpioPin31_SetInput
(
...
)
{
    ...
    le_gpioPin31_Polarity_t polarity;
...
static void Handle_le_gpioPin31_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin31_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin31_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin31_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin31_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin31_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin31_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin31_EnablePullUp (  );
...
static void Handle_le_gpioPin31_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin31_EnablePullDown (  );
...
static void Handle_le_gpioPin31_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin31_DisableResistors (  );
...
static void Handle_le_gpioPin31_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin31_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin31_Deactivate (  );
...
static void Handle_le_gpioPin31_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin31_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin31_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin31_AddChangeEventHandler;
...
static void Handle_le_gpioPin31_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin31_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin31_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin31_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin31_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin31_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Unpack the input parameters from the message
    le_gpioPin31_ChangeEventHandlerRef_t handlerRef;
    ...
    _UNLOCK
    handlerRef = (le_gpioPin31_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin31_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin31_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin31_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin31_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin31_DisableEdgeSense (  );
...
static void Handle_le_gpioPin31_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin31_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin31_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin31_Edge_t _result;
    _result  = le_gpioPin31_GetEdgeSense (  );
...
static void Handle_le_gpioPin31_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin31_Polarity_t _result;
    _result  = le_gpioPin31_GetPolarity (  );
...
static void Handle_le_gpioPin31_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin31_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin31_PullUpDown_t _result;
    _result  = le_gpioPin31_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin31_SetInput : Handle_le_gpioPin31_SetInput(msgRef); break;
        case _MSGID_le_gpioPin31_SetPushPullOutput : Handle_le_gpioPin31_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin31_SetTriStateOutput : Handle_le_gpioPin31_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin31_SetOpenDrainOutput : Handle_le_gpioPin31_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin31_EnablePullUp : Handle_le_gpioPin31_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin31_EnablePullDown : Handle_le_gpioPin31_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin31_DisableResistors : Handle_le_gpioPin31_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin31_Activate : Handle_le_gpioPin31_Activate(msgRef); break;
        case _MSGID_le_gpioPin31_Deactivate : Handle_le_gpioPin31_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin31_SetHighZ : Handle_le_gpioPin31_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin31_Read : Handle_le_gpioPin31_Read(msgRef); break;
        case _MSGID_le_gpioPin31_AddChangeEventHandler : Handle_le_gpioPin31_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin31_RemoveChangeEventHandler : Handle_le_gpioPin31_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin31_SetEdgeSense : Handle_le_gpioPin31_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin31_DisableEdgeSense : Handle_le_gpioPin31_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin31_IsOutput : Handle_le_gpioPin31_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin31_IsInput : Handle_le_gpioPin31_IsInput(msgRef); break;
        case _MSGID_le_gpioPin31_GetEdgeSense : Handle_le_gpioPin31_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin31_GetPolarity : Handle_le_gpioPin31_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin31_IsActive : Handle_le_gpioPin31_IsActive(msgRef); break;
        case _MSGID_le_gpioPin31_GetPullUpDown : Handle_le_gpioPin31_GetPullUpDown(msgRef); break;
