...
#include "le_gpioPin8_messages.h"
#include "le_gpioPin8_server.h"
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_ServiceRef_t le_gpioPin8_GetServiceRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_msg_SessionRef_t le_gpioPin8_GetClientSessionRef
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
void le_gpioPin8_AdvertiseService
(
    void
)
{
    ...
    _ServerDataPool = le_mem_CreatePool("le_gpioPin8_ServerData", sizeof(_ServerData_t));

    // Create safe reference map for handler references.
    // The size of the map should be based on the number of handlers defined for the server.
    // Don't expect that to be more than 2-3, so use 3 as a reasonable guess.
    _HandlerRefMap = le_ref_CreateMap("le_gpioPin8_ServerHandlers", 3);
...
static void Handle_le_gpioPin8_SetInput
(
...
static void Handle_le_gpioPin8_SetPushPullOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin8_SetPushPullOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin8_SetTriStateOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin8_SetTriStateOutput ( 
        polarity );
...
static void Handle_le_gpioPin8_SetOpenDrainOutput
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin8_SetOpenDrainOutput ( 
        polarity, 
        value );
...
static void Handle_le_gpioPin8_EnablePullUp
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin8_EnablePullUp (  );
...
static void Handle_le_gpioPin8_EnablePullDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin8_EnablePullDown (  );
...
static void Handle_le_gpioPin8_DisableResistors
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin8_DisableResistors (  );
...
static void Handle_le_gpioPin8_Activate
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin8_Deactivate
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin8_Deactivate (  );
...
static void Handle_le_gpioPin8_SetHighZ
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin8_Read
(
    le_msg_MessageRef_t _msgRef
...
static void AsyncResponse_le_gpioPin8_AddChangeEventHandler
(
    bool state,
    void* contextPtr
)
{
    ...
    _msgPtr->id = _MSGID_le_gpioPin8_AddChangeEventHandler;
...
static void Handle_le_gpioPin8_AddChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin8_ChangeEventHandlerRef_t _result;
    _result  = le_gpioPin8_AddChangeEventHandler ( 
        trigger, AsyncResponse_le_gpioPin8_AddChangeEventHandler, 
        contextPtr, 
        sampleMs );
    ...
    if (_result)
    {
        ...
        serverDataPtr->removeHandlerFunc =
            (RemoveHandlerFunc_t)le_gpioPin8_RemoveChangeEventHandler;
...
static void Handle_le_gpioPin8_RemoveChangeEventHandler
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    _UNLOCK
    handlerRef = (le_gpioPin8_ChangeEventHandlerRef_t)serverDataPtr->handlerRef;
    le_mem_Release(serverDataPtr);

    // Define storage for output parameters

    // Call the function
    le_gpioPin8_RemoveChangeEventHandler ( 
        handlerRef );
...
static void Handle_le_gpioPin8_SetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin8_SetEdgeSense ( 
        trigger );
...
static void Handle_le_gpioPin8_DisableEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_result_t _result;
    _result  = le_gpioPin8_DisableEdgeSense (  );
...
static void Handle_le_gpioPin8_IsOutput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin8_IsInput
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin8_GetEdgeSense
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin8_Edge_t _result;
    _result  = le_gpioPin8_GetEdgeSense (  );
...
static void Handle_le_gpioPin8_GetPolarity
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin8_Polarity_t _result;
    _result  = le_gpioPin8_GetPolarity (  );
...
static void Handle_le_gpioPin8_IsActive
(
    le_msg_MessageRef_t _msgRef
...
static void Handle_le_gpioPin8_GetPullUpDown
(
    le_msg_MessageRef_t _msgRef
...
)
{
    ...
    // Call the function
    le_gpioPin8_PullUpDown_t _result;
    _result  = le_gpioPin8_GetPullUpDown (  );
...
)
{
    ...
    switch (msgPtr->id)
    {
        case _MSGID_le_gpioPin8_SetInput : Handle_le_gpioPin8_SetInput(msgRef); break;
        case _MSGID_le_gpioPin8_SetPushPullOutput : Handle_le_gpioPin8_SetPushPullOutput(msgRef); break;
        case _MSGID_le_gpioPin8_SetTriStateOutput : Handle_le_gpioPin8_SetTriStateOutput(msgRef); break;
        case _MSGID_le_gpioPin8_SetOpenDrainOutput : Handle_le_gpioPin8_SetOpenDrainOutput(msgRef); break;
        case _MSGID_le_gpioPin8_EnablePullUp : Handle_le_gpioPin8_EnablePullUp(msgRef); break;
        case _MSGID_le_gpioPin8_EnablePullDown : Handle_le_gpioPin8_EnablePullDown(msgRef); break;
        case _MSGID_le_gpioPin8_DisableResistors : Handle_le_gpioPin8_DisableResistors(msgRef); break;
        case _MSGID_le_gpioPin8_Activate : Handle_le_gpioPin8_Activate(msgRef); break;
        case _MSGID_le_gpioPin8_Deactivate : Handle_le_gpioPin8_Deactivate(msgRef); break;
        case _MSGID_le_gpioPin8_SetHighZ : Handle_le_gpioPin8_SetHighZ(msgRef); break;
        case _MSGID_le_gpioPin8_Read : Handle_le_gpioPin8_Read(msgRef); break;
        case _MSGID_le_gpioPin8_AddChangeEventHandler : Handle_le_gpioPin8_AddChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin8_RemoveChangeEventHandler : Handle_le_gpioPin8_RemoveChangeEventHandler(msgRef); break;
        case _MSGID_le_gpioPin8_SetEdgeSense : Handle_le_gpioPin8_SetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin8_DisableEdgeSense : Handle_le_gpioPin8_DisableEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin8_IsOutput : Handle_le_gpioPin8_IsOutput(msgRef); break;
        case _MSGID_le_gpioPin8_IsInput : Handle_le_gpioPin8_IsInput(msgRef); break;
        case _MSGID_le_gpioPin8_GetEdgeSense : Handle_le_gpioPin8_GetEdgeSense(msgRef); break;
        case _MSGID_le_gpioPin8_GetPolarity : Handle_le_gpioPin8_GetPolarity(msgRef); break;
        case _MSGID_le_gpioPin8_IsActive : Handle_le_gpioPin8_IsActive(msgRef); break;
        case _MSGID_le_gpioPin8_GetPullUpDown : Handle_le_gpioPin8_GetPullUpDown(msgRef); break;
