...
// Startup code for the executable 'portDaemon'.
...
LE_SHARED const char* _watchdogChain_le_wdog_ServiceInstanceName = "portDaemon.watchdogChain.le_wdog";
LE_SHARED const char* _portDaemon_le_port_ServiceInstanceName = "le_port";
LE_SHARED const char* _portDaemon_le_atServer_ServiceInstanceName = "portDaemon.portDaemon.le_atServer";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t portDaemon_exe_LogSession;
LE_SHARED le_log_Level_t* portDaemon_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    portDaemon_exe_LogSession = log_RegComponent("portDaemon_exe", &portDaemon_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_portDaemon.so");
