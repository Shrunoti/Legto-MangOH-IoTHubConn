...
// Startup code for the executable 'voiceCallService'.
...
LE_SHARED const char* _watchdogChain_le_wdog_ServiceInstanceName = "voiceCallService.watchdogChain.le_wdog";
LE_SHARED const char* _voiceCallService_le_voicecall_ServiceInstanceName = "le_voicecall";
LE_SHARED const char* _voiceCallService_le_mcc_ServiceInstanceName = "voiceCallService.voiceCallService.le_mcc";
LE_SHARED const char* _voiceCallService_le_audio_ServiceInstanceName = "voiceCallService.voiceCallService.le_audio";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t voiceCallService_exe_LogSession;
LE_SHARED le_log_Level_t* voiceCallService_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    voiceCallService_exe_LogSession = log_RegComponent("voiceCallService_exe", &voiceCallService_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_voiceCallService.so");
