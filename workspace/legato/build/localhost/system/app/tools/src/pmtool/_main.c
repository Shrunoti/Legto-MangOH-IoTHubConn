...
// Startup code for the executable 'pmtool'.
...
LE_SHARED const char* _pmtool_le_ulpm_ServiceInstanceName = "pmtool.pmtool.le_ulpm";
LE_SHARED const char* _pmtool_le_bootReason_ServiceInstanceName = "pmtool.pmtool.le_bootReason";
LE_SHARED const char* _pmtool_le_pm_ServiceInstanceName = "pmtool.pmtool.le_pm";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t pmtool_exe_LogSession;
LE_SHARED le_log_Level_t* pmtool_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    pmtool_exe_LogSession = log_RegComponent("pmtool_exe", &pmtool_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_pmtool.so");
