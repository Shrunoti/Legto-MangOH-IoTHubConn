...
// Startup code for the executable 'fwupdate'.
...
LE_SHARED const char* _fwupdate_le_fwupdate_ServiceInstanceName = "fwupdate.fwupdate.le_fwupdate";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t fwupdate_exe_LogSession;
LE_SHARED le_log_Level_t* fwupdate_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    fwupdate_exe_LogSession = log_RegComponent("fwupdate_exe", &fwupdate_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_fwupdate.so");
