...
// Startup code for the executable 'rSimDaemon'.
...
LE_SHARED const char* _watchdogChain_le_wdog_ServiceInstanceName = "rSimDaemon.watchdogChain.le_wdog";
LE_SHARED const char* _rSimDaemon_le_rsim_ServiceInstanceName = "le_rsim";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t rSimDaemon_exe_LogSession;
LE_SHARED le_log_Level_t* rSimDaemon_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    rSimDaemon_exe_LogSession = log_RegComponent("rSimDaemon_exe", &rSimDaemon_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_le_pa_remotesim_default.so");
    LoadLib("libComponent_watchdogChain.so");
    LoadLib("libComponent_rSimDaemon.so");
