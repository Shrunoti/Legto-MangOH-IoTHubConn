...
// Startup code for the executable 'atClientDaemon'.
...
LE_SHARED const char* _watchdogChain_le_wdog_ServiceInstanceName = "atClientDaemon.watchdogChain.le_wdog";
LE_SHARED const char* _atClient_le_atClient_ServiceInstanceName = "le_atClient";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t atClientDaemon_exe_LogSession;
LE_SHARED le_log_Level_t* atClientDaemon_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    atClientDaemon_exe_LogSession = log_RegComponent("atClientDaemon_exe", &atClientDaemon_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_atClient.so");
