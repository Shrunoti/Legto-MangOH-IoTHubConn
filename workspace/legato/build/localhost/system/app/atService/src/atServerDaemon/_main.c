...
// Startup code for the executable 'atServerDaemon'.
...
LE_SHARED const char* _watchdogChain_le_wdog_ServiceInstanceName = "atServerDaemon.watchdogChain.le_wdog";
LE_SHARED const char* _atServer_le_atServer_ServiceInstanceName = "le_atServer";
LE_SHARED const char* _atServer_le_atClient_ServiceInstanceName = "atServerDaemon.atServer.le_atClient";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t atServerDaemon_exe_LogSession;
LE_SHARED le_log_Level_t* atServerDaemon_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    atServerDaemon_exe_LogSession = log_RegComponent("atServerDaemon_exe", &atServerDaemon_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_atServer.so");
