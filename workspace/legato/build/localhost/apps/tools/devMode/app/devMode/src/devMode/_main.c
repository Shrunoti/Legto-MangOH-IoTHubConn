...
// Startup code for the executable 'devMode'.
...
LE_SHARED const char* _devMode_le_pm_ServiceInstanceName = "devMode.devMode.le_pm";
LE_SHARED const char* _devMode_le_updateCtrl_ServiceInstanceName = "devMode.devMode.le_updateCtrl";
LE_SHARED const char* _devMode_le_instStat_ServiceInstanceName = "devMode.devMode.le_instStat";
LE_SHARED const char* _devMode_le_framework_ServiceInstanceName = "devMode.devMode.le_framework";

// Define default component's log session variables.
LE_SHARED le_log_SessionRef_t devMode_exe_LogSession;
LE_SHARED le_log_Level_t* devMode_exe_LogLevelFilterPtr;
...
int main(int argc, char* argv[])
{
    ...
    devMode_exe_LogSession = log_RegComponent("devMode_exe", &devMode_exe_LogLevelFilterPtr);
    ...
    LoadLib("libComponent_devMode.so");
