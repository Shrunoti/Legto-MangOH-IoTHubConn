...
\{
    ...
    \{
        \hyperlink{le__log_8h_a353590f91b3143a7ba3a416ae5a50c3d}{LE\_ERROR}(\textcolor{stringliteral}{"Open file %s failure: errno.%d (%s)"},  AudioFilePath, errno, strerror(errno));
        DisconnectAllAudio();
        exit(0);
    \}
    \textcolor{keywordflow}{else}
...
\{
    ...
    \{
        ...
        \hyperlink{le__timer_8h_a8fb341f11e0da2692453df997613cb8e}{le\_timer\_SetHandler}(OptionTimerRef, OptionTimerHandler);
