...
DESIGN= PSOC6_FreeRTOS+LwIP+MbedTLS_Azure-IOT-Hub-Demo
CONFIG= debug
...
CFLAGS_CortexM0p= -mcpu=cortex-m0plus -mthumb -I./Source/azure_iot_sdk/c-utility/inc -I./Source/azure_iot_sdk/c-utility/adapters -I./Source/azure_iot_sdk/iothub_client/inc -I./Source/FreeRTOS/10.0.1/Source/portable -I./Source/FreeRTOS/10.0.1/Source/include -I./Source/mbedtls_open/include/mbedtls -I./Source/azure_iot_sdk/uamqp/inc -I./Source/LwIP/src/include -I./Source/FreeRTOS/10.0.1/Source/portable/GCC/CM0 -I./Source/mbedtls_open/include -I./Source/azure_iot_sdk/c-utility/pal/generic -I./Source/azure_iot_sdk/iothub_client/inc/internal -I./Source/azure_iot_sdk/c-utility/Socket/inc -I. -IGenerated_Source/PSoC6 -IGenerated_Source/PSoC6/pdl/cmsis/include/ -IGenerated_Source/PSoC6/pdl/devices/psoc6/ip/ -IGenerated_Source/PSoC6/pdl/devices/psoc6/psoc62/include/ -IGenerated_Source/PSoC6/pdl/drivers/peripheral/ -IGenerated_Source/PSoC6/pdl/utilities/ -Wa,-alh=$(OUT_DIR_CortexM0p)/$(basename $(<F)).lst -g -D DEBUG -D CY_CORE_ID=0 -D __STACK_SIZE=8192 -D __HEAP_SIZE=40960 -D CY_PSOC_CREATOR_USED=1 -D CY8C6247BZI_D54 -Wall -ffunction-sections -ffat-lto-objects -Og

OUT_DIR_CortexM4= output/$(CONFIG)/CortexM4
CFLAGS_CortexM4= -mcpu=cortex-m4 -mfloat-abi=softfp -mfpu=fpv4-sp-d16 -mthumb -I. -IGenerated_Source/PSoC6 -IGenerated_Source/PSoC6/pdl/cmsis/include/ -IGenerated_Source/PSoC6/pdl/devices/psoc6/ip/ -IGenerated_Source/PSoC6/pdl/devices/psoc6/psoc62/include/ -IGenerated_Source/PSoC6/pdl/drivers/peripheral/ -IGenerated_Source/PSoC6/pdl/utilities/ -Wa,-alh=$(OUT_DIR_CortexM4)/$(basename $(<F)).lst -g -D DEBUG -D CY_CORE_ID=0 -D CY_PSOC_CREATOR_USED=1 -D CY8C6247BZI_D54 -Wall -ffunction-sections -ffat-lto-objects -Og
